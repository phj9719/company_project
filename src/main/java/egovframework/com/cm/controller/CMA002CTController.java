...
@Controller
public class CMA002CTController {

	private Logger log = LoggerFactory.getLogger(CMA002CTController.class);

	@Resource(name="CMA002CTService")
	private CMA002CTService CMA002CTService;

	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/CMA002CTController.do")
    ...
    public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(CMA002CTService, inVar.getString("method"));
			method.invoke(CMA002CTService, new Object[] {inVar, inDataSet, outVar, outMap});
