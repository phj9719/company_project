...
@Controller
public class CMA300QRController {

	private Logger log = LoggerFactory.getLogger(CMA300QRController.class);

	@Resource(name="CMA300QRService")
	private CMA300QRService CMA300QRService;
	
	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	
	@RequestMapping(value = "/CMA300QR_delete.do")
    public NexacroResult delete(HttpServletRequest request) {
    	...
    	try {
			...
			result = CMA300QRService.delete(inVar, inDataSet);
