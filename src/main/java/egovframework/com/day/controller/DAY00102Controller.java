...
@Controller
public class DAY00102Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00102Controller.class);
	
	@Resource(name="DAY00102Service")
	private DAY00102Service DAY00102Service;
	
	@RequestMapping(value = "/DAY00102Controller.do")
    	...
    	try {
			...
			switch (method) {
				case "save" :
					...
					break;
				case "getRecordCnt" :
					DAY00102Service.getRecordCnt(inVar, outMap);
					break;
			}
