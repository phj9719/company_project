...
@Controller
public class DAY00717Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00717Controller.class);
	
	@Resource(name="DAY00717Service")
	private DAY00717Service DAY00717Service;
	
	@RequestMapping(value = "/DAY00717Controller.do")
	public NexacroResult save(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				case "save" :
					result = DAY00717Service.save(inVar, inDataSet);
					break;
				case "delete" :
					result = DAY00717Service.delete(inVar, inDataSet);
					break;
			}
