...
import egovframework.com.day.service.DAY00108Service;

@Controller
public class DAY00108Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00108Controller.class);
	
	@Resource(name="DAY00108Service")
	private DAY00108Service DAY00108Service;
	
	@RequestMapping(value = "/DAY00108Controller.do")
	public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				//case "save" :
				//	result = DAY00102Service.save(inVar, inDataSet);
				//	break;
				case "getRecordCnt" :
					DAY00108Service.getRecordCnt(inVar, outMap);
					break;
			}
