...
@Controller
public class DAY00208Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00208Controller.class);
	
	@Resource(name="DAY00208Service")
	private DAY00208Service DAY00208Service;
	
	@RequestMapping(value = "/DAY00208Controller.do")
	public NexacroResult save(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				case "save" :
					result = DAY00208Service.save(inVar, inDataSet);
					break;
				case "delete" :
					result = DAY00208Service.delete(inVar, inDataSet);
					break;
			}
