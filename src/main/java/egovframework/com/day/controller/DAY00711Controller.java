...
@Controller
public class DAY00711Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00711Controller.class);
	
	@Resource(name="DAY00711Service")
	private DAY00711Service DAY00711Service;
	
	@RequestMapping(value = "/DAY00711Controller.do")
	public NexacroResult save(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				case "save" :
					result = DAY00711Service.save(inVar, inDataSet);
					break;
				case "delete" :
					result = DAY00711Service.delete(inVar, inDataSet);
					break;
			}
