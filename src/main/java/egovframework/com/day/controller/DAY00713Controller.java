...
@Controller
public class DAY00713Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00713Controller.class);
	
	@Resource(name="DAY00713Service")
	private DAY00713Service DAY00713Service;
	
	@RequestMapping(value = "/DAY00713Controller.do")
	public NexacroResult save(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				case "save" :
					result = DAY00713Service.save(inVar, inDataSet);
					break;
				case "delete" :
					result = DAY00713Service.delete(inVar, inDataSet);
					break;
			}
