...
@Controller
public class DAY00715Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00715Controller.class);
	
	@Resource(name="DAY00715Service")
	private DAY00715Service DAY00715Service;
	
	@RequestMapping(value = "/DAY00715Controller.do")
	public NexacroResult save(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				case "save" :
					result = DAY00715Service.save(inVar, inDataSet);
					break;
				case "delete" :
					result = DAY00715Service.delete(inVar, inDataSet);
					break;
			}
