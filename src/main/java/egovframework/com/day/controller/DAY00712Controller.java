...
@Controller
public class DAY00712Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00712Controller.class);
	
	@Resource(name="DAY00712Service")
	private DAY00712Service DAY00712Service;
	
	@RequestMapping(value = "/DAY00712Controller.do")
	public NexacroResult save(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				case "save" :
					result = DAY00712Service.save(inVar, inDataSet);
					break;
				case "delete" :
					result = DAY00712Service.delete(inVar, inDataSet);
					break;
			}
