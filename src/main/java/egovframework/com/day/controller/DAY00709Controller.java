...
@Controller
public class DAY00709Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00709Controller.class);
	
	@Resource(name="DAY00709Service")
	private DAY00709Service DAY00709Service;
	
	@RequestMapping(value = "/DAY00709Controller.do")
	public NexacroResult save(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				case "save" :
					result = DAY00709Service.save(inVar, inDataSet);
					break;
				case "delete" :
					result = DAY00709Service.delete(inVar, inDataSet);
					break;
			}
