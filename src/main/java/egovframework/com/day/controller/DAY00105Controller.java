...
@Controller
public class DAY00105Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00105Controller.class);
	
	@Resource(name="DAY00105Service")
	private DAY00105Service DAY00105Service;
	
	@RequestMapping(value = "/DAY00105Controller.do")
	public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				case "save" :
					result = DAY00105Service.save(inVar, inDataSet);
					break;
			}
