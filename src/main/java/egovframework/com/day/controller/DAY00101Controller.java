...
@Controller
public class DAY00101Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00101Controller.class);
	
	@Resource(name="DAY00101Service")
	private DAY00101Service DAY00101Service;
	
	@RequestMapping(value = "/DAY00101Controller.do")
	public NexacroResult save(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				case "save" :
					result = DAY00101Service.save(inVar, inDataSet);
					break;
			}
