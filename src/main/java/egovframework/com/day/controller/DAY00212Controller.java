...
@Controller
public class DAY00212Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00212Controller.class);
	
	@Resource(name="DAY00212Service")
	private DAY00212Service DAY00212Service;
	
	@RequestMapping(value = "/DAY00212Controller.do")
	public NexacroResult save(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				case "save" :
					result = DAY00212Service.save(inVar, inDataSet, outDataSet);
					break;
			}
