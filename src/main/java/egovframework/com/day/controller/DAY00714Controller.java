...
@Controller
public class DAY00714Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00714Controller.class);
	
	@Resource(name="DAY00714Service")
	private DAY00714Service DAY00714Service;
	
	@RequestMapping(value = "/DAY00714Controller.do")
	public NexacroResult save(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				case "save" :
					result = DAY00714Service.save(inVar, inDataSet);
					break;
				case "delete" :
					result = DAY00714Service.delete(inVar, inDataSet);
					break;
			}
