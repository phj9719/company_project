...
@Controller
public class DAY00707Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00707Controller.class);
	
	@Resource(name="DAY00707Service")
	private DAY00707Service DAY00707Service;
	
	@RequestMapping(value = "/DAY00707Controller.do")
	public NexacroResult save(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				case "save" :
					result = DAY00707Service.save(inVar, inDataSet);
					break;
				case "delete" :
					result = DAY00707Service.delete(inVar, inDataSet);
					break;
			}
