...
import egovframework.com.day.service.DAY00207Service;

@Controller
public class DAY00207Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00207Controller.class);
	
	@Resource(name="DAY00207Service")
	private DAY00207Service DAY00207Service;
	
	@RequestMapping(value = "/DAY00207Controller.do")
	public NexacroResult save(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				case "save" :
					result = DAY00207Service.save(inVar, inDataSet);
					break;
				case "delete" :
					result = DAY00207Service.delete(inVar, inDataSet);
					break;
			}
