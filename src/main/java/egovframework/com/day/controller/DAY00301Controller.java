...
@Controller
public class DAY00301Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00301Controller.class);
	
	@Resource(name="DAY00301Service")
	private DAY00301Service DAY00301Service;
	
	@RequestMapping(value = "/DAY00301Controller.do")
	public NexacroResult save(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				case "save" :
					result = DAY00301Service.save(inVar, inDataSet);
					break;
			}
