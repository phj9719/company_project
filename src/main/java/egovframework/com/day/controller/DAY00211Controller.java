...
@Controller
public class DAY00211Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00211Controller.class);
	
	@Resource(name="DAY00211Service")
	private DAY00211Service DAY00211Service;
	
	@RequestMapping(value = "/DAY00211Controller.do")
	public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				case "excel" :
					DAY00211Service.excel(inVar, inDataSet, outMap);
					break;
			}
