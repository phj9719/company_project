...
@Controller
public class DAY00710Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00710Controller.class);
	
	@Resource(name="DAY00710Service")
	private DAY00710Service DAY00710Service;
	
	@RequestMapping(value = "/DAY00710Controller.do")
	public NexacroResult save(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				case "save" :
					result = DAY00710Service.save(inVar, inDataSet);
					break;
				case "delete" :
					result = DAY00710Service.delete(inVar, inDataSet);
					break;
			}
