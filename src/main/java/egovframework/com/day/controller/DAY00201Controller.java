...
@Controller
public class DAY00201Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00201Controller.class);
	
	@Resource(name="DAY00201Service")
	private DAY00201Service DAY00201Service;
	
	@RequestMapping(value = "/DAY00201Controller.do")
	public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				case "save" :
					result = DAY00201Service.save(inVar, inDataSet);
					break;
			}
