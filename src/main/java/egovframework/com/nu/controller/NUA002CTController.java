...
@Controller
public class NUA002CTController {

	private Logger log = LoggerFactory.getLogger(NUA002CTController.class);

	@Resource(name="NUA002CTService")
	private NUA002CTService NUA002CTService;

	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUA002CTController.do")
    ...
    public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUA002CTService, inVar.getString("method"));
			method.invoke(NUA002CTService, new Object[] {inVar, inDataSet, outVar, outMap});
