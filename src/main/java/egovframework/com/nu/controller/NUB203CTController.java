...
@Controller
public class NUB203CTController {

	private Logger log = LoggerFactory.getLogger(NUB203CTController.class);

	@Resource(name="NUB203CTService")
	private NUB203CTService NUB203CTService;

	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUB203CTController.do")
    ...
    public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUB203CTService, inVar.getString("method"));
			method.invoke(NUB203CTService, new Object[] {inVar, inDataSet, outVar, outMap});
