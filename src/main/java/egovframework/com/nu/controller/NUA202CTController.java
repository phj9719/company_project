...
@Controller
public class NUA202CTController {

	private Logger log = LoggerFactory.getLogger(NUA202CTController.class);

	@Resource(name="NUA202CTService")
	private NUA202CTService NUA202CTService;

	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUA202CTController.do")
    ...
    public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUA202CTService, inVar.getString("method"));
			method.invoke(NUA202CTService, new Object[] {inVar, inDataSet, outVar, outMap});
