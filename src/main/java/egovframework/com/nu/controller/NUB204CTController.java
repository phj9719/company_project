...
@Controller
public class NUB204CTController {

	private Logger log = LoggerFactory.getLogger(NUB204CTController.class);

	@Resource(name="NUB204CTService")
	private NUB204CTService NUB204CTService;

	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUB204CTController.do")
    ...
    public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUB204CTService, inVar.getString("method"));
			method.invoke(NUB204CTService, new Object[] {inVar, inDataSet, outVar, outMap});
