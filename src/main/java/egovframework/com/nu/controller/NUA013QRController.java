...
@Controller
public class NUA013QRController {
	
	private Logger log = LoggerFactory.getLogger(this.getClass().getName());
	
	@Resource(name="NUA013QRService")
	private NUA013QRService NUA013QRService;
	
	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUA013QRController.do")
	public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUA013QRService, inVar.getString("method"));
			method.invoke(NUA013QRService, new Object[] {inVar, inDataSet, outVar, outMap});
