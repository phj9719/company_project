...
@Controller
public class NUA012QRController {
	
	private Logger log = LoggerFactory.getLogger(this.getClass().getName());
	
	@Resource(name="NUA012QRService")
	private NUA012QRService NUA012QRService; 
	
	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUA012QRController.do")
	public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUA012QRService, inVar.getString("method"));
			method.invoke(NUA012QRService, new Object[] {inVar, inDataSet, outVar, outMap});
