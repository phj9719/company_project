...
@Controller
public class NUA302CTController {

	private Logger log = LoggerFactory.getLogger(NUA302CTController.class);

	@Resource(name="NUA302CTService")
	private NUA302CTService NUA302CTService;

	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUA302CTController.do")
    ...
    public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUA302CTService, inVar.getString("method"));
			method.invoke(NUA302CTService, new Object[] {inVar, inDataSet, outVar, outMap});
