...
@Controller
public class NUB101CTController {

	private Logger log = LoggerFactory.getLogger(NUB101CTController.class);
	
	@Resource(name="NUB101CTService")
	private NUB101CTService NUB101CTService;
	
	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUB101CTController.do")
	public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUB101CTService, inVar.getString("method"));
			method.invoke(NUB101CTService, new Object[] {inVar, inDataSet, outVar, outMap});
