...
@Controller
public class NUB205CTController {

	private Logger log = LoggerFactory.getLogger(NUB205CTController.class);

	@Resource(name="NUB205CTService")
	private NUB205CTService NUB205CTService;

	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUB205CTController.do")
    ...
    public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUB205CTService, inVar.getString("method"));
			method.invoke(NUB205CTService, new Object[] {inVar, inDataSet, outVar, outMap});
