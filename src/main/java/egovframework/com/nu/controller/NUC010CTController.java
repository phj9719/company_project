...
@Controller
public class NUC010CTController {
	
	private Logger log = LoggerFactory.getLogger(NUC010CTController.class);
	
	@Resource(name = "NUC010CTService")
	private egovframework.com.nu.service.NUC010CTService NUC010CTService;
	
	@Resource(name = "LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUC010CTController.do")
	public NexacroResult operate(HttpServletRequest request) {
		...
		try {
			...
			Method method = getMethod(NUC010CTService, inVar.getString("method"));
			method.invoke(NUC010CTService, new Object[] {inVar, inDataSet, outVar, outMap});
