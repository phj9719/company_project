...
@Controller
public class NUB302CTController {

	private Logger log = LoggerFactory.getLogger(NUB302CTController.class);
	
	@Resource(name="NUB302CTService")
	private NUB302CTService NUB302CTservice;
	
	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value="/NUB302CTController.do")
	public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUB302CTservice, inVar.getString("method"));
			method.invoke(NUB302CTservice, new Object[] {inVar, inDataSet, outVar, outMap});
