...
@Controller
public class NUA803QR_DController {

	private Logger log = LoggerFactory.getLogger(NUA803QR_DController.class);
	
	@Resource(name="NUA803QR_DService")
	private NUA803QR_DService NUA803QR_DService;
	
	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value="/NUA803QR_DController.do")
	public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUA803QR_DService, inVar.getString("method"));
			method.invoke(NUA803QR_DService, new Object[] {inVar, inDataSet, outVar, outMap});
