...
import egovframework.com.nu.service.NUA101CTService;

@Controller
public class NUA101CTController {

	private Logger log = LoggerFactory.getLogger(NUA101CTController.class);

	@Resource(name="NUA101CTService")
	private NUA101CTService NUA101CTService;

	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUA101CTController.do")
    ...
    public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUA101CTService, inVar.getString("method"));
			method.invoke(NUA101CTService, new Object[] {inVar, inDataSet, outVar, outMap});
