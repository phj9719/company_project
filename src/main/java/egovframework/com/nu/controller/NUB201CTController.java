...
@Controller
public class NUB201CTController {

	private Logger log = LoggerFactory.getLogger(NUB201CTController.class);
	
	@Resource(name="NUB201CTService")
	private NUB201CTService NUB201CTService;
	
	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUB201CTController.do")
	public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUB201CTService, inVar.getString("method"));
			method.invoke(NUB201CTService, new Object[] {inVar, inDataSet, outVar, outMap});
