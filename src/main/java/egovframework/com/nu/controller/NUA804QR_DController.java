...
@Controller
public class NUA804QR_DController {

	private Logger log = LoggerFactory.getLogger(NUA804QR_DController.class);
	
	@Resource(name="NUA804QR_DService")
	private NUA804QR_DService NUA804QR_DService;
	
	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value="/NUA804QR_DController.do")
	public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUA804QR_DService, inVar.getString("method"));
			method.invoke(NUA804QR_DService, new Object[] {inVar, inDataSet, outVar, outMap});
