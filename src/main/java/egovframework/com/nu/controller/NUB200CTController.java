...
import egovframework.com.nu.service.NUB200CTService;

@Controller
public class NUB200CTController {

	private Logger log = LoggerFactory.getLogger(NUB200CTController.class);

	@Resource(name="NUB200CTService")
	private NUB200CTService NUB200CTService;

	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUB200CTController.do")
    ...
    public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUB200CTService, inVar.getString("method"));
			method.invoke(NUB200CTService, new Object[] {inVar, inDataSet, outVar, outMap});
