...
@Controller
public class NUA203CTController {

	private Logger log = LoggerFactory.getLogger(NUA203CTController.class);

	@Resource(name="NUA203CTService")
	private NUA203CTService NUA203CTService;

	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUA203CTController.do")
    ...
    public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUA203CTService, inVar.getString("method"));
			method.invoke(NUA203CTService, new Object[] {inVar, inDataSet, outVar, outMap});
