...
@Controller
public class NUA808QR_DController {

	private Logger log = LoggerFactory.getLogger(NUA808QR_DController.class);
	
	@Resource(name="NUA808QR_DService")
	private NUA808QR_DService NUA808QR_DService;
	
	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value="/NUA808QR_DController.do")
	public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUA808QR_DService, inVar.getString("method"));
			method.invoke(NUA808QR_DService, new Object[] {inVar, inDataSet, outVar, outMap});
