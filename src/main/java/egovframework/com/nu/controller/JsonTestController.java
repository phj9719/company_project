...
public class JsonTestController {
	...
	private Logger log = LoggerFactory.getLogger(JsonTestController.class);
	...
	public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(JsonTestService, inVar.getString("method"));
			method.invoke(JsonTestService, new Object[] {inVar, inDataSet, outVar, outMap});
