...
@Controller
public class NUB202CTController {

	private Logger log = LoggerFactory.getLogger(NUB202CTController.class);

	@Resource(name="NUB202CTService")
	private NUB202CTService NUB202CTService;

	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUB202CTController.do")
    ...
    public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUB202CTService, inVar.getString("method"));
			method.invoke(NUB202CTService, new Object[] {inVar, inDataSet, outVar, outMap});
