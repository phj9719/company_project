...
@Controller
public class NUB101CT_DController {

	private Logger log = LoggerFactory.getLogger(NUB101CT_DController.class);
	
	@Resource(name="NUB101CT_DService")
	private NUB101CT_DService NUB101CT_DService;
	
	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUB101CT_DController.do")
	public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUB101CT_DService, inVar.getString("method"));
			method.invoke(NUB101CT_DService, new Object[] {inVar, inDataSet, outVar, outMap});
