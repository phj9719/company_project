...
@Controller
public class NUA204CTController {

	private Logger log = LoggerFactory.getLogger(NUA204CTController.class);

	@Resource(name="NUA204CTService")
	private NUA204CTService NUA204CTService;

	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUA204CTController.do")
    ...
    public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUA204CTService, inVar.getString("method"));
			method.invoke(NUA204CTService, new Object[] {inVar, inDataSet, outVar, outMap});
