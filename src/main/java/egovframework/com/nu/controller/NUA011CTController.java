...
@Controller
public class NUA011CTController {

	private Logger log = LoggerFactory.getLogger(NUA011CTController.class);

	@Resource(name="NUA011CTService")
	private NUA011CTService NUA011CTService;

	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUA011CTController.do")
    ...
    public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUA011CTService, inVar.getString("method"));
			method.invoke(NUA011CTService, new Object[] {inVar, inDataSet, outVar, outMap});
