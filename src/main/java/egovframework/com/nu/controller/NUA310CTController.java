...
@Controller
public class NUA310CTController {

	private Logger log = LoggerFactory.getLogger(NUA310CTController.class);

	@Resource(name="NUA310CTService")
	private NUA310CTService NUA310CTService;

	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUA310CTController.do")
    ...
    public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUA310CTService, inVar.getString("method"));
			method.invoke(NUA310CTService, new Object[] {inVar, inDataSet, outVar, outMap});
