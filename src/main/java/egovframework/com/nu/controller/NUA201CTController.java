...
@Controller
public class NUA201CTController {

	private Logger log = LoggerFactory.getLogger(NUA201CTController.class);

	@Resource(name="NUA201CTService")
	private NUA201CTService NUA201CTService;

	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/NUA201CTController.do")
    ...
    public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(NUA201CTService, inVar.getString("method"));
			method.invoke(NUA201CTService, new Object[] {inVar, inDataSet, outVar, outMap});
