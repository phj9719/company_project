package egovframework.com.sm.controller;
...
@Controller
public class SMD060CTController {

	private Logger log = LoggerFactory.getLogger(SMD060CTController.class);

	@Resource(name="SMD060CTService")
	private SMD060CTService SMD060CTService;

	@Resource(name="LanguageUtil")
	private LanguageUtil languageUtil;
	
	@RequestMapping(value = "/SMD060CTController.do")
    ...
    public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			Method method = getMethod(SMD060CTService, inVar.getString("method"));
			method.invoke(SMD060CTService, new Object[] {inVar, inDataSet, outVar, outMap});
	...
	@RequestMapping(value = "/SMD060CT_insert2.do")
    public NexacroResult insert(HttpServletRequest request) {
    	NexacroResult result = new NexacroResult();
    	VariableList inVar 	 = new VariableList();
    	...
    	try {
			...
			result = SMD060CTService.insert2(inVar, inDataSet);
	...
	@RequestMapping(value = "/SMD060CT_update.do")
    public NexacroResult update(HttpServletRequest request) {
    	NexacroResult result = new NexacroResult();
    	VariableList inVar 	 = new VariableList();
    	...
    	try {
			...
			result = SMD060CTService.update(inVar, inDataSet);
	...
	@RequestMapping(value = "/SMD060CT_send.do")
	public NexacroResult send(HttpServletRequest request) {
		...
		try {
			...
			result = SMD060CTService.send(inVar, inDataSet);
