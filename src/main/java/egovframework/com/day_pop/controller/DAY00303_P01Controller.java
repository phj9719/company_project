...
@Controller
public class DAY00303_P01Controller {
	
	private Logger log = LoggerFactory.getLogger(DAY00303_P01Controller.class);
	
	@Resource(name="DAY00303_P01Service")
	private DAY00303_P01Service DAY00303_P01Service;
	
	@RequestMapping(value = "/DAY00303_P01Controller.do")
	public NexacroResult save(HttpServletRequest request) {
    	...
    	try {
			...
			if (log.isDebugEnabled())
				log.debug("DAY00303_P01Controller method : {}", method);
			
			switch (method) {
				case "save" :
					result = DAY00303_P01Service.save(inVar, inDataSet);
					break;
			}
