...
@Controller
public class DAY00201_P06Controller {
private Logger log = LoggerFactory.getLogger(DAY00201_P06Controller.class);
	
	@Resource(name="DAY00201_P06Service")
	private DAY00201_P06Service DAY00201_P06Service;
	
	@RequestMapping(value = "/DAY00201_P06Controller.do")
	public NexacroResult operate(HttpServletRequest request) {
    	...
    	try {
			...
			switch (method) {
				case "save" ://저장(삽입,수정)
					result = DAY00201_P06Service.save(inVar, inDataSet);
					break;
			}
