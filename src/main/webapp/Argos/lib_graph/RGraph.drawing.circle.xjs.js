...
(function()
{
    return function(path)
    {
        ...
        if (!nexacro.RGraph.Drawing_Circle)
        {
        	/**
        	 ...
        	 */
        	nexacro.RGraph.Drawing_Circle = function (RG, conf, x, y, radius)
        	{
        		var id = conf.id;
        			...
        			this.Highlight = function (shape)
        		{
        			if (prop["chart.tooltips.highlight"])
        			{
        				...
        				{
        					// pa2(co, ['b','a',this.centerx, this.centery, this.radius + 0.5, 0, RG.TWOPI, false,'f',prop['chart.highlight.fill'],'s',prop['chart.highlight.stroke']]);
        					RG.pa2(co,
        						'b a % % % % % % f % s %',
        						this.centerx,
        						this.centery,
