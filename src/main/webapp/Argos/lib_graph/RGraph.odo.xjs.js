...
(function()
{
    return function(path)
    {
        ...
        if (!nexacro.RGraph.Odometer)
        {
        	 ...
        	 */
        	nexacro.RGraph.Odometer = function (conf)
        	{
        		var RG = arguments[1];
        		...
        		this.properties =
        			...
        			'chart.background.color' : '#eeeeee',
        			'chart.background.lines.color' : '#dddddd',
        			'chart.background.image.background' : "", // hsji
        			'chart.background.image.gradation' : "",
        			'chart.background.image.stretch' : false,
        			'chart.background.image.x' : 0,
        			'chart.background.image.y' : 0,
        			...
        			'chart.needle.extra' : [],
        			'chart.needle.triangle.border' : '#aaaaaa',
        			'chart.text.size' : 12,
        			...
        			'chart.green.color' : 'gradient(#00cc00:white:#00cc00)',
        			'chart.yellow.color' : 'gradient(#ffff00:white:#ffff00)',
        			'chart.red.color' : 'gradient(#ff0000:white:#ff0000)',
        			'chart.label.area' : 35,
        			...
        			'chart.tickmarks.big.color' : '#999999',
        			...
        			this.Draw = function ()
        		{
        			 ...
        			 */
        			if (prop["chart.key"] && prop["chart.key"].length > 0 && ca.width > ca.height)
        			{
        			...
        			this.DrawBackground = function ()
        		{
        			...
        			if (prop["chart.border"])
        			{
        				var grdcol = "gradient(" + prop["chart.border.color1"] + ":" + prop["chart.border.color2"] + ":" + prop["chart.border.color3"] + ")";
        				var grad = RG.createRadialGradient(co, this.centerx, this.centery, this.radius, this.centerx, this.centery, this.radius + 20, grdcol);

        				co.beginPath();
        				co.fillStyle = grad;
        				RG.setElementCommonStyle(co, co.fillStyle, 1);
        				co.strokeStyle = [0, 0, 0, 0];
        				RG.setElementCommonStyle(co, co.strokeStyle, 2);
        				co.lineWidth = 0.001;
        				co.setElementLineWidth(co.lineWidth);
        			...
        			this.DrawNeedle = function (value, color)
        		{
        			...
        			else if (prop["chart.needle.type"] == 'triangle')
        			{
        				...
        				co.setElementLineWidth(co.lineWidth);
        				co.lineEnd = 'square';
        				co.setElementLineEnd(co.lineEnd);
        				co.lineJoin = 'miter';
        				co.setElementLineJoin(co.lineJoin);
