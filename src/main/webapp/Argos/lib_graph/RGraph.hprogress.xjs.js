...
(function()
{
    return function(path)
    {
        ...
        if (!nexacro.RGraph.HProgress)
        {
        	 ...
        	 */
        	nexacro.RGraph.HProgress = function (conf)
        	{
        		// argument 0 : option
        		// 1 : rg common
        		// 2 : canvas id
        		 ...
        		 */
        		var linear_data = RG.array_linearize(value);
        			...
        			this.DrawLabels = function ()
        		{
        			...
        			var xPoints = [],yPoints = [],font = prop["chart.text.font"],size = prop["chart.text.size"],offsetx = prop["chart.labels.offsetx"],offsety = prop["chart.labels.offsety"];
        			...
        			this.DrawSpecificLabels = function ()
        		{
        			...
        			if (labels)
        			{
        				var font = prop["chart.text.font"],size = prop["chart.text.size"],valign = (prop["chart.labels.position"] == 'top' ? 'bottom' : 'top'),step = this.width / (labels.length - 1),offsetx = prop["chart.labels.offsetx"],offsety = prop["chart.labels.offsety"];
