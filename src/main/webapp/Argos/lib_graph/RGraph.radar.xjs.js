...
(function()
{
    return function(path)
    {
        ...
        if (!nexacro.RGraph.Radar)
        {
        	 ...
        	 */
        	nexacro.RGraph.Radar = function (conf)
        	{
        		var RG = arguments[1];
        		...
        		for (var i = 0,len = conf.data.length; i < len; ++i)
        		{
        			...
        			this.original_data.push(RG.arrayClone(conf.data[i]));
        			this.data.push(RG.arrayClone(conf.data[i]));
        			this.max = Math.max(this.max, RG.arrayMax(conf.data[i]));
        		}
        		...
        		this.properties =
        			...
        			'chart.strokestyle' : '#aaaaaadd',
        			'chart.gutter.left' : 25,
        			'chart.gutter.right' : 25,
        			'chart.gutter.top' : 25,
        			'chart.gutter.bottom' : 25,
        			'chart.linewidth' : 1,
        			'chart.colors' : ['#ffff0099', '#00ffff99', '#ff000099', 'red', 'green', 'blue', 'pink', 'aqua', 'brown', 'orange', 'grey'],
        			...
        			'chart.key.interactive.highlight.chart.stroke' : '#ff000044',
        			'chart.key.interactive.highlight.label' : '#ff000033',
        			...
        			'chart.numxticks' : 5,
        			'chart.numyticks' : 5,
        			'chart.axes.color' : '#00000066',
        			'chart.highlights' : false,
        			'chart.highlights.stroke' : '#dfffdd',
        			...
        			'chart.fill.highlight.fill' : '#ffffffaa',
        			'chart.fill.highlight.stroke' : '#00000000',
        			...
        			this.Draw = function ()
        		{
        			...
        			{
        				this.centerx = 2 * prop["chart.centerx"];
        			}
        			if (typeof prop["chart.centery"] == 'number')
        			{
        				this.centery = 2 * prop["chart.centery"];
        			}
        			...
        			this.DrawChart = function ()
        		{
        			...
        			for (var dataset = 0; dataset < this.data.length; ++dataset)
        			{
        				...
        				RG.setElementCommonStyle(co, co.strokeStyle, 2);
        				co.fillStyle = prop["chart.colors"][dataset] ? prop["chart.colors"][dataset] : '#0000000';
        			...
        			this.DrawLabels = function ()
        		{
        			...
        			if (labels && labels.length > 0)
        			{
        				...
        				var bgFill = prop["chart.labels.background.fill"],bold = prop["chart.labels.bold"],bgBoxed = prop["chart.labels.boxed"],offset = prop["chart.labels.offset"],font = prop["chart.text.font"],size = prop["chart.text.size"],radius = this.radius,color = prop["chart.labels.color"] || prop["chart.text.color"];
        			...
        			this.DrawAxisLabels = function ()
        		{
        			...
        			var r = this.radius,font = prop["chart.text.font"],size = typeof (prop["chart.text.size.scale"]) == 'number' ? prop["chart.text.size.scale"] : prop["chart.text.size"],axes = prop["chart.labels.axes"].toLowerCase(),color = prop["chart.labels.axes.boxed.background"],drawzero = false,units_pre = prop["chart.units.pre"],units_post = prop["chart.units.post"],decimals = prop["chart.scale.decimals"],bold = prop["chart.labels.axes.bold"],boxed = prop["chart.labels.axes.boxed"],centerx = this.centerx,centery = this.centery,scale = this.scale;
        		...
        		this.parseSingleColorForGradient = function (color)
        		{
        			...
        			{
        				// Create the gradient
        				var grad = RG.createRadialGradient(co, this.centerx, this.centery, 0, this.centerx, this.centery, this.radius, color);
        			}
        		...
        		this.addFillListeners =
        			this.AddFillListeners = function (obj, e)
        		{
        			// var canvas  = e.target;
        			...
        			this.DatasetTooltip = function (e, dataset)
        		{
        			...
        			var shape = this.getPoint(e);
        			// trace("shape:" + shape + ":" + mouseXY);
        			// trace(shape["x"] + ":" + shape["y"] + ":" + shape["x1"] + ":" + shape["y1"]);
        			// var x    = 0;
        			// var y    = this.coords2[dataset][0][1] + RG.getCanvasXY(ca)[1];


        			// Show a tooltip
        			RG.Tooltip(this, text, mouseXY[0], mouseXY[1], 0, e);
        		};
