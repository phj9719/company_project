(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("bnt_exe","671","5","162","58",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("EXCUTE");
            ...
            obj = new Div("div_input","6","5","657","83",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            ...
            obj = new Grid("grd_top","877","5","150","82",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            ...
            obj = new Grid("grd_mid","841","69","153","57",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            ...
            obj = new Grid("grd_bottom","699","69","153","57",null,null,null,null,null,null,this);
            obj.set_taborder("18");
            ...
            obj = new TextArea("textarea_top","6","96",null,"139","0%",null,null,null,null,null,this);
            obj.set_taborder("19");
            this.addChild(obj.name, obj);

            obj = new TextArea("textarea_mid","6","249",null,"139","0%",null,null,null,null,null,this);
            obj.set_taborder("20");
            this.addChild(obj.name, obj);

            obj = new TextArea("textarea_bottom","6","403",null,"139","0%",null,null,null,null,null,this);
            obj.set_taborder("21");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.addIncludeScript("AutoComponent_copy.xfdl","lib::sct_com.xjs");
        this.registerScript("AutoComponent_copy.xfdl", function() {
        ...
        this.bnt_exe_onclick = function (obj, e)
        {
        	...
        	if (flag == true)
        	{
        		...
        		var params = "/commonController.do";
        		var inDatasets = "";
        		var outDatasets = "ds_top=output1 ds_mid=output2 ds_bottom=output3";
        		var argument = "method=getList "
        			 + "sqlId='TEST_AUTOCOMPONENTS01 TEST_AUTOCOMPONENTS02 TEST_AUTOCOMPONENTS02' "
        			 + "TABLENAME=" + TableName + " "
        			 + "AS_TOP=" + top + " "
        			 + "AS_LEFT=" + left + " "
        			 + "AS_WIDTH=" + width + " "
        ...
        this.loadIncludeScript("AutoComponent_copy.xfdl");
