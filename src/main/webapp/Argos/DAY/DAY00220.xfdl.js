(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("DAY00220.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("DAY00220.xfdl","lib::pgm_com.xjs");
        this.registerScript("DAY00220.xfdl", function() {
        /***********************************************************************
         * 화면ID   	: DAY00210
         * 화면명   	: 2-10 투약기록일지
         * 화면설명 	:
        ...
        this.loadIncludeScript("DAY00220.xfdl");
