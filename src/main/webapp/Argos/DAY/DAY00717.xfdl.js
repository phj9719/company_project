(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00717");
            this.set_titletext("7-17 실내·외 소독일지");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"30\"/><Column size=\"100\"/><Column size=\"30\"/><Column size=\"100\"/><Column size=\"30\"/><Column size=\"100\"/><Column size=\"30\"/><Column size=\"100\"/><Column size=\"30\"/><Column size=\"100\"/><Column size=\"30\"/><Column size=\"100\"/><Column size=\"30\"/><Column size=\"100\"/><Column size=\"30\"/><Column size=\"100\"/><Column size=\"30\"/><Column size=\"100\"/><Column size=\"30\"/><Column size=\"100\"/><Column size=\"30\"/><Column size=\"100\"/><Column size=\"30\"/></Columns><Rows><Row size=\"21\" band=\"head\"/><Row size=\"21\"/></Rows><Band id=\"head\"><Cell text=\"1월\"/><Cell col=\"1\" text=\"O\"/><Cell col=\"2\" text=\"2월\"/><Cell col=\"3\" text=\"O\"/><Cell col=\"4\" text=\"3월\"/><Cell col=\"5\" text=\"O\"/><Cell col=\"6\" text=\"4월\"/><Cell col=\"7\" text=\"O\"/><Cell col=\"8\" text=\"5월\"/><Cell col=\"9\" text=\"O\"/><Cell col=\"10\" text=\"6월\"/><Cell col=\"11\" text=\"O\"/><Cell col=\"12\" text=\"7월\"/><Cell col=\"13\" text=\"O\"/><Cell col=\"14\" text=\"8월\"/><Cell col=\"15\" text=\"O\"/><Cell col=\"16\" text=\"9월\"/><Cell col=\"17\" text=\"O\"/><Cell col=\"18\" text=\"10월\"/><Cell col=\"19\" text=\"O\"/><Cell col=\"20\" text=\"11월\"/><Cell col=\"21\" text=\"O\"/><Cell col=\"22\" text=\"12월\"/><Cell col=\"23\" text=\"O\"/></Band><Band id=\"body\"><Cell displaytype=\"date\" cursor=\"pointer\" expandchar=\"dotd\" text=\"bind:jan\"/><Cell col=\"1\" text=\"bind:jan_c\"/><Cell col=\"2\" cursor=\"pointer\" displaytype=\"date\" expandchar=\"dotd\" text=\"bind:feb\"/><Cell col=\"3\" text=\"bind:feb_c\"/><Cell col=\"4\" cursor=\"pointer\" displaytype=\"date\" expandchar=\"dotd\" text=\"bind:mar\"/><Cell col=\"5\" text=\"bind:mar_c\"/><Cell col=\"6\" cursor=\"pointer\" displaytype=\"date\" expandchar=\"dotd\" text=\"bind:apr\"/><Cell col=\"7\" text=\"bind:apr_c\"/><Cell col=\"8\" cursor=\"pointer\" displaytype=\"date\" expandchar=\"dotd\" text=\"bind:may\"/><Cell col=\"9\" text=\"bind:may_c\"/><Cell col=\"10\" cursor=\"pointer\" displaytype=\"date\" expandchar=\"dotd\" text=\"bind:jun\"/><Cell col=\"11\" text=\"bind:jun_c\"/><Cell col=\"12\" cursor=\"pointer\" displaytype=\"date\" expandchar=\"dotd\" text=\"bind:jul\"/><Cell col=\"13\" text=\"bind:jul_c\"/><Cell col=\"14\" cursor=\"pointer\" displaytype=\"date\" expandchar=\"dotd\" text=\"bind:aug\"/><Cell col=\"15\" text=\"bind:aug_c\"/><Cell col=\"16\" cursor=\"pointer\" displaytype=\"date\" expandchar=\"dotd\" text=\"bind:sep\"/><Cell col=\"17\" text=\"bind:sep_c\"/><Cell col=\"18\" cursor=\"pointer\" displaytype=\"date\" expandchar=\"dotd\" text=\"bind:oct\"/><Cell col=\"19\" text=\"bind:oct_c\"/><Cell col=\"20\" cursor=\"pointer\" displaytype=\"date\" expandchar=\"dotd\" text=\"bind:nov\"/><Cell col=\"21\" text=\"bind:nov_c\"/><Cell col=\"22\" cursor=\"pointer\" displaytype=\"date\" expandchar=\"dotd\" text=\"bind:dec\"/><Cell col=\"23\" text=\"bind:dec_c\"/></Band></Format></Formats>");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("sta_subTitle","6","3","250","26",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("1");
            obj.set_text("2022년 실내·외 정기소독일지");
            obj.set_cssclass("lb01");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("sta_remark","grd_list:-1878","grd_list:2","350","16",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("2");
            obj.set_text("▲ 실내·외 소독일지 작성, 조회시 운영일자 \'더블클릭 ! \'");
            this.div_cont.addChild(obj.name, obj);

            obj = new Div("div_search","0","0","430","30",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_search",null,"5","70","25","0",null,null,null,null,null,this.div_search.form);
            obj.set_taborder("4");
            obj.set_text("조회");
            ...
            obj = new Div("div_func","div_search:10","0","860","30",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_formscrollbartype("none");
            this.addChild(obj.name, obj);

            obj = new Button("btn_reportMon","0","5","205","25",null,null,null,null,null,null,this.div_func.form);
            obj.set_taborder("0");
            obj.set_text("실내·외 정기소독일지 출력(월)");
        ...
        // User Script
        this.addIncludeScript("DAY00717.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("DAY00717.xfdl","lib::pgm_com.xjs");
        this.registerScript("DAY00717.xfdl", function() {
        /***********************************************************************
         * 화면ID   	: DAY00717
         * 화면명   	: 7-17 실내·외 소독일지
         * 화면설명 	: 실내·외 소독일지 작성여부를 확인하는 화면
         * 작성일   	: 2022-03-24
         * 작성자   	: 조기종
         * 수정이력 	:
         ***********************************************************************
        ...
        this.fn_search = function ()
        {
        	...
        	const argument = "method=getList "
        				   + "sqlId=DAY00717.DAY00717_DS_LIST_S ";
        ...
        this.fn_callback = function (strSvcID, nErrorCode, strErrorMsg)
        {
        	if (nErrorCode == 0)
        	{
        		if (strSvcID == "search")
        		{
        			...
        			const gTitleStr = year + "년 실내·외 정기소독일지";
        ...
        this.div_func_btn_reportMon_onclick = function(obj,e)
        {
        	...
        	Sct.popup(this, "Mon", 450, 400, "", param, "DAY_POP::DAY00717_P01.xfdl", "fn_popCallback");
        };
        ...
        this.div_cont_grd_list_oncelldblclick = function(obj,e)
        {
        		...
        		|| e.col == decIdx)
        	{
        		...
        		Sct.popup(this, "record", 450, 400, "", param, "DAY_POP::DAY00717_P01.xfdl", "fn_popCallback");
        	}
        };
        ...
        this.loadIncludeScript("DAY00717.xfdl");
