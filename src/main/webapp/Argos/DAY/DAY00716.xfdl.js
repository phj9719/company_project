(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00716");
            this.set_titletext("7-16 비상구점검일지");
            ...
            obj = new Button("btn_reportMon","0","5","185","25",null,null,null,null,null,null,this.div_func.form);
            obj.set_taborder("0");
        ...
        // User Script
        this.addIncludeScript("DAY00716.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("DAY00716.xfdl","lib::pgm_com.xjs");
        this.registerScript("DAY00716.xfdl", function() {
        /***********************************************************************
         * 화면ID   	: DAY00716
         * 화면명   	: 7-16 비상구점검일지
        ...
        this.loadIncludeScript("DAY00716.xfdl");
