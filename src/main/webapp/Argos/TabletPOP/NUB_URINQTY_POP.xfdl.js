(function()
{
    return function()
    {
        ...
        {
            this.set_name("NUB_URINQTY_POP");
            this.set_titletext("소변량 입력 팝업");
            ...
            obj._setContents("<ColumnInfo><Column id=\"URIN_QTY\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj = new Div("Div01","62","95","210","24",null,null,null,null,null,null,this.div_pop_main.form);
            obj.set_taborder("4");
            obj.set_background("#ffc000");
            ...
            obj = new Static("sta_min_select","13","-10","210","60",null,null,null,null,null,null,this.div_pop_main.form.div_left.form);
            obj.set_taborder("0");
            obj.set_text("소변량(ml) 선택");
            ...
            obj = new Div("Div01","76","20","210","24",null,null,null,null,null,null,this.div_pop_main.form.div_right.form);
            obj.set_taborder("17");
            obj.set_background("#ffc000");
            this.div_pop_main.form.div_right.addChild(obj.name, obj);

            obj = new Static("sta_min_insert","71","-10","220","60",null,null,null,null,null,null,this.div_pop_main.form.div_right.form);
            obj.set_taborder("0");
            obj.set_text("소변량(ml) 입력");
            obj.set_textAlign("center");
            obj.set_cssclass("sta_tPopupTitle");
            obj.set_visible("true");
            this.div_pop_main.form.div_right.addChild(obj.name, obj);
            ...
            obj = new Div("Div00","74","26","210","24",null,null,null,null,null,null,this.div_pop_main.form.div_right.form);
            obj.set_taborder("16");
            this.div_pop_main.form.div_right.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("NUB_URINQTY_POP.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUB_URINQTY_POP.xfdl","lib::pgm_com.xjs");
        this.addIncludeScript("NUB_URINQTY_POP.xfdl","lib::tpgm_com.xjs");
        this.registerScript("NUB_URINQTY_POP.xfdl", function() {
        ...
        this.loadIncludeScript("NUB_URINQTY_POP.xfdl");
