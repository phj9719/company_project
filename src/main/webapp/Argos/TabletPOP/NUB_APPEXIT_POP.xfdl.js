(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_popTitle","158","26","135","50",null,null,null,null,null,null,this.div_pop_main.form);
            obj.set_taborder("0");
            obj.set_text("앱 종료");
        ...
        // User Script
        this.addIncludeScript("NUB_APPEXIT_POP.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUB_APPEXIT_POP.xfdl","lib::pgm_com.xjs");
        this.addIncludeScript("NUB_APPEXIT_POP.xfdl","lib::tpgm_com.xjs");
        this.registerScript("NUB_APPEXIT_POP.xfdl", function() {
        this.executeIncludeScript("lib::sct_com.xjs"); /*include "lib::sct_com.xjs"*/;
        this.executeIncludeScript("lib::pgm_com.xjs"); /*include "lib::pgm_com.xjs"*/;
        this.executeIncludeScript("lib::tpgm_com.xjs"); /*include "lib::tpgm_com.xjs"*/;

        this.NUB_APPEXIT_POP_onload = function(obj,e)
        {

        };

        // 디바이스 버튼 이벤트
        this.NUB_APPEXIT_POP_ondevicebuttonup = function(obj,e)
        {
        	if (e.button == 2)
        	{
        		this.close();
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("ondevicebuttonup",this.NUB_APPEXIT_POP_ondevicebuttonup,this);
            this.addEventHandler("onload",this.NUB_APPEXIT_POP_onload,this);
        ...
        this.loadIncludeScript("NUB_APPEXIT_POP.xfdl");
