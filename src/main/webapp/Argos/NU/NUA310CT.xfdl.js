(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new BindItem("item348","div_search.form.cmb_enter_gb","value","ds_search","RETIRE_YN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("NUA310CT.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUA310CT.xfdl","lib::pgm_com.xjs");
        this.registerScript("NUA310CT.xfdl", function() {
        /***********************************************************************
         * 화면ID   : NUA310CT.xfdl
         * 화면명   :
         * 화면설명 : 집중배설관찰일지
        ...
        {
             //조회전 그리드에 변경된 데이터가 있을경우 ..
             if(Sct.Grid.isUpdate(this.ds_list)||Sct.Grid.isUpdate(this.ds_list2)) {
                 //메세지로 변경된 데이터 여부와 상관없이 조회 할지 확인
                 if(!Sct.confirm(this,"000171","")){
                     return false;
                 }
        ...
        this.fn_save_pre = function ()
        {
        	...
        	this.ds_list2.set_updatecontrol(false);
        	if(this.saveType == "I") {
        	...
        	if(this.saveType2 == "I") {
        		this.ds_list2.setRowType(0, 2);
        	}
        	if(this.saveType2 == "U") {
        		this.ds_list2.setRowType(0, 4);
        	}
        	this.ds_list.set_updatecontrol(true);
        	this.ds_list2.set_updatecontrol(true);
        	return true;
        };
        ...
        this.fn_search = function ()
        {
        	...
        	var argument = "method=getListPaging "
        		+ "sqlId=NUA310CT.NUA310CT_DS_HEAD_S ";
        ...
        this.fn_callback = function (strSvcID, nErrorCode, strErrorMsg)
        {
        	if (nErrorCode == 0)
        	{
        		...
        		}else if(strSvcID == "save" || strSvcID == "delete")
        		{
        			...
        			this.saveType2 = "U"; // 저장 구분 : update
        			if(this.ds_list2.rowcount==0){
        				this.fn_list2_add();
        				this.saveType2 = "I"; // 저장 구분 : update
        			}
        ...
        this.fn_list_addrow = function()
        {
        	...
        	this.ds_list.setColumn(nRow, "RES_NM", this.ds_head.getColumn(this.ds_head.rowposition,"NAME"));
        	this.ds_list.setColumn(nRow, "EXC_DT", this.ds_search.getColumn(this.ds_search.rowposition,"DT"));
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_cont.form.div_right.form.chk_tm00.addEventHandler("onclick",this.div_cont_div_right_chk_tm00_onclick,this);
        ...
        this.loadIncludeScript("NUA310CT.xfdl");
