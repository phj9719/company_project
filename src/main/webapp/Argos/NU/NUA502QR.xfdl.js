(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"90\"/><Column size=\"100\"/><Column size=\"90\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"순번\"/><Cell col=\"1\" text=\"일자\"/><Cell col=\"2\" text=\"입소자성명\"/><Cell col=\"3\" text=\"층\"/><Cell col=\"4\" text=\"생활실\"/><Cell col=\"5\" text=\"지남력(5/5)\"/><Cell col=\"6\" text=\"주의력(3/3)\"/><Cell col=\"7\" text=\"시공간기능(2/2)\"/><Cell col=\"8\" text=\"집행기능(6/6)\"/><Cell col=\"9\" text=\"기억력(10/10)\"/><Cell col=\"10\" text=\"언어기능(4/4)\"/><Cell col=\"11\" text=\"총점(30/30)\"/><Cell col=\"12\" text=\"판정\"/><Cell col=\"13\" text=\"처리자\" displaytype=\"normal\"/><Cell col=\"14\" text=\"등록자ID\"/><Cell col=\"15\" text=\"등록자명\"/><Cell col=\"16\" text=\"등록일자\"/><Cell col=\"17\" text=\"수정자명\"/><Cell col=\"18\" text=\"수정일자\"/></Band><Band id=\"body\"><Cell text=\"bind:ROWNUM\"/><Cell col=\"1\" text=\"bind:CIS_DT\" displaytype=\"date\"/><Cell col=\"2\" text=\"bind:RES_NM\" displaytype=\"normal\"/><Cell col=\"3\" text=\"bind:AREA\" displaytype=\"combotext\" combodataset=\"ds_area\" combodatacol=\"ARE_NM\" combocodecol=\"ARE_CD\"/><Cell col=\"4\" text=\"bind:LOCATION\" displaytype=\"combotext\" combodataset=\"ds_location_all\" combodatacol=\"LOC_NM\" combocodecol=\"LOC_CD\" comboautoselect=\"true\"/><Cell col=\"5\" text=\"bind:PT1\" editinputtype=\"number\" editautoselect=\"true\" textAlign=\"right\" displaytype=\"normal\" combodataset=\"ds_nu_bomi_cont\" combodatacol=\"CMNM\" combocodecol=\"CMCD\"/><Cell col=\"6\" text=\"bind:PT2\" editinputtype=\"number\" editautoselect=\"true\" textAlign=\"right\" displaytype=\"normal\" combodataset=\"ds_nu_bomi_level\" combodatacol=\"CMNM\" combocodecol=\"CMCD\"/><Cell col=\"7\" text=\"bind:PT3\" editinputtype=\"number\" maskeditformat=\"#0.#\" displaytype=\"normal\" editautoselect=\"true\" textAlign=\"right\"/><Cell col=\"8\" text=\"bind:PT4\" editinputtype=\"number\" editautoselect=\"true\" textAlign=\"right\" displaytype=\"normal\" combodataset=\"ds_nu_bomi_level\" combodatacol=\"CMNM\" combocodecol=\"CMCD\"/><Cell col=\"9\" text=\"bind:PT5\" editinputtype=\"number\" editautoselect=\"true\" textAlign=\"right\" displaytype=\"normal\" combodataset=\"ds_nu_bomi_level\" combodatacol=\"CMNM\" combocodecol=\"CMCD\"/><Cell col=\"10\" text=\"bind:PT6\" editinputtype=\"number\" editautoselect=\"true\" textAlign=\"right\" displaytype=\"normal\" combodataset=\"ds_nu_bomi_level\" combodatacol=\"CMNM\" combocodecol=\"CMCD\"/><Cell col=\"11\" text=\"bind:PT7\" editinputtype=\"number\" editautoselect=\"true\" textAlign=\"right\" displaytype=\"normal\" combodataset=\"ds_nu_bomi_level\" combodatacol=\"CMNM\" combocodecol=\"CMCD\"/><Cell col=\"12\" text=\"bind:CIS_GRADE\" editinputtype=\"number\" editautoselect=\"true\" textAlign=\"center\" displaytype=\"combotext\" combodataset=\"ds_nu_cist_grade\" combodatacol=\"CMNM\" combocodecol=\"CMCD\"/><Cell col=\"13\" text=\"bind:MANAGER_NM\" displaytype=\"normal\"/><Cell col=\"14\" text=\"bind:REG_USER\"/><Cell col=\"15\" text=\"bind:REG_USER_NM\"/><Cell col=\"16\" text=\"bind:REG_DT\" displaytype=\"date\"/><Cell col=\"17\" text=\"bind:MOD_USER_NM\"/><Cell col=\"18\" displaytype=\"date\" text=\"bind:MOD_DT\"/></Band></Format></Formats>");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("statc_divcont_title","0","7","200","22",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("1");
            obj.set_text("CIST검사 리스트");
        ...
        // User Script
        this.addIncludeScript("NUA502QR.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUA502QR.xfdl","lib::pgm_com.xjs");
        this.registerScript("NUA502QR.xfdl", function() {
        /***********************************************************************
         * 화면ID   : NUA502QR.xfdl
         * 화면명   :
         * 화면설명 : CIST검사
        ...
        {
             var comboDsParamArr = [
        					    { outDsName : "ds_area", sqlId : "NUA502QR.NUA502QR_DS_AREA_S",param : {COMPANY_CD : fv_Company}, bEmptyRow : true} // 층 조회
        					   , { outDsName : "ds_location_all", sqlId : "NUA502QR.NUA502QR_DS_LOCATION_S",param : {COMPANY_CD : fv_Company}, bEmptyRow : true} // 생활실 전체 조회
                            ];
        ...
        this.fn_search = function ()
        {
        	...
        	var argument = "method=getListPaging "
        		+ "sqlId=NUA502QR.NUA502QR_DS_LIST_S ";
        ...
        this.fn_location_search = function (outDs, col)
        {
        	...
        	var argument = "method=getList "
        		+ "sqlId=NUA502QR.NUA502QR_DS_LOCATION_S "
        ...
        this.div_cont_grd_list_oncelldblclick = function(obj,e)
        {
        	...
        	var param = {
        		...
        		,pDt : this.ds_list.getColumn(e.row,"CIS_DT")
        	};
        	//메뉴 open
        ...
        this.loadIncludeScript("NUA502QR.xfdl");
