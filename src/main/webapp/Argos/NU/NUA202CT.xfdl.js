(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"COMPANY_CD\" type=\"STRING\" size=\"256\"/><Column id=\"PRE_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"RES_ID\" type=\"STRING\" size=\"256\"/><Column id=\"PRE_DT\" type=\"STRING\" size=\"256\"/><Column id=\"PRE_TIME\" type=\"STRING\" size=\"256\"/><Column id=\"PRE_H\" type=\"STRING\" size=\"256\"/><Column id=\"PRE_L\" type=\"STRING\" size=\"256\"/><Column id=\"PULSE\" type=\"STRING\" size=\"256\"/><Column id=\"IR_PRE_H\" type=\"STRING\" size=\"256\"/><Column id=\"IR_PRE_L\" type=\"STRING\" size=\"256\"/><Column id=\"IR_PULSE\" type=\"STRING\" size=\"256\"/><Column id=\"IR_PRE_TIME\" type=\"STRING\" size=\"256\"/><Column id=\"MANAGER_NM\" type=\"STRING\" size=\"256\"/><Column id=\"MANAGER_ID\" type=\"STRING\" size=\"256\"/><Column id=\"REMARK\" type=\"STRING\" size=\"256\"/><Column id=\"REG_PGM_ID\" type=\"STRING\" size=\"256\"/><Column id=\"REG_USER\" type=\"STRING\" size=\"256\"/><Column id=\"REG_DT\" type=\"STRING\" size=\"256\"/><Column id=\"REG_DT_CURR\" type=\"STRING\" size=\"256\"/><Column id=\"REG_DT_LOC\" type=\"STRING\" size=\"256\"/><Column id=\"REG_IP\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_PGM_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_USER\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_DT\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_DT_CURR\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_DT_LOC\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_IP\" type=\"STRING\" size=\"256\"/><Column id=\"REG_USER_NM\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_USER_NM\" type=\"STRING\" size=\"256\"/><Column id=\"AREA\" type=\"STRING\" size=\"256\"/><Column id=\"LOCATION\" type=\"STRING\" size=\"256\"/><Column id=\"RES_NM\" type=\"STRING\" size=\"256\"/><Column id=\"HOUR\" type=\"STRING\" size=\"256\"/><Column id=\"MINUTE\" type=\"STRING\" size=\"256\"/><Column id=\"ROWNUM\" type=\"INT\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_autoenter("select");
            obj.set_readonly("false");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"40\"/><Column size=\"40\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"300\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell expandchar=\"status\"/><Cell col=\"1\" expandchar=\"delete\"/><Cell col=\"2\" text=\"순번\"/><Cell col=\"3\" colspan=\"2\" text=\"시간\"/><Cell col=\"5\" text=\"혈압(H)\" cssclass=\"CellEssential\"/><Cell col=\"6\" text=\"혈압(L)\" cssclass=\"CellEssential\"/><Cell col=\"7\" text=\"맥박\" cssclass=\"CellEssential\"/><Cell col=\"8\" text=\"처리자\"/><Cell col=\"9\" text=\"비고\"/><Cell col=\"10\" text=\"등록자ID\"/><Cell col=\"11\" text=\"등록자명\"/><Cell col=\"12\" text=\"등록일자\"/><Cell col=\"13\" text=\"수정자명\"/><Cell col=\"14\" text=\"수정일자\"/></Band><Band id=\"body\"><Cell/><Cell col=\"1\" displaytype=\"normal\"/><Cell col=\"2\" text=\"bind:ROWNUM\"/><Cell col=\"3\" displaytype=\"combotext\" edittype=\"combo\" text=\"bind:HOUR\" combodataset=\"ds_nu_hour\" combodatacol=\"CMNM\" combocodecol=\"CMCD\"/><Cell col=\"4\" text=\"bind:MINUTE\" displaytype=\"combotext\" edittype=\"combo\" combodataset=\"ds_nu_minute\" combodatacol=\"CMNM\" combocodecol=\"CMCD\"/><Cell col=\"5\" text=\"bind:PRE_H\" edittype=\"normal\" editinputtype=\"number\" editautoselect=\"true\" textAlign=\"right\"/><Cell col=\"6\" text=\"bind:PRE_L\" edittype=\"normal\" editinputtype=\"number\" editautoselect=\"true\" textAlign=\"right\"/><Cell col=\"7\" text=\"bind:PULSE\" edittype=\"normal\" editinputtype=\"number\" editautoselect=\"true\" textAlign=\"right\"/><Cell col=\"8\" text=\"bind:MANAGER_NM\" displaytype=\"normal\" edittype=\"none\" combodataset=\"ds_manager\" combodatacol=\"CMNM\" combocodecol=\"CMCD\" expandshow=\"show\"/><Cell col=\"9\" text=\"bind:REMARK\" edittype=\"normal\" displaytype=\"normal\" textAlign=\"left\"/><Cell col=\"10\" text=\"bind:REG_USER\"/><Cell col=\"11\" text=\"bind:REG_USER_NM\"/><Cell col=\"12\" text=\"bind:REG_DT\" displaytype=\"date\"/><Cell col=\"13\" text=\"bind:MOD_USER_NM\"/><Cell col=\"14\" displaytype=\"date\" text=\"bind:MOD_DT\"/></Band></Format></Formats>");
            this.div_cont.form.div_right.form.div_head.addChild(obj.name, obj);
            ...
            obj = new BindItem("item63","div_search.form.cmb_retire_yn","value","ds_search","RETIRE_YN");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("NUA202CT.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUA202CT.xfdl","lib::pgm_com.xjs");
        this.registerScript("NUA202CT.xfdl", function() {
        /***********************************************************************
         * 화면ID   : NUA202CT
         * 화면명   :
         * 화면설명 : 혈압측정
        ...
        {
             var comboDsParamArr = [
        						   { outDsName : "ds_area", sqlId : "NUA202CT.NUA202CT_DS_AREA_S",param : {COMPANY_CD : fv_Company}, bEmptyRow : true} // 층 조회
        						 , { outDsName : "ds_location_all", sqlId : "NUA202CT.NUA202CT_DS_LOCATION_S",param : {COMPANY_CD : fv_Company}, bEmptyRow : true} // 생활실 전체 조회
                            ];
        ...
        this.fn_search = function ()
        {
        	...
        	var argument = "method=getListPaging "
        		+ "sqlId=NUA202CT.NUA202CT_DS_HEAD_S ";
        ...
        this.fn_save = function ()
        {
        	...
        	var svcId = "save";
        	var params = "/NUA202CTController.do";
        ...
        this.fn_delete = function ()
        {
        	...
        	var sqlId = "NUA202CT.NUA202CT_DS_LIST_D";
        ...
        this.fn_searchDetail = function ()
        {
        	...
        	var argument = "method=getList "
        		+ "sqlId=NUA202CT.NUA202CT_DS_LIST_S "
        ...
        this.fn_location_search = function (outDs, col)
        {
        	...
        	var argument = "method=getList "
        		+ "sqlId=NUA202CT.NUA202CT_DS_LOCATION_S "
        		+ " COMPANY_CD="+fv_Company
        		+ " AREA="+col;
        ...
        this.fn_head_addrow = function(obj,e)
        {
        	...
        	this.ds_list.setColumn(nRow, "PRE_DT",this.ds_search.getColumn(0, "DATE"));
        ...
        this.loadIncludeScript("NUA202CT.xfdl");
