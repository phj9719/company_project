(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("NUA305CT.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUA305CT.xfdl","lib::pgm_com.xjs");
        this.registerScript("NUA305CT.xfdl", function() {
        /***********************************************************************
         * 화면ID   : NUA305CT.xfdl
         * 화면명   :
         * 화면설명 : 침구교체일지
        ...
        {
             var comboDsParamArr = [
        //                          { outDsName : "ds_location", sqlId : "NUA305CT.NUA305CT_DS_LOCATION_S", param : this.ds_search, bEmptyRow : true}
        //                        , { outDsName : "ds_room", sqlId : "NUA305CT.NUA305CT_DS_ROOM_S",param : this.ds_search, bEmptyRow : true}
        					     { outDsName : "ds_manager", sqlId : "NUA305CT.NUA305CT_DS_MANAGER_S",param : this.ds_search, bEmptyRow : true}
        					   , { outDsName : "ds_area", sqlId : "NUA305CT.NUA305CT_DS_AREA_S",param : {COMPANY_CD : fv_Company}, bEmptyRow : true} // 층 조회
        					   , { outDsName : "ds_location_all", sqlId : "NUA305CT.NUA305CT_DS_LOCATION_S",param : {COMPANY_CD : fv_Company}, bEmptyRow : true} // 생활실 전체 조회
                            ];
        ...
        this.fn_save_pre = function ()
        {
        	...
        	if(this.fv_currentDS.name == "ds_list"){
        		keyArr = ["COMPANY_CD", "RES_ID","BED_DT","HOUR","MINUTE"];
        	}
        ...
        this.fn_search = function ()
        {
        	...
        	var argument = "method=getListPaging "
        		+ "sqlId=NUA305CT.NUA305CT_DS_LIST_S ";
        ...
        this.fn_delete = function ()
        {
        	...
        	var sqlId = "";
        	if(this.fv_currentDS.name == "ds_list")	sqlId = "NUA305CT.NUA305CT_DS_LIST_D";
        ...
        this.fn_location_search = function (outDs, col)
        {
        	...
        	var argument = "method=getList "
        		+ "sqlId=NUA305CT.NUA305CT_DS_LOCATION_S "
        ...
        this.loadIncludeScript("NUA305CT.xfdl");
