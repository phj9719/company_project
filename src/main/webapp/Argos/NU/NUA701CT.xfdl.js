(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("보호자 공지등록");
            if (Form == this.constructor)
            {
                this._setFormPosition(1250,610);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_list", this);
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"COMPANY_CD\" type=\"STRING\" size=\"256\"/><Column id=\"NOT_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"NOT_DT\" type=\"STRING\" size=\"256\"/><Column id=\"TITLE\" type=\"STRING\" size=\"256\"/><Column id=\"CONTENT\" type=\"STRING\" size=\"256\"/><Column id=\"FILE_GRP_ID\" type=\"STRING\" size=\"256\"/><Column id=\"REF_USER_ID\" type=\"STRING\" size=\"256\"/><Column id=\"REG_PGM_ID\" type=\"STRING\" size=\"256\"/><Column id=\"REG_USER\" type=\"STRING\" size=\"256\"/><Column id=\"REG_DT\" type=\"STRING\" size=\"256\"/><Column id=\"REG_DT_CURR\" type=\"STRING\" size=\"256\"/><Column id=\"REG_DT_LOC\" type=\"STRING\" size=\"256\"/><Column id=\"REG_IP\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_PGM_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_USER\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_DT\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_DT_CURR\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_DT_LOC\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_IP\" type=\"STRING\" size=\"256\"/><Column id=\"REG_USER_NM\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_USER_NM\" type=\"STRING\" size=\"256\"/><Column id=\"REAL_USER_ID\" type=\"STRING\" size=\"256\"/><Column id=\"FILE_REAL_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"FILE_NAME\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj = new Edit("edt_company_nm","110","25","130","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("0");
            ...
            obj = new Edit("edt_company_nm00","340","25","130","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("1");
            obj.set_autoselect("true");
            obj.set_textAlign("left");
            this.div_search.addChild(obj.name, obj);

            obj = new Static("sta_edate","472","25","90","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("6");
            obj.set_text("일자");
            obj.set_textAlign("right");
            obj.set_verticalAlign("middle");
            ...
            obj = new Calendar("cal_sdate","570","25","110","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("2");
            obj.set_cssclass("essential");
            this.div_search.addChild(obj.name, obj);

            obj = new Static("Static26","684","25","16","20",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("7");
            obj.set_text("~");
            obj.set_font("8pt \"Malgun Gothic\"");
            this.div_search.addChild(obj.name, obj);

            obj = new Calendar("cal_edate","695","25","110","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("3");
            obj.set_cssclass("essential");
            this.div_search.addChild(obj.name, obj);

            obj = new Div("div_cont","0","120",null,null,"0%","0.00%",null,null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("div_right","744","0",null,null,"0","0",null,null,null,null,this.div_cont.form.div_cont.form);
            obj.set_taborder("2");
            obj.set_text("");
            ...
            obj = new Static("Static05_00_00_00_00_00","37","91",null,null,"0","73",null,null,null,null,this.div_cont.form.div_cont.form.div_right.form);
            obj.set_taborder("8");
            obj.set_cssclass("sta_WF_DetailLabel02");
            obj.set_text("");
            this.div_cont.form.div_cont.form.div_right.addChild(obj.name, obj);
            ...
            obj = new Static("Static05_00_01","37",null,null,"29","0","45",null,null,null,null,this.div_cont.form.div_cont.form.div_right.form);
            obj.set_taborder("11");
            obj.set_cssclass("sta_WF_DetailLabel02");
            this.div_cont.form.div_cont.form.div_right.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_user_passwd","148",null,null,"21","51","49",null,null,null,null,this.div_cont.form.div_cont.form.div_right.form);
            obj.set_taborder("4");
            ...
            obj = new Button("btn_chgpass",null,null,"36","23","8","48",null,null,null,null,this.div_cont.form.div_cont.form.div_right.form);
            obj.set_taborder("3");
            obj.set_text("첨부");
            obj.set_visible("true");
            this.div_cont.form.div_cont.form.div_right.addChild(obj.name, obj);

            obj = new TextArea("ta_content","148","97",null,null,"6","78",null,null,null,null,this.div_cont.form.div_cont.form.div_right.form);
            obj.set_taborder("2");
            obj.set_padding("5px");
            ...
            obj = new Div("div_left","0","0","756",null,null,"0",null,null,null,null,this.div_cont.form.div_cont.form);
            obj.set_taborder("0");
            obj.set_text("");
            this.div_cont.form.div_cont.addChild(obj.name, obj);

            obj = new Grid("grd_list","0","30",null,null,"0","40",null,null,null,null,this.div_cont.form.div_cont.form.div_left.form);
            obj.set_taborder("0");
            obj.set_binddataset("ds_list");
            obj.set_autosizebandtype("body");
            obj.set_autoenter("select");
            obj.set_autofittype("none");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"40\"/><Column size=\"40\"/><Column size=\"0\"/><Column size=\"0\"/><Column size=\"80\"/><Column size=\"185\"/><Column size=\"60\"/><Column size=\"60\"/><Column size=\"80\"/><Column size=\"60\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell expandchar=\"status\"/><Cell col=\"1\" expandchar=\"delete\"/><Cell col=\"2\" text=\"NO\"/><Cell col=\"3\" text=\"사업장\"/><Cell col=\"4\" displaytype=\"normal\" text=\"공장\"/><Cell col=\"5\" text=\"작성일\"/><Cell col=\"6\" text=\"제목\"/><Cell col=\"7\" text=\"등록자ID\"/><Cell col=\"8\" text=\"등록자명\"/><Cell col=\"9\" text=\"등록일자\"/><Cell col=\"10\" text=\"수정자명\"/><Cell col=\"11\" text=\"수정일자\"/></Band><Band id=\"body\"><Cell displaytype=\"normal\"/><Cell col=\"1\"/><Cell col=\"2\" text=\"expr:currow + 1\"/><Cell col=\"3\" displaytype=\"combotext\" text=\"bind:BIZ_CD\" combodataset=\"gds_biz\" combocodecol=\"BIZ_CD\" combodatacol=\"BIZ_NM\" combotype=\"filterlike\"/><Cell col=\"4\" displaytype=\"combotext\" text=\"bind:PLANT_CD\" combodataset=\"gds_plant\" combocodecol=\"PLANT_CD\" combodatacol=\"PLANT_NM\" combotype=\"filterlike\"/><Cell col=\"5\" text=\"bind:NOT_DT\" displaytype=\"date\"/><Cell col=\"6\" text=\"bind:TITLE\" displaytype=\"normal\"/><Cell col=\"7\" text=\"bind:REG_USER\"/><Cell col=\"8\" text=\"bind:REG_USER_NM\"/><Cell col=\"9\" text=\"bind:REG_DT\" displaytype=\"date\"/><Cell col=\"10\" text=\"bind:MOD_USER_NM\"/><Cell col=\"11\" text=\"bind:MOD_DT\" displaytype=\"date\"/></Band></Format></Formats>");
            this.div_cont.form.div_cont.form.div_left.addChild(obj.name, obj);

            obj = new Static("Static_mid_label_left01","0","7","194","22",null,null,null,null,null,null,this.div_cont.form.div_cont.form.div_left.form);
            obj.set_taborder("1");
            obj.set_text("공지리스트");
            obj.set_cssclass("lb01");
            this.div_cont.form.div_cont.form.div_left.addChild(obj.name, obj);

            obj = new Button("btn_gHMove","756","45.31%","25","50",null,null,null,null,null,null,this.div_cont.form.div_cont.form);
            obj.set_taborder("1");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1250,610,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("NUA701CT.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUA701CT.xfdl","lib::pgm_com.xjs");
        this.registerScript("NUA701CT.xfdl", function() {
        /***********************************************************************
         * 화면ID   : NUA701CT.xfdl
         * 화면명   :
         * 화면설명 : 공지등록
        ...
        this.fn_save_pre = function ()
        {
        	...
        	if(this.fv_currentDS.name == "ds_list"){
        		keyArr = ["COMPANY_CD", "TITLE","NOT_DT"];
        	}
        ...
        this.fn_search = function ()
        {
        	...
        	var argument = "method=getListPaging "
        		+ "sqlId=NUA701CT.NUA701CT_DS_LIST_S ";
        ...
        this.fn_delete = function ()
        {
        	...
        	var sqlId = "";
        	if(this.fv_currentDS.name == "ds_list")	sqlId = "NUA701CT.NUA701CT_DS_LIST_D";
        ...
        this.fn_callback = function (strSvcID, nErrorCode, strErrorMsg)
        {
        	if (nErrorCode == 0)
        	{
        		...
        		else if(strSvcID == "save")
        		{
        			this.fn_search();
        // 			const svcId = "fcm";
        // 			const params = "/mFcm.do";
        // 			const argument = "COMPANY_CD=" + fv_Company;
        // 			Sct.transaction(this, svcId, params, "", "", argument, "");
        		}
        	}
        	else
        	{
        ...
        this.loadIncludeScript("NUA701CT.xfdl");
