(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("NUA703CT.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUA703CT.xfdl","lib::pgm_com.xjs");
        this.registerScript("NUA703CT.xfdl", function() {
        /***********************************************************************
         * 화면ID   : NUA703CT.xfdl
         * 화면명   :
         * 화면설명 : 체위변경일지
        ...
        this.loadIncludeScript("NUA703CT.xfdl");
