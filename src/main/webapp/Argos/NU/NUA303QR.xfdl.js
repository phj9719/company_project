(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"100\"/><Column size=\"70\"/><Column size=\"70\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"70\"/><Column size=\"80\"/><Column size=\"150\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"순번\"/><Cell col=\"1\" text=\"일자\"/><Cell col=\"2\" colspan=\"2\" text=\"시간\"/><Cell col=\"4\" text=\"입소자성명\"/><Cell col=\"5\" text=\"층\"/><Cell col=\"6\" text=\"생활실\"/><Cell col=\"7\" text=\"섭취량\"/><Cell col=\"8\" text=\"처리자\"/><Cell col=\"9\" text=\"비고\"/><Cell col=\"10\" text=\"등록자ID\"/><Cell col=\"11\" text=\"등록자명\"/><Cell col=\"12\" text=\"등록일자\"/><Cell col=\"13\" text=\"수정자명\"/><Cell col=\"14\" text=\"수정일자\"/></Band><Band id=\"body\"><Cell text=\"bind:ROWNUM\"/><Cell col=\"1\" text=\"bind:WAT_DT\" displaytype=\"date\"/><Cell col=\"2\" text=\"bind:HOUR\" editinputtype=\"number\" editautoselect=\"true\" maskeditformat=\"##0.#\" textAlign=\"center\" maskeditautoselect=\"true\" displaytype=\"combotext\" combodataset=\"ds_nu_hour\" combodatacol=\"CMNM\" combocodecol=\"CMCD\" comboautoselect=\"true\"/><Cell col=\"3\" text=\"bind:MINUTE\" displaytype=\"combotext\" combodataset=\"ds_nu_minute\" combodatacol=\"CMNM\" combocodecol=\"CMCD\" comboautoselect=\"true\" textAlign=\"center\"/><Cell col=\"4\" text=\"bind:RES_NM\" expandshow=\"hide\"/><Cell col=\"5\" text=\"bind:AREA\" displaytype=\"combotext\" combodataset=\"ds_area\" combodatacol=\"ARE_NM\" combocodecol=\"ARE_CD\"/><Cell col=\"6\" text=\"bind:LOCATION\" displaytype=\"combotext\" combodataset=\"ds_location_all\" combodatacol=\"LOC_NM\" combocodecol=\"LOC_CD\"/><Cell col=\"7\" editinputtype=\"number\" text=\"bind:VOLUME\" textAlign=\"center\" editautoselect=\"true\" maskeditautoselect=\"true\" displaytype=\"normal\" comboautoselect=\"true\"/><Cell col=\"8\" text=\"bind:MANAGER_NM\" displaytype=\"normal\" combodataset=\"ds_manager\" combodatacol=\"CMNM\" combocodecol=\"CMCD\" textAlign=\"center\" editautoselect=\"true\" combotype=\"filterlike\"/><Cell col=\"9\" text=\"bind:REMARK\" editautoselect=\"true\" textareaautoselect=\"true\" wordWrap=\"none\" textAlign=\"left\"/><Cell col=\"10\" text=\"bind:REG_USER\"/><Cell col=\"11\" text=\"bind:REG_USER_NM\"/><Cell col=\"12\" text=\"bind:REG_DT\" displaytype=\"date\"/><Cell col=\"13\" text=\"bind:MOD_USER_NM\"/><Cell col=\"14\" displaytype=\"date\" text=\"bind:MOD_DT\"/></Band></Format></Formats>");
            this.div_cont.addChild(obj.name, obj);
            ...
            obj = new Static("sta_name","750","25","90","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("11");
            obj.set_text("입소자성명");
            ...
            obj = new Edit("edt_name","850","25","110","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("4");
            obj.set_maxlength("0");
            ...
            obj = new Button("btn_res_pp","966","25","25","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("6");
            ...
            obj = new Static("sta_room00","1000","25","90","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("12");
            obj.set_text("퇴소여부");
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.set_color("rgba(34,34,34,1)");
        ...
        // User Script
        this.addIncludeScript("NUA303QR.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUA303QR.xfdl","lib::pgm_com.xjs");
        this.registerScript("NUA303QR.xfdl", function() {
        /***********************************************************************
         * 화면ID   : NUA303CT.xfdl
         * 화면명   :
         * 화면설명 : 체위변경일지
        ...
        {
             var comboDsParamArr = [
        //                          { outDsName : "ds_location", sqlId : "NUA303CT.NUA303CT_DS_LOCATION_S", param : this.ds_search, bEmptyRow : true}
        //                        , { outDsName : "ds_room", sqlId : "NUA303CT.NUA303CT_DS_ROOM_S",param : this.ds_search, bEmptyRow : true}
        //					     { outDsName : "ds_manager", sqlId : "NUA303CT.NUA303CT_DS_MANAGER_S",param : this.ds_search, bEmptyRow : true}
        ...
        this.fn_search = function ()
        {
        	...
        	var argument = "method=getListPaging "
        		+ "sqlId=NUA303QR.NUA303QR_DS_LIST_S ";
        ...
        this.div_cont_grd_list_oncelldblclick = function(obj,e)
        {
        	...
        	var param = {
        		...
        		,pDt : this.ds_list.getColumn(e.row,"WAT_DT")
        	};
        	//메뉴 open
        ...
        this.loadIncludeScript("NUA303QR.xfdl");
