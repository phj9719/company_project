(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"COMPANY_CD\" type=\"STRING\" size=\"256\"/><Column id=\"WAT_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"RES_ID\" type=\"STRING\" size=\"256\"/><Column id=\"WAT_DT\" type=\"STRING\" size=\"256\"/><Column id=\"WAT_TIME\" type=\"STRING\" size=\"256\"/><Column id=\"VOLUME\" type=\"STRING\" size=\"256\"/><Column id=\"MANAGER_NM\" type=\"STRING\" size=\"256\"/><Column id=\"MANAGER_ID\" type=\"STRING\" size=\"256\"/><Column id=\"REMARK\" type=\"STRING\" size=\"256\"/><Column id=\"REG_PGM_ID\" type=\"STRING\" size=\"256\"/><Column id=\"REG_USER\" type=\"STRING\" size=\"256\"/><Column id=\"REG_DT\" type=\"STRING\" size=\"256\"/><Column id=\"REG_DT_CURR\" type=\"STRING\" size=\"256\"/><Column id=\"REG_DT_LOC\" type=\"STRING\" size=\"256\"/><Column id=\"REG_IP\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_PGM_ID\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_USER\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_DT\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_DT_CURR\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_DT_LOC\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_IP\" type=\"STRING\" size=\"256\"/><Column id=\"REG_USER_NM\" type=\"STRING\" size=\"256\"/><Column id=\"MOD_USER_NM\" type=\"STRING\" size=\"256\"/><Column id=\"AREA\" type=\"STRING\" size=\"256\"/><Column id=\"LOCATION\" type=\"STRING\" size=\"256\"/><Column id=\"RES_NM\" type=\"STRING\" size=\"256\"/><Column id=\"ROWNUM\" type=\"INT\" size=\"256\"/><Column id=\"HOUR\" type=\"STRING\" size=\"256\"/><Column id=\"MINUTE\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"40\"/><Column size=\"40\"/><Column size=\"70\"/><Column size=\"70\"/><Column size=\"70\"/><Column size=\"80\"/><Column size=\"150\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell expandchar=\"status\"/><Cell col=\"1\" expandchar=\"delete\"/><Cell col=\"2\" text=\"순번\"/><Cell col=\"3\" colspan=\"2\" text=\"시간\" cssclass=\"CellEssential\"/><Cell col=\"5\" text=\"섭취량\" cssclass=\"CellEssential\"/><Cell col=\"6\" text=\"처리자\"/><Cell col=\"7\" text=\"비고\"/><Cell col=\"8\" text=\"등록자ID\"/><Cell col=\"9\" text=\"등록자명\"/><Cell col=\"10\" text=\"등록일자\"/><Cell col=\"11\" text=\"수정자명\"/><Cell col=\"12\" text=\"수정일자\"/></Band><Band id=\"body\"><Cell/><Cell col=\"1\" displaytype=\"normal\"/><Cell col=\"2\" text=\"bind:ROWNUM\"/><Cell col=\"3\" text=\"bind:HOUR\" edittype=\"combo\" editinputtype=\"number\" editautoselect=\"true\" maskeditformat=\"##0.#\" textAlign=\"center\" maskeditautoselect=\"true\" displaytype=\"combotext\" combodataset=\"ds_nu_hour\" combodatacol=\"CMNM\" combocodecol=\"CMCD\" comboautoselect=\"true\"/><Cell col=\"4\" text=\"bind:MINUTE\" displaytype=\"combotext\" edittype=\"combo\" combodataset=\"ds_nu_minute\" combodatacol=\"CMNM\" combocodecol=\"CMCD\" comboautoselect=\"true\" textAlign=\"center\"/><Cell col=\"5\" editinputtype=\"number\" edittype=\"normal\" text=\"bind:VOLUME\" textAlign=\"center\" editautoselect=\"true\" maskeditautoselect=\"true\" displaytype=\"normal\" comboautoselect=\"true\"/><Cell col=\"6\" text=\"bind:MANAGER_NM\" displaytype=\"normal\" edittype=\"none\" combodataset=\"ds_manager\" combodatacol=\"CMNM\" combocodecol=\"CMCD\" textAlign=\"center\" editautoselect=\"true\" combotype=\"filterlike\" expandshow=\"show\"/><Cell col=\"7\" text=\"bind:REMARK\" edittype=\"normal\" editautoselect=\"true\" textareaautoselect=\"true\" wordWrap=\"none\" textAlign=\"left\"/><Cell col=\"8\" text=\"bind:REG_USER\"/><Cell col=\"9\" text=\"bind:REG_USER_NM\"/><Cell col=\"10\" text=\"bind:REG_DT\" displaytype=\"date\"/><Cell col=\"11\" text=\"bind:MOD_USER_NM\"/><Cell col=\"12\" displaytype=\"date\" text=\"bind:MOD_DT\"/></Band></Format></Formats>");
            ...
            obj = new Div("div_left","0","0","605",null,null,"0",null,null,null,null,this.div_cont.form);
            obj.set_taborder("1");
            this.div_cont.addChild(obj.name, obj);

            obj = new Div("div_paging","0",null,"420","30",null,"0",null,null,null,null,this.div_cont.form.div_left.form);
            obj.set_taborder("0");
            ...
            obj = new Grid("grd_resident","0","30",null,null,"0","30",null,null,null,null,this.div_cont.form.div_left.form);
            obj.set_taborder("2");
            ...
            obj = new Static("sta_dt","130","5","60","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("8");
            obj.set_text("일자");
        ...
        // User Script
        this.addIncludeScript("NUA303CT.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUA303CT.xfdl","lib::pgm_com.xjs");
        this.registerScript("NUA303CT.xfdl", function() {
        /***********************************************************************
         * 화면ID   : NUA303CT.xfdl
         * 화면명   :
         * 화면설명 : 체위변경일지
        ...
        //날짜 변경 이벤트
        this.div_search_cal_dt_onchanged = function(obj,e)
        {
           // validation
           if(!this.fn_detail_search_pre()) {
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_cont.form.div_right.form.grd_list.addEventHandler("onexpandup",this.div_cont_grd_list_onexpandup,this);
            ...
            this.div_cont.form.div_right.form.btn_addrow.addEventHandler("onclick",this.fn_head_addrow,this);
            ...
            this.div_search.form.cal_dt.addEventHandler("onchanged",this.div_search_cal_dt_onchanged,this);
        ...
        this.loadIncludeScript("NUA303CT.xfdl");
