(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"40\"/><Column size=\"40\"/><Column size=\"100\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"0\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell expandchar=\"delete\"/><Cell col=\"1\" expandchar=\"status\"/><Cell col=\"2\" text=\"순번\"/><Cell col=\"3\" text=\"일자\" cssclass=\"CellEssential\"/><Cell col=\"4\" text=\"입소자성명\" cssclass=\"CellEssential\"/><Cell col=\"5\" text=\"층\"/><Cell col=\"6\" text=\"생활실\"/><Cell col=\"7\" text=\"프로그램\"/><Cell col=\"8\" text=\"단계\"/><Cell col=\"9\" text=\"점수(성취율)\" cssclass=\"CellEssential\"/><Cell col=\"10\" text=\"처리자\" displaytype=\"normal\"/><Cell col=\"11\" text=\"등록자ID\"/><Cell col=\"12\" text=\"등록자명\"/><Cell col=\"13\" text=\"등록일자\"/><Cell col=\"14\" text=\"수정자명\"/><Cell col=\"15\" text=\"수정일자\"/></Band><Band id=\"body\"><Cell/><Cell col=\"1\"/><Cell col=\"2\" text=\"bind:ROWNUM\"/><Cell col=\"3\" text=\"bind:BOM_DT\" displaytype=\"date\" edittype=\"date\"/><Cell col=\"4\" text=\"bind:RES_NM\" expandshow=\"show\" edittype=\"none\" displaytype=\"normal\"/><Cell col=\"5\" text=\"bind:AREA\" displaytype=\"combotext\" combodataset=\"ds_area\" combodatacol=\"ARE_NM\" combocodecol=\"ARE_CD\" edittype=\"none\"/><Cell col=\"6\" text=\"bind:LOCATION\" displaytype=\"combotext\" combodataset=\"ds_location_all\" combodatacol=\"LOC_NM\" combocodecol=\"LOC_CD\" edittype=\"none\" comboautoselect=\"true\"/><Cell col=\"7\" text=\"bind:PROGRAM_NM\" edittype=\"combo\" editinputtype=\"number\" editautoselect=\"true\" textAlign=\"center\" displaytype=\"combotext\" combodataset=\"ds_nu_bomi_cont\" combodatacol=\"CMNM\" combocodecol=\"CMCD\"/><Cell col=\"8\" text=\"bind:CONT_LVL\" edittype=\"combo\" editinputtype=\"number\" editautoselect=\"true\" textAlign=\"center\" displaytype=\"combotext\" combodataset=\"ds_nu_bomi_level\" combodatacol=\"CMNM\" combocodecol=\"CMCD\"/><Cell col=\"9\" text=\"bind:CONT_PT\" editinputtype=\"number\" edittype=\"normal\" maskeditformat=\"#0.#\" displaytype=\"normal\" editautoselect=\"true\" textAlign=\"right\"/><Cell col=\"10\" text=\"bind:MANAGER_NM\" displaytype=\"normal\" edittype=\"none\" combodataset=\"ds_manager\" combodatacol=\"CMNM\" combocodecol=\"CMCD\" expandshow=\"show\"/><Cell col=\"11\" text=\"bind:REG_USER\"/><Cell col=\"12\" text=\"bind:REG_USER_NM\"/><Cell col=\"13\" text=\"bind:REG_DT\" displaytype=\"date\"/><Cell col=\"14\" text=\"bind:MOD_USER_NM\"/><Cell col=\"15\" displaytype=\"date\" text=\"bind:MOD_DT\"/></Band></Format></Formats>");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("statc_divcont_title","0","7","200","22",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("1");
            obj.set_text("로봇인지훈련 리스트");
        ...
        // User Script
        this.addIncludeScript("NUA501CT_copy0.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUA501CT_copy0.xfdl","lib::pgm_com.xjs");
        this.registerScript("NUA501CT_copy0.xfdl", function() {
        /***********************************************************************
         * 화면ID   : NUA501CT.xfdl
         * 화면명   :
         * 화면설명 : 로봇인지훈련
        ...
        {
             var comboDsParamArr = [
        //                          { outDsName : "ds_location", sqlId : "NUA501CT.NUA501CT_DS_LOCATION_S", param : this.ds_search, bEmptyRow : true}
        //                        , { outDsName : "ds_room", sqlId : "NUA501CT.NUA501CT_DS_ROOM_S",param : this.ds_search, bEmptyRow : true}
        //					     { outDsName : "ds_manager", sqlId : "NUA501CT.NUA501CT_DS_MANAGER_S",param : this.ds_search, bEmptyRow : true}
        ...
        this.fn_delete = function ()
        {
        	...
        	var sqlId = "";
        	if(this.fv_currentDS.name == "ds_list")	sqlId = "NUA501CT.NUA501CT_DS_LIST_D";
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_cont.form.btn_addrow.addEventHandler("onclick",this.div_cont_btn_addrow_onclick,this);
        ...
        this.loadIncludeScript("NUA501CT_copy0.xfdl");
