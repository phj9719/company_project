(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grd_list","750","30",null,null,"0","40",null,null,null,null,this.div_cont.form);
            obj.set_taborder("0");
            ...
            obj = new Div("div_paging","280",null,null,"30","550","0",null,null,null,null,this.div_cont.form);
            obj.set_taborder("2");
            ...
            obj = new ImageViewer("imv_psture1","0","30","270",null,null,"40",null,null,null,null,this.div_cont.form);
            obj.set_taborder("4");
            obj.set_stretch("fit");
            ...
            obj = new Grid("grd_head","278","30","443",null,null,"40",null,null,null,null,this.div_cont.form);
            obj.set_taborder("5");
            obj.set_autoenter("select");
            obj.set_readonly("false");
            ...
            obj = new Button("btn_gMove","723","44.12%","25","50",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("6");
        ...
        // User Script
        this.addIncludeScript("NUA302CT.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUA302CT.xfdl","lib::pgm_com.xjs");
        this.registerScript("NUA302CT.xfdl", function() {
        /***********************************************************************
         * 화면ID   : NUA302CT.xfdl
         * 화면명   :
         * 화면설명 : 체위변경일지
        ...
        this.loadIncludeScript("NUA302CT.xfdl");
