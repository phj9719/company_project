(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"40\"/><Column size=\"40\"/><Column size=\"100\"/><Column size=\"70\"/><Column size=\"70\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"150\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell expandchar=\"status\"/><Cell col=\"1\" expandchar=\"delete\"/><Cell col=\"2\" text=\"순번\"/><Cell col=\"3\" text=\"일자\" cssclass=\"CellEssential\"/><Cell col=\"4\" colspan=\"2\" text=\"시간\" cssclass=\"CellEssential\"/><Cell col=\"6\" text=\"입소자성명\" cssclass=\"CellEssential\"/><Cell col=\"7\" text=\"층\"/><Cell col=\"8\" text=\"생활실\"/><Cell col=\"9\" text=\"처리자\"/><Cell col=\"10\" text=\"비고\"/><Cell col=\"11\" text=\"등록자ID\"/><Cell col=\"12\" text=\"등록자명\"/><Cell col=\"13\" text=\"등록일자\"/><Cell col=\"14\" text=\"수정자명\"/><Cell col=\"15\" text=\"수정일자\"/></Band><Band id=\"body\"><Cell/><Cell col=\"1\" displaytype=\"normal\"/><Cell col=\"2\" text=\"bind:ROWNUM\"/><Cell col=\"3\" text=\"bind:CLO_DT\" displaytype=\"date\" edittype=\"date\"/><Cell col=\"4\" text=\"bind:HOUR\" edittype=\"combo\" editinputtype=\"number\" editautoselect=\"true\" maskeditformat=\"##0.#\" textAlign=\"center\" maskeditautoselect=\"true\" displaytype=\"combotext\" combodataset=\"ds_nu_hour\" combodatacol=\"CMNM\" combocodecol=\"CMCD\" comboautoselect=\"true\"/><Cell col=\"5\" text=\"bind:MINUTE\" displaytype=\"combotext\" edittype=\"combo\" combodataset=\"ds_nu_minute\" combodatacol=\"CMNM\" combocodecol=\"CMCD\" comboautoselect=\"true\" textAlign=\"center\"/><Cell col=\"6\" text=\"bind:RES_NM\" expandshow=\"show\"/><Cell col=\"7\" text=\"bind:AREA\" displaytype=\"combotext\" combodataset=\"ds_area\" combodatacol=\"ARE_NM\" combocodecol=\"ARE_CD\"/><Cell col=\"8\" text=\"bind:LOCATION\" displaytype=\"combotext\" combodataset=\"ds_location_all\" combodatacol=\"LOC_NM\" combocodecol=\"LOC_CD\"/><Cell col=\"9\" text=\"bind:MANAGER_ID\" displaytype=\"combotext\" edittype=\"combo\" combodataset=\"ds_manager\" combodatacol=\"CMNM\" combocodecol=\"CMCD\" textAlign=\"center\" editautoselect=\"true\" combotype=\"filterlike\"/><Cell col=\"10\" text=\"bind:REMARK\" edittype=\"normal\" editautoselect=\"true\" textareaautoselect=\"true\" wordWrap=\"none\"/><Cell col=\"11\" text=\"bind:REG_USER\"/><Cell col=\"12\" text=\"bind:REG_USER_NM\"/><Cell col=\"13\" text=\"bind:REG_DT\" displaytype=\"date\"/><Cell col=\"14\" text=\"bind:MOD_USER_NM\"/><Cell col=\"15\" displaytype=\"date\" text=\"bind:MOD_DT\"/></Band></Format></Formats>");
            this.div_cont.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("NUA306CT.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUA306CT.xfdl","lib::pgm_com.xjs");
        this.registerScript("NUA306CT.xfdl", function() {
        /***********************************************************************
         * 화면ID   : NUA306CT.xfdl
         * 화면명   :
         * 화면설명 : 침구교체일지
        ...
        {
             var comboDsParamArr = [
        //                          { outDsName : "ds_location", sqlId : "NUA306CT.NUA306CT_DS_LOCATION_S", param : this.ds_search, bEmptyRow : true}
        //                        , { outDsName : "ds_room", sqlId : "NUA306CT.NUA306CT_DS_ROOM_S",param : this.ds_search, bEmptyRow : true}
        					     { outDsName : "ds_manager", sqlId : "NUA306CT.NUA306CT_DS_MANAGER_S",param : this.ds_search, bEmptyRow : true}
        					   , { outDsName : "ds_area", sqlId : "NUA306CT.NUA306CT_DS_AREA_S",param : {COMPANY_CD : fv_Company}, bEmptyRow : true} // 층 조회
        					   , { outDsName : "ds_location_all", sqlId : "NUA306CT.NUA306CT_DS_LOCATION_S",param : {COMPANY_CD : fv_Company}, bEmptyRow : true} // 생활실 전체 조회
                            ];
        ...
        this.fn_save_pre = function ()
        {
        	...
        	if(this.fv_currentDS.name == "ds_list"){
        		keyArr = ["COMPANY_CD", "RES_ID","CLO_DT","HOUR","MINUTE"];
        	}
        ...
        this.fn_search = function ()
        {
        	...
        	var argument = "method=getListPaging "
        		+ "sqlId=NUA306CT.NUA306CT_DS_LIST_S ";
        ...
        this.fn_delete = function ()
        {
        	...
        	var sqlId = "";
        	if(this.fv_currentDS.name == "ds_list")	sqlId = "NUA306CT.NUA306CT_DS_LIST_D";
        ...
        this.fn_location_search = function (outDs, col)
        {
        	...
        	var argument = "method=getList "
        		+ "sqlId=NUA306CT.NUA306CT_DS_LOCATION_S "
        ...
        this.loadIncludeScript("NUA306CT.xfdl");
