(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_user_id","15","25","90","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("0");
            obj.set_text("사용자ID");
            ...
            obj = new Edit("edt_user_id","110","25","130","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("1");
            obj.set_autoselect("true");
            this.div_search.addChild(obj.name, obj);

            obj = new Static("sta_user_nm_kor","254","25","90","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("2");
            obj.set_text("사원명");
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.set_textAlign("right");
            ...
            obj = new Edit("edt_user_nm_kor","349","25","130","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("3");
            obj.set_autoselect("true");
            this.div_search.addChild(obj.name, obj);
            ...
            obj = new Button("btn_gVMove","40%","217","100","25",null,null,null,null,null,null,this.div_cont.form.div_right.form);
            obj.set_taborder("0");
            ...
            obj.set_autoenter("select");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"48\"/><Column size=\"52\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"96\"/><Column size=\"90\"/><Column size=\"94\"/><Column size=\"88\"/><Column size=\"92\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"NO\"/><Cell col=\"2\" text=\"레벨\"/><Cell col=\"3\" text=\"역할코드\"/><Cell col=\"4\" text=\"역할명\"/><Cell col=\"5\" text=\"설명\"/><Cell col=\"6\" text=\"등록자ID\"/><Cell col=\"7\" text=\"등록자명\"/><Cell col=\"8\" text=\"등록일자\"/><Cell col=\"9\" text=\"수정자명\"/><Cell col=\"10\" text=\"수정일자\"/></Band><Band id=\"body\"><Cell text=\"bind:CHK\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"expr:currow + 1\"/><Cell col=\"2\"/><Cell col=\"3\" text=\"bind:GRP_CD\"/><Cell col=\"4\" text=\"bind:GRP_NM\" textAlign=\"left\"/><Cell col=\"5\" text=\"bind:GRP_DESC\" textAlign=\"left\"/><Cell col=\"6\" text=\"bind:REG_USER\"/><Cell col=\"7\" text=\"bind:REG_USER_NM\"/><Cell col=\"8\" displaytype=\"date\" text=\"bind:REG_DT\"/><Cell col=\"9\" text=\"bind:MOD_USER_NM\"/><Cell col=\"10\" displaytype=\"date\" text=\"bind:MOD_DT\"/></Band></Format></Formats>");
            ...
            obj = new Div("div_down","0","243",null,null,"0","0",null,null,null,null,this.div_cont.form.div_right.form);
            obj.set_taborder("2");
            obj.set_text("");
            this.div_cont.form.div_right.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("NUA005CT.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUA005CT.xfdl","lib::pgm_com.xjs");
        this.registerScript("NUA005CT.xfdl", function() {
        /***********************************************************************
         * 화면ID    : NUA005CT
         * 화면명   : 사용자별 권한관리
         * 화면설명 :  사용자별 권한관리 화면.
         * 작성일    : 2021-06-16 11:59
         * 작성자   : SOOIM
         * 수정이력 :
         ***********************************************************************
         *     	수정일   	수정자   	내용
        ...
        */
        ...
        this.fn_search = function ()
        {
        	...
        	var argument = "method=getList "
        		+ "sqlId=NUA005CT.NUA005CT_DS_USER_S ";
        ...
        this.fn_searchDetail = function ()
        {
        	...
        	var appTp = this.ds_search.getColumn(0,"APPLICATION_TP");
        	...
        	var argument = "method=getList "
        		+ "sqlId='NUA005CT.NUA005CT_DS_GROUP_S NUA005CT.NUA005CT_DS_ROLE_S' "
        		+ "USER_ID=" + userId + " "
        		+ "COMPANY_CD=" + comCd + " "
        		+ "SERVICE_TP=" + svcTp + " "
        ...
        this.fn_delete = function ()
        {
        	...
        	var argument = "method=delete "
        		+ "sqlId=NUA005CT.NUA005CT_DS_ROLE_D ";
        ...
        this.loadIncludeScript("NUA005CT.xfdl");
