(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_autoenter("select");
            obj.set_readonly("false");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"40\"/><Column size=\"40\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"300\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell expandchar=\"status\"/><Cell col=\"1\" expandchar=\"delete\"/><Cell col=\"2\" text=\"순번\"/><Cell col=\"3\" colspan=\"2\" text=\"시간\"/><Cell col=\"5\" text=\"유형\" cssclass=\"CellEssential\"/><Cell col=\"6\" text=\"혈당\" cssclass=\"CellEssential\"/><Cell col=\"7\" text=\"처리자\"/><Cell col=\"8\" text=\"비고\"/><Cell col=\"9\" text=\"등록자ID\"/><Cell col=\"10\" text=\"등록자명\"/><Cell col=\"11\" text=\"등록일자\"/><Cell col=\"12\" text=\"수정자명\"/><Cell col=\"13\" text=\"수정일자\"/></Band><Band id=\"body\"><Cell/><Cell col=\"1\" displaytype=\"normal\"/><Cell col=\"2\" text=\"bind:ROWNUM\"/><Cell col=\"3\" displaytype=\"combotext\" edittype=\"combo\" text=\"bind:HOUR\" combodataset=\"ds_nu_hour\" combodatacol=\"CMNM\" combocodecol=\"CMCD\"/><Cell col=\"4\" text=\"bind:MINUTE\" displaytype=\"combotext\" edittype=\"combo\" combodataset=\"ds_nu_minute\" combodatacol=\"CMNM\" combocodecol=\"CMCD\"/><Cell col=\"5\" text=\"bind:SUG_TP\" edittype=\"combo\" editinputtype=\"number\" editautoselect=\"true\" textAlign=\"right\" combodataset=\"ds_nu_sugar\" combocodecol=\"CMCD\" combodatacol=\"CMNM\" displaytype=\"combotext\"/><Cell col=\"6\" text=\"bind:SUGAR\" edittype=\"normal\" editinputtype=\"number\" editautoselect=\"true\" textAlign=\"right\"/><Cell col=\"7\" text=\"bind:MANAGER_NM\" displaytype=\"normal\" edittype=\"none\" combodataset=\"ds_manager\" combodatacol=\"CMNM\" combocodecol=\"CMCD\" expandshow=\"show\"/><Cell col=\"8\" text=\"bind:REMARK\" edittype=\"normal\" displaytype=\"normal\" textAlign=\"left\"/><Cell col=\"9\" text=\"bind:REG_USER\"/><Cell col=\"10\" text=\"bind:REG_USER_NM\"/><Cell col=\"11\" text=\"bind:REG_DT\" displaytype=\"date\"/><Cell col=\"12\" text=\"bind:MOD_USER_NM\"/><Cell col=\"13\" displaytype=\"date\" text=\"bind:MOD_DT\"/></Band></Format></Formats>");
            this.div_cont.form.div_right.form.div_head.addChild(obj.name, obj);
            ...
            obj = new Static("sta_date","130","3","60","20",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("8");
        ...
        // User Script
        this.addIncludeScript("NUA203CT.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUA203CT.xfdl","lib::pgm_com.xjs");
        this.registerScript("NUA203CT.xfdl", function() {
        /***********************************************************************
         * 화면ID   : NUA203CT
         * 화면명   :
         * 화면설명 : 혈당측정
        ...
        {
             var comboDsParamArr = [
        						   { outDsName : "ds_area", sqlId : "NUA203CT.NUA203CT_DS_AREA_S",param : {COMPANY_CD : fv_Company}, bEmptyRow : true} // 층 조회
        						 , { outDsName : "ds_location_all", sqlId : "NUA203CT.NUA203CT_DS_LOCATION_S",param : {COMPANY_CD : fv_Company}, bEmptyRow : true} // 생활실 전체 조회
                            ];
        ...
        this.fn_search = function ()
        {
        	...
        	var argument = "method=getListPaging "
        		+ "sqlId=NUA203CT.NUA203CT_DS_HEAD_S ";
        ...
        this.fn_save = function ()
        {
        	...
        	var svcId = "save";
        	var params = "/NUA203CTController.do";
        ...
        this.fn_delete = function ()
        {
        	...
        	var sqlId = "NUA203CT.NUA203CT_DS_LIST_D";
        ...
        this.fn_searchDetail = function ()
        {
        	...
        	var argument = "method=getList "
        		+ "sqlId=NUA203CT.NUA203CT_DS_LIST_S "
        ...
        this.fn_location_search = function (outDs, col)
        {
        	...
        	var argument = "method=getList "
        		+ "sqlId=NUA203CT.NUA203CT_DS_LOCATION_S "
        		+ " COMPANY_CD="+fv_Company
        		+ " AREA="+col;
        ...
        this.fn_head_addrow = function(obj,e)
        {
        	...
        	this.ds_list.setColumn(nRow, "SUG_DT",this.ds_search.getColumn(0, "DATE"));
        	this.ds_list.setColumn(nRow, "SUG_TP","");
        	this.ds_list.setColumn(nRow, "SUGAR",0);
        ...
        this.loadIncludeScript("NUA203CT.xfdl");
