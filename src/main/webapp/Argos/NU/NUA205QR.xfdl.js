(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("체성분측정현황");
            if (Form == this.constructor)
            {
                this._setFormPosition(1410,570);
            }
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"100\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"60\"/><Column size=\"80\"/><Column size=\"150\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"순번\"/><Cell col=\"1\" text=\"일자\"/><Cell col=\"2\" text=\"입소자성명\"/><Cell col=\"3\" text=\"층\"/><Cell col=\"4\" text=\"생활실\"/><Cell col=\"5\" text=\"신장(cm)\"/><Cell col=\"6\" text=\"체중(kg)\"/><Cell col=\"7\" text=\"체지방율(%)\"/><Cell col=\"8\" text=\"골격근량(kg)\"/><Cell col=\"9\" text=\"내장지방레벨\"/><Cell col=\"10\" text=\"체지방량(kg)\"/><Cell col=\"11\" text=\"BMI\"/><Cell col=\"12\" text=\"처리자\"/><Cell col=\"13\" text=\"비고\"/><Cell col=\"14\" text=\"등록자ID\"/><Cell col=\"15\" text=\"등록자명\"/><Cell col=\"16\" text=\"등록일자\"/><Cell col=\"17\" text=\"수정자명\"/><Cell col=\"18\" text=\"수정일자\"/></Band><Band id=\"body\"><Cell text=\"bind:ROWNUM\"/><Cell col=\"1\" text=\"bind:COM_DT\" displaytype=\"date\"/><Cell col=\"2\" text=\"bind:RES_NM\"/><Cell col=\"3\" text=\"bind:AREA\" displaytype=\"combotext\" combodataset=\"ds_area\" combodatacol=\"ARE_NM\" combocodecol=\"ARE_CD\"/><Cell col=\"4\" text=\"bind:LOCATION\" displaytype=\"combotext\" combodataset=\"ds_location_all\" combodatacol=\"LOC_NM\" combocodecol=\"LOC_CD\"/><Cell col=\"5\" text=\"bind:HEIGHT\" editinputtype=\"number\" editautoselect=\"true\" maskeditformat=\"##0.#\" textAlign=\"right\" maskeditautoselect=\"true\"/><Cell col=\"6\" editinputtype=\"number\" maskeditformat=\"##0.#\" text=\"bind:WEIGHT\" textAlign=\"right\" editautoselect=\"true\" maskeditautoselect=\"true\"/><Cell col=\"7\" editinputtype=\"number\" maskeditformat=\"##0.#\" text=\"bind:PBF\" textAlign=\"right\" editautoselect=\"true\" maskeditautoselect=\"true\"/><Cell col=\"8\" editinputtype=\"number\" maskeditformat=\"##0.#\" text=\"bind:SMM\" textAlign=\"right\" editautoselect=\"true\" maskeditautoselect=\"true\"/><Cell col=\"9\" editinputtype=\"number\" text=\"bind:FAT_LVL\" textAlign=\"right\" editautoselect=\"true\" maskeditautoselect=\"true\"/><Cell col=\"10\" editinputtype=\"number\" maskeditformat=\"##0.#\" text=\"bind:BFM\" textAlign=\"right\" editautoselect=\"true\" maskeditautoselect=\"true\"/><Cell col=\"11\" editinputtype=\"number\" maskeditformat=\"##0.#\" text=\"bind:BMI\" textAlign=\"right\" editautoselect=\"true\"/><Cell col=\"12\" text=\"bind:MANAGER_NM\" displaytype=\"normal\" combodataset=\"ds_manager\" combodatacol=\"CMNM\" combocodecol=\"CMCD\"/><Cell col=\"13\" text=\"bind:REMARK\" autosizerow=\"limitmin\" textAlign=\"left\" verticalAlign=\"top\"/><Cell col=\"14\" text=\"bind:REG_USER\"/><Cell col=\"15\" text=\"bind:REG_USER_NM\"/><Cell col=\"16\" text=\"bind:REG_DT\" displaytype=\"date\"/><Cell col=\"17\" text=\"bind:MOD_USER_NM\"/><Cell col=\"18\" displaytype=\"date\" text=\"bind:MOD_DT\"/></Band></Format></Formats>");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("statc_divcont_title","0","7","200","22",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("2");
            obj.set_text("체성분분석 리스트");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1410,570,this,function(p){});
        ...
        // User Script
        this.addIncludeScript("NUA205QR.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUA205QR.xfdl","lib::pgm_com.xjs");
        this.registerScript("NUA205QR.xfdl", function() {
        /***********************************************************************
         * 화면ID   : NUA205QR.xfdl
         * 화면명   :
         * 화면설명 : 체성분측정현황
         * 작성일   : 2021-11-30 13:30
         * 작성자   : 이승규
         * 수정이력 :
         ***********************************************************************
         ***********************************************************************
        ...
        {
             var comboDsParamArr = [
        					     { outDsName : "ds_area", sqlId : "NUA205QR.NUA205QR_DS_AREA_S",param : {COMPANY_CD : fv_Company}, bEmptyRow : true} // 층 조회
        					   , { outDsName : "ds_location_all", sqlId : "NUA205QR.NUA205QR_DS_LOCATION_S",param : {COMPANY_CD : fv_Company}, bEmptyRow : true} // 생활실 전체 조회
                            ];
        ...
        this.fn_search = function ()
        {
        	...
        	var argument = "method=getListPaging "
        		+ "sqlId=NUA205QR.NUA205QR_DS_LIST_S ";
        ...
        this.div_cont_grd_list_oncelldblclick = function(obj,e)
        {
        	...
        	var param = {
        		...
        		,pDt : this.ds_list.getColumn(e.row,"COM_DT")
        	};
        	//메뉴 open
        ...
        this.loadIncludeScript("NUA205QR.xfdl");
