(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_grp_nm","5","25","90","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("1");
            obj.set_text("역할명");
            ...
            obj = new Edit("edt_grp_nm","100","25","130","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("0");
            ...
            obj = new BindItem("item0","div_search.form.edt_grp_nm","value","ds_search","GRP_NM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("NUA004CT.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUA004CT.xfdl","lib::pgm_com.xjs");
        this.registerScript("NUA004CT.xfdl", function() {
        /***********************************************************************
         * 화면ID    : NUA004CT
         * 화면명   : 역할관리(고객용)
         * 화면설명 :  역할관리 화면(고객용)
         * 작성일    : 2021-06-15 11:59
         * 작성자   : SOOIM
         * 수정이력 :
         ***********************************************************************
         *     수정일     	수정자   	내용
        ...
        this.form_onload = function (obj, e)
        {
        	...
        	this.div_search.form.edt_grp_nm.setFocus();
        };
        ...
        this.fn_search = function ()
        {
        	...
        	var argument = "method=getList "
        		+ "sqlId=NUA004CT.NUA004CT_DS_HEAD_S ";
        ...
        this.fn_searchDetail = function ()
        {
        	...
        	var argument = "method=getList "
        		+ "sqlId='NUA004CT.NUA004CT_DS_MENU_S NUA004CT.NUA004CT_DS_DETAIL_S' "
        ...
        this.fn_delete = function ()
        {
        	...
        	var sqlId = "";
        	if(this.fv_currentDS.name == "ds_head")	sqlId = "NUA004CT.NUA004CT_DS_HEAD_D";
        	else									sqlId = "NUA004CT.NUA004CT_DS_DETAIL_D";
        ...
        this.loadIncludeScript("NUA004CT.xfdl");
