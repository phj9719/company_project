(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("요양관찰일지현황");
            if (Form == this.constructor)
            {
                this._setFormPosition(1400,570);
            }
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"100\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"500\"/><Column size=\"200\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"순번\"/><Cell col=\"1\" text=\"일자\"/><Cell col=\"2\" text=\"입소자성명\"/><Cell col=\"3\" text=\"층\"/><Cell col=\"4\" text=\"생활실\"/><Cell col=\"5\" text=\"요양일지\"/><Cell col=\"6\" text=\"관찰기록\" edittype=\"none\"/><Cell col=\"7\" text=\"처리자\"/><Cell col=\"8\" text=\"등록자ID\"/><Cell col=\"9\" text=\"등록자명\"/><Cell col=\"10\" text=\"등록일자\"/><Cell col=\"11\" text=\"수정자명\"/><Cell col=\"12\" text=\"수정일자\"/></Band><Band id=\"body\"><Cell text=\"bind:ROWNUM\"/><Cell col=\"1\" text=\"bind:OBS_DT\" displaytype=\"date\"/><Cell col=\"2\" text=\"bind:RES_NM\"/><Cell col=\"3\" text=\"bind:AREA\" displaytype=\"combotext\" combodataset=\"ds_area\" combodatacol=\"ARE_NM\" combocodecol=\"ARE_CD\"/><Cell col=\"4\" text=\"bind:LOCATION\" displaytype=\"combotext\" combodataset=\"ds_location_all\" combodatacol=\"LOC_NM\" combocodecol=\"LOC_CD\"/><Cell col=\"5\" text=\"bind:NOTE\" autosizerow=\"limitmin\" textAlign=\"left\" verticalAlign=\"top\"/><Cell col=\"6\" text=\"bind:REMARK\" autosizerow=\"limitmin\" textAlign=\"left\" verticalAlign=\"top\"/><Cell col=\"7\" text=\"bind:MANAGER_NM\" displaytype=\"normal\" combodataset=\"ds_manager\" combodatacol=\"CMNM\" combocodecol=\"CMCD\" editautoselect=\"true\" combotype=\"filterlike\"/><Cell col=\"8\" text=\"bind:REG_USER\"/><Cell col=\"9\" text=\"bind:REG_USER_NM\"/><Cell col=\"10\" text=\"bind:REG_DT\" displaytype=\"date\"/><Cell col=\"11\" text=\"bind:MOD_USER_NM\"/><Cell col=\"12\" displaytype=\"date\" text=\"bind:MOD_DT\"/></Band></Format></Formats>");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1400,570,this,function(p){});
            ...
            obj = new BindItem("item3","div_search.form.cmb_enter_gb","value","ds_search","RETIRE_YN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","div_search.form.cal_sdate","value","ds_search","DT_FROM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","div_search.form.cal_edate","value","ds_search","DT_TO");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("NUA309QR.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUA309QR.xfdl","lib::pgm_com.xjs");
        this.registerScript("NUA309QR.xfdl", function() {
        /***********************************************************************
         * 화면ID   : NUA309QR.xfdl
         * 화면명   :
         * 화면설명 : 요양관찰일지현황
         * 작성일   : 2021-11-29 17:00
         * 작성자   : 이승규
         * 수정이력 :
         ***********************************************************************
         ***********************************************************************
        ...
        //					     { outDsName : "ds_manager", sqlId : "NUA309CT.NUA309CT_DS_MANAGER_S",param : this.ds_search, bEmptyRow : true}
        					   { outDsName : "ds_area", sqlId : "NUA309QR.NUA309QR_DS_AREA_S",param : {COMPANY_CD : fv_Company}, bEmptyRow : true} // 층 조회
        					   , { outDsName : "ds_location_all", sqlId : "NUA309QR.NUA309QR_DS_LOCATION_S",param : {COMPANY_CD : fv_Company}, bEmptyRow : true} // 생활실 전체 조회
                            ];
        ...
        this.fn_search = function ()
        {
        	...
        	var argument = "method=getListPaging "
        		+ "sqlId=NUA309QR.NUA309QR_DS_LIST_S ";
        ...
        this.fn_location_search = function (outDs, col)
        {
        	...
        	var argument = "method=getList "
        		+ "sqlId=NUA309QR.NUA309QR_DS_LOCATION_S "
        ...
        this.div_cont_grd_list_oncelldblclick = function(obj,e)
        {
        	...
        	var param = {
        		...
        		,pDt : this.ds_list.getColumn(e.row,"OBS_DT")
        	};
        	//메뉴 open
        ...
        this.loadIncludeScript("NUA309QR.xfdl");
