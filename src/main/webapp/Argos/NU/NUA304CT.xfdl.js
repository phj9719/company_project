(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("수면상태일지");
            if (Form == this.constructor)
            {
                this._setFormPosition(1530,570);
            }
            ...
            obj = new Static("Static02_00_00_00","0","114","782","200",null,null,null,null,null,null,this.div_cont.form.div_right.form);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_DetailLabel02");
            this.div_cont.form.div_right.addChild(obj.name, obj);
            ...
            obj = new Static("sta_sle_time","0","86","130","29",null,null,null,null,null,null,this.div_cont.form.div_right.form);
            obj.set_taborder("8");
            obj.set_text("기상시간");
            obj.set_cssclass("sta_WF_DetailLabel01");
            this.div_cont.form.div_right.addChild(obj.name, obj);

            obj = new Static("sta_sleep_ty","478","86","130","29",null,null,null,null,null,null,this.div_cont.form.div_right.form);
            obj.set_taborder("9");
            obj.set_text("수면상태");
            obj.set_cssclass("sta_WF_DetailLabel01");
            this.div_cont.form.div_right.addChild(obj.name, obj);

            obj = new Static("sta_remark","0","114","130","200",null,null,null,null,null,null,this.div_cont.form.div_right.form);
            obj.set_taborder("10");
            obj.set_text("비고");
            obj.set_cssclass("sta_WF_DetailLabel01");
            this.div_cont.form.div_right.addChild(obj.name, obj);

            obj = new Combo("cmb_hour","132","90","170","21",null,null,null,null,null,null,this.div_cont.form.div_right.form);
            obj.set_taborder("2");
            obj.set_innerdataset("ds_nu_sleep_time");
            obj.set_codecolumn("CMCD");
            obj.set_datacolumn("CMNM");
            obj.set_cssclass("essential");
            this.div_cont.form.div_right.addChild(obj.name, obj);

            obj = new Combo("cmb_sleep_ty","610","90","170","21",null,null,null,null,null,null,this.div_cont.form.div_right.form);
            obj.set_taborder("4");
            ...
            obj = new Combo("cmb_minute","305","90","170","21",null,null,null,null,null,null,this.div_cont.form.div_right.form);
            obj.set_taborder("3");
            ...
            obj = new TextArea("txt_remark","132","118","647","192",null,null,null,null,null,null,this.div_cont.form.div_right.form);
            obj.set_taborder("5");
            this.div_cont.form.div_right.addChild(obj.name, obj);
            ...
            obj = new Static("sta_hour","2","389","130","29",null,null,null,null,null,null,this.div_cont.form.div_right.form);
            obj.set_taborder("15");
            obj.set_text("기상시간");
            obj.set_cssclass("sta_WF_DetailLabel01");
            obj.set_visible("false");
            ...
            obj = new Static("sta_minute","130","389","130","29",null,null,null,null,null,null,this.div_cont.form.div_right.form);
            obj.set_taborder("16");
            obj.set_text("기상시간");
            obj.set_cssclass("sta_WF_DetailLabel01");
            obj.set_visible("false");
            ...
            obj = new Static("sta_dt","70","5","130","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("8");
            obj.set_text("일자");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1530,570,this,function(p){});
            ...
            obj = new BindItem("item4","div_cont.form.div_right.form.txt_remark","value","ds_list","REMARK");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","div_cont.form.div_right.form.cmb_sleep_ty","value","ds_list","SLEEP_TP");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","div_cont.form.div_right.form.edt_manager_nm","value","ds_list","MANAGER_NM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","div_cont.form.div_right.form.cmb_hour","value","ds_list","HOUR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","div_cont.form.div_right.form.cmb_minute","value","ds_list","MINUTE");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item9","div_search.form.cmb_area","value","ds_search","AREA");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("NUA304CT.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUA304CT.xfdl","lib::pgm_com.xjs");
        this.registerScript("NUA304CT.xfdl", function() {
        /***********************************************************************
         * 화면ID   : NUA304CT.xfdl
         * 화면명   :
         * 화면설명 : 체위변경일지
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_cont.form.div_right.form.btn_manager.addEventHandler("onclick",this.div_cont_div_right_btn_day_manager_onclick,this);
        ...
        this.loadIncludeScript("NUA304CT.xfdl");
