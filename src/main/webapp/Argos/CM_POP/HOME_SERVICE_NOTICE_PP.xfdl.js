(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_chgpass",null,null,"60","23","229","48",null,null,null,null,this.div_cont.form.div_cont.form.div_right.form);
            obj.set_taborder("3");
            obj.set_text("받기");
            obj.set_visible("true");
            this.div_cont.form.div_cont.form.div_right.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("HOME_SERVICE_NOTICE_PP.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("HOME_SERVICE_NOTICE_PP.xfdl","lib::pgm_com.xjs");
        this.registerScript("HOME_SERVICE_NOTICE_PP.xfdl", function() {
        /***********************************************************************
        ...
        this.loadIncludeScript("HOME_SERVICE_NOTICE_PP.xfdl");
