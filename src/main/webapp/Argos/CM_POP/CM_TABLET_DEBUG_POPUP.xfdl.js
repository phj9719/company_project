(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"40\"/></Rows><Band id=\"head\"><Cell text=\"FormDS\"/></Band><Band id=\"body\"><Cell text=\"bind:DS\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj.set_autoenter("select");
            obj.set_cssclass("grd_DataList");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"40\"/></Rows><Band id=\"head\"><Cell text=\"GlobalDS\"/></Band><Band id=\"body\"><Cell text=\"bind:GDS\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("Button00","0","0","71","29",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_icon("url(\'imagerc::reset.png\')");
            obj.set_cssclass("neutest");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","Tablet",1032,655,this,function(p){});
        ...
        // User Script
        this.registerScript("CM_TABLET_DEBUG_POPUP.xfdl", function() {
        ...
        this.Grid00_oncellclick = function (obj, e)
        {
        	...
        	if (this.parent.isModal == false)
        	{
        		...
        		this.grd_detail.set_autosizingtype("both");
        	}
        	else
        	{
        ...
        this.loadIncludeScript("CM_TABLET_DEBUG_POPUP.xfdl");
