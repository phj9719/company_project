(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"COMPANY_CD\" type=\"STRING\" size=\"256\"/><Column id=\"SERVICE_TP\" type=\"STRING\" size=\"256\"/><Column id=\"APPLICATION_TP\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/><Column id=\"LOCATION\" type=\"STRING\" size=\"256\"/><Column id=\"ROOM\" type=\"STRING\" size=\"256\"/><Column id=\"AGE\" type=\"STRING\" size=\"256\"/><Column id=\"RES_ID\" type=\"STRING\" size=\"256\"/><Column id=\"AREA\" type=\"STRING\" size=\"256\"/><Column id=\"ENTER_GB\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("div_search","0","30",null,"100","0",null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Static("sta_area","5","41","90","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("7");
            obj.set_text("층");
            obj.set_cssclass("sta_WF_SearchLabel");
            ...
            obj = new Static("sta_location","195","41","90","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("8");
            obj.set_text("생활실");
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.set_color("rgba(34,34,34,1)");
            ...
            obj = new Combo("cmb_location","290","41","130","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("2");
            ...
            obj = new Combo("cmb_area","100","41","130","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("1");
            ...
            obj = new Combo("cmb_enter_gb","100","70","130","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("3");
            ...
            obj = new Static("sta_age00","12","72","80","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("9");
            obj.set_text("조회구분");
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.set_color("rgba(34,34,34,1)");
            ...
            obj = new Div("div_cont","0","114","450","386",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);

            obj = new Static("Static_mid_label","0","27","149","22",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("3");
            obj.set_text("입소자 리스트");
            obj.set_cssclass("lb01");
            this.div_cont.addChild(obj.name, obj);

            obj = new Grid("grd_list","0","50",null,null,"0","0",null,null,null,null,this.div_cont.form);
            obj.set_taborder("2");
            obj.set_autofittype("col");
            obj.set_binddataset("ds_list");
            obj.set_autosizingtype("none");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"100\"/><Column size=\"48\"/><Column size=\"48\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell edittype=\"checkbox\" displaytype=\"checkboxcontrol\"/><Cell col=\"1\" text=\"입소자성명\"/><Cell col=\"2\" text=\"성별\"/><Cell col=\"3\" text=\"나이\"/><Cell col=\"4\" text=\"층\"/><Cell col=\"5\" text=\"생활실\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"1\" text=\"bind:NAME\" textAlign=\"center\"/><Cell col=\"2\" displaytype=\"combotext\" combodataset=\"ds_nu_sex\" combodatacol=\"CMNM\" combocodecol=\"CMCD\" text=\"bind:SEX\"/><Cell col=\"3\" text=\"bind:AGE\"/><Cell col=\"4\" text=\"bind:AREA\" displaytype=\"combotext\" combodataset=\"ds_area\" combocodecol=\"ARE_CD\" combodatacol=\"ARE_NM\"/><Cell col=\"5\" displaytype=\"combotext\" text=\"bind:LOCATION\" combodataset=\"ds_location_all\" combocodecol=\"LOC_CD\" combodatacol=\"LOC_NM\"/></Band></Format></Formats>");
            this.div_cont.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            ...
            obj = new BindItem("item0","div_search.form.cmb_enter_gb","value","ds_search","ENTER_GB");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("CM_RES_PP.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("CM_RES_PP.xfdl","lib::pgm_com.xjs");
        this.registerScript("CM_RES_PP.xfdl", function() {
        ...
        this.loadIncludeScript("CM_RES_PP.xfdl");
