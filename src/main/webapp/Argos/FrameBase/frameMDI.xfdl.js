(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_background("#ffb74e");
            this.set_scrolltype("none");
            this.set_scrollbartype("none none");
            this.set_color("#fbab62");
            if (Form == this.constructor)
            {
                this._setFormPosition(1666,36);
            }
            ...
            obj = new Tab("tab_mdi","40",null,null,"36","0","0",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_tabindex("0");
            ...
            obj = new Button("btn_closeAll",null,"4","28","28","70",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_tooltiptext("Close All");
            obj.set_visible("true");
            obj.set_cursor("pointer");
            obj.set_border("1px solid transparent");
            obj.set_background("URL(\'imagerc::window_close.png\') no-repeat center center");
            this.addChild(obj.name, obj);

            obj = new Button("btn_cascade",null,"4","28","28","172",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_visible("true");
            ...
            obj = new Button("btn_maximize",null,"4","28","28","206",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_visible("true");
            ...
            obj = new Button("btn_vertical",null,"4","28","28","138",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_visible("true");
            ...
            obj = new Button("btn_horizontal",null,"4","28","28","104",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_visible("true");
            ...
            obj.set_background("#ffe4ce");
            obj.set_color("#fbab62");
            obj.set_font("8pt/normal \"Noto Sans CJK KR Regular\"");
            obj.set_border("1px solid transparent,1px solid #fbab62,1px solid #fbab62");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1666,36,this,function(p){});
            obj.set_stepcount("0");
        ...
        {
        	nexacro.getApplication().av_vFrameSetMain.set_separatesize(nexacro.getApplication().av_hideTopModeSize);
        ...
        {
        	nexacro.getApplication().av_vFrameSetMain.set_separatesize(nexacro.getApplication().av_showTopModeSize);
