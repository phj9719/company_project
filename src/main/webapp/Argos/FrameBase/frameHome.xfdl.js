(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("div_left","20","40","700",null,null,"20",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("1");
            obj.set_text("센터 일일알림");
            obj.set_cssclass("lb01");
            this.div_left.addChild(obj.name, obj);

            obj = new TextArea("txt_00","0","23",null,null,"0","20",null,null,null,null,this.div_left.form);
            obj.set_taborder("1");
            obj.set_readonly("true");
            this.div_left.addChild(obj.name, obj);

            obj = new Div("div_right","758","40","700",null,null,"20",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_service_notice","0","23",null,null,"0","20",null,null,null,null,this.div_right.form);
            obj.set_taborder("0");
            obj.set_binddataset("ds_service_notice");
            obj.set_autosizebandtype("body");
            obj.set_autoenter("select");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"0\"/><Column size=\"0\"/><Column size=\"80\"/><Column size=\"500\"/><Column size=\"60\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"순번\"/><Cell col=\"1\" text=\"사업장\"/><Cell col=\"2\" displaytype=\"normal\" text=\"공장\"/><Cell col=\"3\" text=\"작성일\" cursor=\"pointer\"/><Cell col=\"4\" text=\"제목\"/><Cell col=\"5\" text=\"등록자명\"/></Band><Band id=\"body\"><Cell text=\"expr:currow + 1\"/><Cell col=\"1\" displaytype=\"combotext\" text=\"bind:BIZ_CD\" combodataset=\"gds_biz\" combocodecol=\"BIZ_CD\" combodatacol=\"BIZ_NM\" combotype=\"filterlike\"/><Cell col=\"2\" displaytype=\"combotext\" text=\"bind:PLANT_CD\" combodataset=\"gds_plant\" combocodecol=\"PLANT_CD\" combodatacol=\"PLANT_NM\" combotype=\"filterlike\"/><Cell col=\"3\"/><Cell col=\"4\" displaytype=\"normal\" textAlign=\"left\"/><Cell col=\"5\" text=\"bind:REG_USER_NM\"/></Band></Format></Formats>");
            this.div_right.addChild(obj.name, obj);

            obj = new Static("Static_mid_label_left01","0","0","250","22",null,null,null,null,null,null,this.div_right.form);
            obj.set_taborder("1");
            obj.set_text("너싱홈 공지사항 및 자료실");
            obj.set_cssclass("lb01");
            this.div_right.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
