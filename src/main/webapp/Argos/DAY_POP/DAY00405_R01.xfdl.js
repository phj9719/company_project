(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00405_R01");
            this.set_titletext("월간 수급자 송영집계");
        ...
        // User Script
        this.registerScript("DAY00405_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	//trace("argument : sicode = " + sicode + ", date = " + date + ", from : " + from + ", to : " + to);
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00405_R01.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00405_R01.xfdl");
