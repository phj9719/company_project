(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00102_1_R03");
            this.set_titletext("실습 리포트3");
            ...
            obj = new UbiReport("UbiViewer","0","0","1000","900",null,null,null,null,null,null,this);
            obj.set_taborder("0");
        ...
        // User Script
        this.registerScript("DAY00102_1_R03.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        * 저장 완료 후 콜백
        ************************************************************************************/
        this.DAY00102_1_R03_onload = function(obj,e)
        {
        	let jrfFile = "DAY00102_1_R03.jrf";

        	// UbiReport Argument 세팅
        	const sicode = this.parent.pParam.sicode;
        	const date_from = this.parent.pParam.data_from;
        	...
        	this.UbiViewer.setArgument("DATE_FROM", date_from);
        	this.UbiViewer.setArgument("DATE_TO", date_to);
        	this.UbiViewer.setArgument("SIGN", sign);
        ...
        ************************************************************************************/
        ...
        {
            this.addEventHandler("onload",this.DAY00102_1_R03_onload,this);
        };
        this.loadIncludeScript("DAY00102_1_R03.xfdl");
