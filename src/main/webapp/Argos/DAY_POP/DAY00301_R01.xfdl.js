(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00301_R01");
            this.set_titletext("물리(작업)치료 운영일지");
        ...
        // User Script
        this.registerScript("DAY00301_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	var group = this.parent.pParam.group;
        	...
        	this.UbiViewer.setArgument("P_GROUP", group);
        	this.UbiViewer.setArgument("P_SIGN", sign);

        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00301_R01.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00301_R01.xfdl");
