(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00104_R03");
            this.set_titletext("일지.식사.배설");
        ...
        // User Script
        this.registerScript("DAY00104_R03.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00104_R03.xfdl");
