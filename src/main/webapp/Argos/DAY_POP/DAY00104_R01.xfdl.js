(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00104_R01");
            this.set_titletext("요양일지(3단)");
        ...
        // User Script
        this.registerScript("DAY00104_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00104_R01.xfdl");
