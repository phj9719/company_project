(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00402_R03");
            this.set_titletext("기록식 주간운행일정");
        ...
        // User Script
        this.registerScript("DAY00402_R03.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00402_R03.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00402_R03.xfdl");
