(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00209_R01");
            this.set_titletext("진료기록");
        ...
        // User Script
        this.registerScript("DAY00209_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.UbiViewer.setArgument("P_M_CODE", mCodes);
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00209_R01.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00209_R01.xfdl");
