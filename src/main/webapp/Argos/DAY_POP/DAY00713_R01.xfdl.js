(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00713_R01");
            this.set_titletext("가스안전관리 점검표");
        ...
        // User Script
        this.registerScript("DAY00713_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00713_R01.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00713_R01.xfdl");
