(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00214_R01");
            this.set_titletext("감염예방일지");
        ...
        // User Script
        this.registerScript("DAY00214_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        {
        	let jrfFile = "DAY00214_R01.jrf";

        	// UbiReport Argument 세팅
        	const sicode = this.parent.pParam.sicode;
        	const preventionNo = this.parent.pParam.preventionNo;
        	...
        	this.UbiViewer.setArgument("P_PREVENTION_NO", preventionNo);
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00214_R01.xfdl");
