(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00108_R02");
            this.set_titletext("오늘의활동점검 서식");
        ...
        // User Script
        this.registerScript("DAY00108_R02.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00108_R02.xfdl");
