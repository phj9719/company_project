(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00102_R01_1");
            this.set_titletext("실습 리포트1");
            ...
            obj = new UbiReport("UbiViewer","0","-2","1000","902",null,null,null,null,null,null,this);
            obj.set_taborder("0");
        ...
        // User Script
        this.registerScript("DAY00102_1_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        {
        	let jrfFile = "DAY00102_1_R01.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00102_1_R01.xfdl");
