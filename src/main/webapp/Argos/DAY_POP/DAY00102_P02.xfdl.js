(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("DAY00102_P02.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("DAY00102_P02.xfdl","lib::pgm_com.xjs");
        this.registerScript("DAY00102_P02.xfdl", function() {
        /***********************************************************************
         * 화면ID   	: DAY00102_R01
         * 화면명   	: 상태변화기록 수정
        ...
        this.loadIncludeScript("DAY00102_P02.xfdl");
