(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00210_R01");
            this.set_titletext("자세변경.욕창간호기록");
        ...
        // User Script
        this.registerScript("DAY00210_R01_copy0.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	const codes = this.parent.pParam.codes;
        	const sign = this.parent.pParam.dateTo;

        	this.UbiViewer.ismultireport = "false";

        	this.UbiViewer.setArgument("P_SICODE", sicode);
        	this.UbiViewer.setArgument("P_DATE_FROM", datefrom);
        	this.UbiViewer.setArgument("P_DATE_TO", dateTo);
        	this.UbiViewer.setArgument("P_M_CODE", codes);
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00210_R01_copy0.xfdl");
