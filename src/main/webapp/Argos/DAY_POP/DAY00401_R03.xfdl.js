(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00401_R03");
            this.set_titletext("차량별송영일지(운행)");
        ...
        // User Script
        this.registerScript("DAY00401_R03.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	const gubun = this.parent.pParam.gubun;
        	const no = this.parent.pParam.no;
        	const flag = this.parent.pParam.flag;
        	const chk = this.parent.pParam.chk;
        	const dateArr = this.parent.pParam.dateArr;

        	//trace("argument : sicode = " + sicode + ", date = " + date + ", gubun = " + gubun + ", no = " + no + ", flag = " + flag + ", chk = " + chk);
        	//trace("dateArr = " + dateArr);

        	if (flag != "1")
        	{
        		this.UbiViewer.ismultireport = "true";
        		this.UbiViewer.multicount = chk + "";
        		for (let i = 0; i < dateArr.length; i++)
        		{
        			this.UbiViewer.setArgument("P_DATE." + (i + 1), dateArr[i]);
        		}
        	}
        	else
        	{
        	...
        	this.UbiViewer.setArgument("P_DGUBUN", gubun);
        	this.UbiViewer.setArgument("P_DNO", no);
        	this.UbiViewer.setArgument("P_FLAG", flag);

        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00401_R03.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00401_R03.xfdl");
