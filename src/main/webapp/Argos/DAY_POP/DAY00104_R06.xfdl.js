(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00104_R06");
            this.set_titletext("기저귀사용대장");
        ...
        // User Script
        this.registerScript("DAY00104_R06.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00104_R06.xfdl");
