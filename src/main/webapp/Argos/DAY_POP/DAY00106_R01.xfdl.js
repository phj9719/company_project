(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00106_R01");
            this.set_titletext("집중배설관찰기록");
        ...
        // User Script
        this.registerScript("DAY00106_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	const dayz = this.parent.pParam.dayz;
        	...
        	this.UbiViewer.setArgument("P_DAYZ", dayz);
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00106_R01.xfdl");
