(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00703_R02");
            this.set_titletext("위생점검일지(7일)");
        ...
        // User Script
        this.registerScript("DAY00703_R02.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.DAY00712_R01_onload = function(obj,e)
        {
        	...
        	const mindate = this.parent.pParam.mindate;
        	const maxdate = this.parent.pParam.maxdate;
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00703_R02.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00703_R02.xfdl");
