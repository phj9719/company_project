(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00402_R05");
            this.set_titletext("차량별 운행일정");
        ...
        // User Script
        this.registerScript("DAY00402_R05.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	//trace("argument : sicode = " + sicode + ", date = " + date + ", gubun : " + gubun);
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00402_R05.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00402_R05.xfdl");
