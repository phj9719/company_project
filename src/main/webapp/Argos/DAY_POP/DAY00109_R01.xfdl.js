(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00109_R01");
            this.set_titletext("월간 기능회복훈련기록  서식");
        ...
        // User Script
        this.registerScript("DAY00109_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00109_R01.xfdl");
