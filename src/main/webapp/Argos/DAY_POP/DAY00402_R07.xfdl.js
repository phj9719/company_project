(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00402_R07");
            this.set_titletext("송영일지서식(B)");
        ...
        // User Script
        this.registerScript("DAY00402_R07.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	const yy = year.substr(0, 2);

        	//trace("argument : sicode = " + sicode + ", date = " + date + ", year : " + year);

        	this.UbiViewer.setArgument("P_SICODE", sicode);
        	this.UbiViewer.setArgument("P_DATE", date);
        	this.UbiViewer.setArgument("P_YY", yy);

        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00402_R07.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00402_R07.xfdl");
