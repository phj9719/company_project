(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00708_R01");
            this.set_titletext("직원회의록 & 서명부");
        ...
        // User Script
        this.registerScript("DAY00708_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	if (repo1 == "1")
        		jrfArr.push("DAY00708_R01.jrf");
        	else if (repo1 == "2")
        		jrfArr.push("DAY00708_R02.jrf");

        	if (repo2 == "1")
        		jrfArr.push("DAY00708_R03.jrf");
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00708_R01.xfdl");
