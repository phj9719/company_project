(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00211_R07");
            this.set_titletext("배뇨관찰집계");
        ...
        // User Script
        this.registerScript("DAY00211_R07.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	const m_group = this.parent.pParam.m_group;
        	...
        	this.UbiViewer.setArgument("P_M_GROUP", m_group);
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00211_R07.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00211_R07.xfdl");
