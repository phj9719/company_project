(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00302_P01");
            this.set_titletext("물리(작업)치료 제공기록(삭제)");
            if (Form == this.constructor)
            {
                this._setFormPosition(700,275);
            }
            ...
            obj._setContents("<ColumnInfo><Column id=\"sicode\" type=\"STRING\" size=\"256\"/><Column id=\"mulnumber\" type=\"STRING\" size=\"256\"/><Column id=\"mulday\" type=\"STRING\" size=\"256\"/><Column id=\"제공일\" type=\"STRING\" size=\"256\"/><Column id=\"mulgroup\" type=\"STRING\" size=\"256\"/><Column id=\"mulname\" type=\"STRING\" size=\"256\"/><Column id=\"mulcode\" type=\"STRING\" size=\"256\"/><Column id=\"치료명01\" type=\"STRING\" size=\"256\"/><Column id=\"치료명02\" type=\"STRING\" size=\"256\"/><Column id=\"치료명03\" type=\"STRING\" size=\"256\"/><Column id=\"치료명04\" type=\"STRING\" size=\"256\"/><Column id=\"치료명05\" type=\"STRING\" size=\"256\"/><Column id=\"치료명06\" type=\"STRING\" size=\"256\"/><Column id=\"치료명07\" type=\"STRING\" size=\"256\"/><Column id=\"치료명08\" type=\"STRING\" size=\"256\"/><Column id=\"참여01\" type=\"STRING\" size=\"256\"/><Column id=\"참여02\" type=\"STRING\" size=\"256\"/><Column id=\"참여03\" type=\"STRING\" size=\"256\"/><Column id=\"참여04\" type=\"STRING\" size=\"256\"/><Column id=\"참여05\" type=\"STRING\" size=\"256\"/><Column id=\"참여06\" type=\"STRING\" size=\"256\"/><Column id=\"참여07\" type=\"STRING\" size=\"256\"/><Column id=\"참여08\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta_subTitle","200","9","280","24",null,null,null,null,null,null,this.div_main.form);
            obj.set_taborder("0");
            obj.set_text("수급자 물리(작업)치료 제공기록 삭제");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",700,275,this,function(p){});
            ...
            obj = new BindItem("item2","div_main.form.sta_group","text","ds_data","mulgroup");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("DAY00302_P01.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("DAY00302_P01.xfdl","lib::pgm_com.xjs");
        this.registerScript("DAY00302_P01.xfdl", function() {
        /***********************************************************************
         * 화면ID   	: DAY00302_P01
         * 화면명   	: 물리(작업)치료 제공기록(삭제)
         * 화면설명 	:
         * 작성일   	: 2022-05-30
         * 작성자   	: 조기종
         * 수정이력 	:
        ...
        {
        	if (!this.confirm("물리치료 제공기록 삭제 확인 후 선택하세요 !"))
        		return false;

        	if (!this.confirm("물리치료 제공기록 삭제 확인 후 진행하세요 !"))
        		return false;
        ...
        this.fn_search = function ()
        {
        	...
        	const argument = "method=getList"
        				   + " sqlId=DAY00302_P01.DAY00302_P01_DS_DATA_S";
        ...
        this.fn_delete = function()
        {
        	...
        	const argument = "method=delete"
        				   + " sqlId=DAY00302_P01.DAY00302_P01_DS_DATA_D";
        ...
        this.loadIncludeScript("DAY00302_P01.xfdl");
