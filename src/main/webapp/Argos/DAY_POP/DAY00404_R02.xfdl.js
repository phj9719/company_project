(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00404_R02");
            this.set_titletext("급여제공 계획서");
        ...
        // User Script
        this.registerScript("DAY00404_R02.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	const print = this.parent.pParam.reportDay;
        	const code = this.parent.pParam.code;
        	const arr = this.parent.pParam.timeArr;
        	const daylength = this.parent.pParam.daycount;

        	//trace("argument : sicode = " + sicode + ", print = " + print + ", code : " + code + ", daylength : " + daylength);
        	//trace("arr : " + arr);
        	...
        	for (let i = 1; i <= daylength; i++)
        	{
        		...
        		if (val == 1)
        			this.UbiViewer.setArgument("P_" + count.padStart(2, '0'), "O");
        		else
        			this.UbiViewer.setArgument("P_" + count.padStart(2, '0'), "X");
        	}

        	this.UbiViewer.setArgument("P_SICODE", sicode);
        	this.UbiViewer.setArgument("P_PDATE", print);
        	this.UbiViewer.setArgument("P_CODE", code);

        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00404_R02.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00404_R02.xfdl");
