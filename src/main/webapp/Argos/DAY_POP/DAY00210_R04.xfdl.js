(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00210_R04");
            this.set_titletext("자세변경 기록서식");
        ...
        // User Script
        this.registerScript("DAY00210_R04.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00210_R04.xfdl");
