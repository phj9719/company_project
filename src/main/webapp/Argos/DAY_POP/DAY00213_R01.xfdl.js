(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00212_R01");
            this.set_titletext("간호.건강수준평가 리스트");
        ...
        // User Script
        this.registerScript("DAY00213_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00213_R01.xfdl");
