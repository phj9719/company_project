(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"sicode\" type=\"STRING\" size=\"256\"/><Column id=\"date\" type=\"STRING\" size=\"256\"/><Column id=\"m_code\" type=\"STRING\" size=\"256\"/><Column id=\"sexgb\" type=\"STRING\" size=\"256\"/><Column id=\"m_group\" type=\"STRING\" size=\"256\"/><Column id=\"row\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_data", this);
            obj._setContents("<ColumnInfo><Column id=\"sicode\" type=\"STRING\" size=\"256\"/><Column id=\"m_code\" type=\"STRING\" size=\"256\"/><Column id=\"m_group\" type=\"STRING\" size=\"256\"/><Column id=\"m_autoid\" type=\"STRING\" size=\"256\"/><Column id=\"m_name\" type=\"STRING\" size=\"256\"/><Column id=\"성별\" type=\"STRING\" size=\"256\"/><Column id=\"나이\" type=\"STRING\" size=\"256\"/><Column id=\"age\" type=\"STRING\" size=\"256\"/><Column id=\"식사종류\" type=\"STRING\" size=\"256\"/><Column id=\"기능장애\" type=\"STRING\" size=\"256\"/><Column id=\"st1\" type=\"STRING\" size=\"256\"/><Column id=\"st2\" type=\"STRING\" size=\"256\"/><Column id=\"st3\" type=\"STRING\" size=\"256\"/><Column id=\"st4\" type=\"STRING\" size=\"256\"/><Column id=\"st5\" type=\"STRING\" size=\"256\"/><Column id=\"배설조절\" type=\"STRING\" size=\"256\"/><Column id=\"배설변의\" type=\"STRING\" size=\"256\"/><Column id=\"배설뇨의\" type=\"STRING\" size=\"256\"/><Column id=\"배설보조\" type=\"STRING\" size=\"256\"/><Column id=\"침실사용\" type=\"STRING\" size=\"256\"/><Column id=\"drugtime\" type=\"STRING\" size=\"256\"/><Column id=\"신장\" type=\"STRING\" size=\"256\"/><Column id=\"체중\" type=\"STRING\" size=\"256\"/><Column id=\"혈액형\" type=\"STRING\" size=\"256\"/><Column id=\"종교\" type=\"STRING\" size=\"256\"/><Column id=\"추가시분\" type=\"STRING\" size=\"256\"/><Column id=\"nur_time1\" type=\"STRING\" size=\"256\"/><Column id=\"nur_time2\" type=\"STRING\" size=\"256\"/><Column id=\"nur_time3\" type=\"STRING\" size=\"256\"/><Column id=\"nur_time4\" type=\"STRING\" size=\"256\"/><Column id=\"nur_time5\" type=\"STRING\" size=\"256\"/><Column id=\"nur_time6\" type=\"STRING\" size=\"256\"/><Column id=\"제공시분\" type=\"STRING\" size=\"256\"/><Column id=\"row\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item19","div_cont.form.chk_kind1","value","ds_data","식사종류");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item61","div_cont.form.chk_kind2","value","ds_data","식사종류");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item62","div_cont.form.chk_kind3","value","ds_data","식사종류");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("DAY00110_P01.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("DAY00110_P01.xfdl","lib::pgm_com.xjs");
        this.registerScript("DAY00110_P01.xfdl", function() {
        /***********************************************************************
         * 화면ID   	: DAY00110_P01
         * 화면명   	: 수급자 상태설정
         * 화면설명 	: 수급자 상태설정
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	nexacro.getApplication().gv_curWinKey = "DAY00110_P01";
        ...
        this.fn_search = function()
        {
        	...
        	const argument = "method=getList "
        				   + "sqlId='DAY00110_P01.DAY00110_P01_DS_DATA_S '";
        ...
        this.fn_callback = function(strSvcID, nErrorCode, strErrorMsg)
        {
        	if (nErrorCode == 0)
        	{
        		...
        		else if(strSvcID == "set_import")
        		{
        			...
        			for(var i=1; i<=6; i++){
        				// 제공분 0 제거
        				if(this.ds_record.getColumn(0,"nur_time"+i)){
        					this.ds_data.setColumn(0,"nur_time"+i, this.ds_record.getColumn(0,"nur_time"+i));
        				}
        			}
        		}
        	}
        ...
        this.btn_set_import = function(obj,e)
        {
        	...
        	const argument = "method=getList "
        				   + "sqlId='DAY00110_P01.DAY00110_P01_DS_RECORD_S '";
        	const callbackFunc = "fn_callback";
        ...
        this.fn_dataCopy = function()
        {
        	...
        	// 제공분 0 제거
        	for(var i=1; i<=6; i++){
        		if(this.ds_data.getColumn(0,"nur_time"+i)){
        			this.ds_data.setColumn(0,"nur_time"+i, this.ds_data.getColumn(0,"nur_time"+i));
        		}
        	}
        ...
        this.loadIncludeScript("DAY00110_P01.xfdl");
