(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00404_R03");
            this.set_titletext("송영일정표(목욕일정)");
        ...
        // User Script
        this.registerScript("DAY00404_R03.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	const code = this.parent.pParam.code;
        	const count = this.parent.pParam.totday;
        	const arr1 = this.parent.pParam.notArr;
        	const arr2 = this.parent.pParam.notArr2;
        	const from = this.parent.pParam.from;

        	trace("argument : sicode = " + sicode + ", code : " + code + ", count : " + count + ", from : " + from);
        	trace("arr1 : " + arr1);
        	trace("arr2 : " + arr2);
        	...
        	trace("notArr : " + notArr);
        	trace("notArr2 : " + notArr2);

        	this.UbiViewer.setArgument("P_SICODE", sicode);
        	this.UbiViewer.setArgument("P_CODE", code);
        	this.UbiViewer.setArgument("P_COUNT", count);
        	this.UbiViewer.setArgument("P_DATE_FROM", from);
        	this.UbiViewer.setArgument("P_NOTARR", notArr);
        	this.UbiViewer.setArgument("P_NOTARR2", notArr2);

        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00404_R03.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00404_R03.xfdl");
