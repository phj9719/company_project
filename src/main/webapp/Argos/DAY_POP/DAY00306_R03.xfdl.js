(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DAY00306_R03.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	const offname = this.parent.pParam.offname;

        	//trace("argument : sicode = " + sicode + ", year = " + year + ", offname = " + offname);

        	this.UbiViewer.setArgument("P_SICODE", sicode);
        	this.UbiViewer.setArgument("P_YEAR", year);
        	this.UbiViewer.setArgument("P_OFFNAME", offname);

        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00306_R03.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00306_R03.xfdl");
