(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00108_R01");
            this.set_titletext("월간 인지관리지원 점검기록");
        ...
        // User Script
        this.registerScript("DAY00108_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00108_R01.xfdl");
