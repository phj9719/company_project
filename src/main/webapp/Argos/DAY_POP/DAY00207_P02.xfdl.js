(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00207_P02");
            this.set_titletext("병의원 진료기록");
        ...
        // User Script
        this.addIncludeScript("DAY00207_P02.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("DAY00207_P02.xfdl","lib::pgm_com.xjs");
        this.registerScript("DAY00207_P02.xfdl", function() {
        /***********************************************************************
         * 화면ID   	: DAY00207_P02
         * 화면명   	: 병의원 진료기록
         * 화면설명 	:
        ...
        this.DAY00207_P02_onload = function(obj,e)
        {
        	...
        	nexacro.getApplication().gv_curWinKey = "DAY00207_P02";
        ...
        this.fn_search = function()
        {
        	...
        	const argument = "method=getList "
        				   + "sqlId=DAY00207_P02.DAY00207_P02_DS_LIST_S ";
        ...
        this.fn_delete = function()
        {
        	...
        	const argument = "method=delete "
        				   + "sqlId=DAY00207_P02.DAY00207_P02_DS_MEDI_SELECT_D ";
        ...
        this.div_cont_div_right2_btn_01_onclick = function(obj,e)
        {
        	...
        	Sct.popup(this, "hosp", 450, 600, "병·의원명 지정", param, "DAY_POP::DAY00207_P01.xfdl", "fn_popCallback");
        };
        ...
        this.loadIncludeScript("DAY00207_P02.xfdl");
