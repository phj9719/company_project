(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00401_R01");
            this.set_titletext("송영일지(일반)");
        ...
        // User Script
        this.registerScript("DAY00401_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	//trace("argument : sicode = " + sicode + ", date = " + date + ", dsign = " + dsign + ", flag = " + flag + ", chk = " + chk);
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00401_R01.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00401_R01.xfdl");
