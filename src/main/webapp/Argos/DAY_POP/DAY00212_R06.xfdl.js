(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00212_R06");
            this.set_titletext("간호사정 건강수준 평가");
        ...
        // User Script
        this.registerScript("DAY00212_R06.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.UbiViewer.setArgument("P_N_NUMBER", n_number);
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00212_R06.xfdl");
