(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00211_R09");
            this.set_titletext("상비약품제공집계");
        ...
        // User Script
        this.registerScript("DAY00211_R09.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00211_R09.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00211_R09.xfdl");
