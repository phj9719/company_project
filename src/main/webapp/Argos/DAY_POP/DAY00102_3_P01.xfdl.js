(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_body8_00","15","614","449","19",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("2");
        ...
        // User Script
        this.addIncludeScript("DAY00102_3_P01.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("DAY00102_3_P01.xfdl","lib::pgm_com.xjs");
        this.registerScript("DAY00102_3_P01.xfdl", function() {
        /***********************************************************************
         * 화면ID   	: DAY00102_P01
         * 화면명   	: 요양,간호일지 조회
         * 화면설명 	:
        ...
        this.fn_search = function()
        {
        	...
        	const argument = "method=getList "
        				   + "sqlId=DAY00102_3_P01.DAY00102_3_P01_DS_LIST_S ";
        ...
        this.loadIncludeScript("DAY00102_3_P01.xfdl");
