(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00201_P09");
            this.set_titletext("병의원정보 등록, 수정");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"49\"/><Column size=\"148\"/><Column size=\"89\"/><Column size=\"202\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"병의원명\"/><Cell col=\"2\" text=\"전화번호\"/><Cell col=\"3\" text=\"주 소\"/></Band><Band id=\"body\"><Cell text=\"bind:병원번호\"/><Cell col=\"1\" text=\"bind:병의원명\" cssclass=\"cellBWoman\" cursor=\"pointer\" textAlign=\"left\"/><Cell col=\"2\" text=\"bind:전화번호\" textAlign=\"left\"/><Cell col=\"3\" text=\"bind:주소\" textAlign=\"left\"/></Band></Format></Formats>");
            this.div_cont.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("DAY00201_P09.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("DAY00201_P09.xfdl","lib::pgm_com.xjs");
        this.registerScript("DAY00201_P09.xfdl", function() {
        /***********************************************************************
         * 화면ID   	: DAY00201_P09
         * 화면명   	: 병·의원 추가등록
         * 화면설명 	:
        ...
        this.loadIncludeScript("DAY00201_P09.xfdl");
