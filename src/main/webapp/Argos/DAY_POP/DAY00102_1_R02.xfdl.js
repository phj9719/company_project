(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00102_1_R02");
            this.set_titletext("실습 리포트2");
            ...
            obj = new UbiReport("UbiViewer","0","-1","1000","900",null,null,null,null,null,null,this);
            obj.set_taborder("0");
        ...
        // User Script
        this.registerScript("DAY00102_1_R02.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        {
        	let jrfFile = "DAY00102_1_R02.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00102_1_R02.xfdl");
