(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00306_R02");
            this.set_titletext("물리치료 급여제공기록");
        ...
        // User Script
        this.registerScript("DAY00306_R02.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	const year = this.parent.pParam.year;
        	const code = this.parent.pParam.code;
        	const monArr = this.parent.pParam.monArr;
        	const chk = this.parent.pParam.chk;

        	//trace("argument : sicode = " + sicode + ", year = " + year + ", code = " + code);
        	...
        	{
        		this.UbiViewer.setArgument("P_MON." + (i + 1), monArr[i]);
        	}

        	this.UbiViewer.setArgument("P_SICODE", sicode);
        	this.UbiViewer.setArgument("P_CODE", code);
        	this.UbiViewer.setArgument("P_YEAR", year);

        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00306_R02.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00306_R02.xfdl");
