(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DAY00103_R05.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.DAY00712_R01_onload = function(obj,e)
        {
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00103_R05.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00103_R05.xfdl");
