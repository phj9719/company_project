(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00714_R01");
            this.set_titletext("전기안전관리 점검표");
        ...
        // User Script
        this.registerScript("DAY00714_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.DAY00713_R01_onload = function(obj,e)
        {
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00714_R01.jrf";
        ...
        ************************************************************************************/
        ...
        {
            this.addEventHandler("onload",this.DAY00713_R01_onload,this);
        };
        this.loadIncludeScript("DAY00714_R01.xfdl");
