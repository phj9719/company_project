(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00707_R01");
            this.set_titletext("직원 교육일지 & 서명부");
        ...
        // User Script
        this.registerScript("DAY00707_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	if (repo1 == "1")
        		jrfArr.push("DAY00707_R01.jrf");
        	if (repo2 == "1")
        		jrfArr.push("DAY00707_R02.jrf");
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00707_R01.xfdl");
