(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00302_R01");
            this.set_titletext("물리(작업)치료 제공기록");
        ...
        // User Script
        this.registerScript("DAY00302_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	//trace("argument : sicode = " + sicode + ", mon = " + mon + ", code = " + code);

        	this.UbiViewer.setArgument("P_SICODE", sicode);
        	this.UbiViewer.setArgument("P_MON", mon);
        	this.UbiViewer.setArgument("P_CODE", code);
        	this.UbiViewer.setArgument("P_PATH", fullPath);

        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00302_R01.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00302_R01.xfdl");
