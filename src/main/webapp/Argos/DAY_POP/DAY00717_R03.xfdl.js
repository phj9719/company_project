(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00717_R03");
            this.set_titletext("월간 실내·외 소독일지");
        ...
        // User Script
        this.registerScript("DAY00717_R03.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.DAY00712_R01_onload = function(obj,e)
        {
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00717_R03.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00717_R03.xfdl");
