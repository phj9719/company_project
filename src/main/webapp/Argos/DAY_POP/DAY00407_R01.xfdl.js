(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00407_R01");
            this.set_titletext("연간 운전자 송영집계");
        ...
        // User Script
        this.registerScript("DAY00407_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.UbiViewer.setArgument("P_ECODE", code);
        	this.UbiViewer.setArgument("P_YEAR", year);

        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00407_R01.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00407_R01.xfdl");
