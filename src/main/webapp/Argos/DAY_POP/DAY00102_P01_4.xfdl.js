(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00102_P01");
            this.set_titletext("요양.간호일지 조회");
            if (Form == this.constructor)
            {
                this._setFormPosition(800,653);
            }
            ...
            obj = new Grid("grd_list","15","44","750","570",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("0");
            obj.set_binddataset("ds_list");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"336\"/><Column size=\"315\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"70\"/></Rows><Band id=\"head\"><Cell text=\"작성일\"/><Cell col=\"1\" text=\"요양일지\"/><Cell col=\"2\" text=\"간호일지\"/></Band><Band id=\"body\"><Cell text=\"bind:k_nalja\"/><Cell col=\"1\" text=\"bind:kr_contents\" displaytype=\"textareacontrol\" edittype=\"readonly\" textareascrollbarsize=\"15\" textareascrollbartype=\"default\" textareascrolltype=\"vertical\"/><Cell col=\"2\" text=\"bind:kn_contents\" displaytype=\"textareacontrol\" edittype=\"readonly\" textareascrollbarsize=\"15\" textareascrollbartype=\"default\" textareascrolltype=\"vertical\"/></Band></Format></Formats>");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("sta_title","15","5","250","25",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("1");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",800,653,this,function(p){});
            ...
            obj = new BindItem("item19","div_cont.form.sta_title","text","ds_item","create_code");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("DAY00102_P01_4.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("DAY00102_P01_4.xfdl","lib::pgm_com.xjs");
        this.registerScript("DAY00102_P01_4.xfdl", function() {
        ...
        this.fn_search = function()
        {
        	...
        	const argument = "method=getList "
        				   + "sqlId=DAY00102_P01_4.DAY00102_P01_4_DS_LIST_S ";
        ...
        {
        	//kr_contents(요양일지), kn_contents(간호일지)를 반환하여 kr_idx,kn_idx에 담는다
        	...
        	//e.col은 (obj,e)가 있어야 사용 가능, 특정 행을 더블 클릭할대 발생하는 이벤트
        ...
        this.loadIncludeScript("DAY00102_P01_4.xfdl");
