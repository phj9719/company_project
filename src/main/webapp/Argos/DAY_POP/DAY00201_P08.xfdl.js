(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("DAY00201_P08.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("DAY00201_P08.xfdl","lib::pgm_com.xjs");
        this.registerScript("DAY00201_P08.xfdl", function() {
        /***********************************************************************
         * 화면ID   	: DAY00201_P08
         * 화면명   	: 병·의원명 지정
         * 화면설명 	:
        ...
        this.loadIncludeScript("DAY00201_P08.xfdl");
