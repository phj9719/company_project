(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00101_R02");
            this.set_titletext("장기요양급여 제공기록지서식");
        ...
        // User Script
        this.registerScript("DAY00101_R02.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        {
        	let jrfFile = "DAY00101_R02.jrf";

        	// UbiReport Argument 세팅
        	const sicode = this.parent.pParam.sicode;
        	const code = this.parent.pParam.mcode;
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00101_R02.xfdl");
