(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00702_R05");
            this.set_titletext("월간 간식식단표");
        ...
        // User Script
        this.registerScript("DAY00702_R05.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.DAY00712_R01_onload = function(obj,e)
        {
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00702_R05.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00702_R05.xfdl");
