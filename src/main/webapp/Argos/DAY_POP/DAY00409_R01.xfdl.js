(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00409_R01");
            this.set_titletext("월간 차량운행일지 집계");
        ...
        // User Script
        this.registerScript("DAY00409_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	//trace("argument : sicode = " + sicode + ", from = " + from + ", to = " + to + ", sign = " + sign);
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00409_R01.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00409_R01.xfdl");
