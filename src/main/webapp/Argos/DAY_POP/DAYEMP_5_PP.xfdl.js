(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"80\"/><Column size=\"30\"/><Column size=\"80\"/><Column size=\"60\"/><Column size=\"90\"/><Column size=\"90\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"그룹\"/><Cell col=\"1\" text=\"직원성명\"/><Cell col=\"2\" text=\"성\"/><Cell col=\"3\" text=\"담당직종\"/><Cell col=\"4\" text=\"현황\"/><Cell col=\"5\" text=\"입사일\"/><Cell col=\"6\" text=\"퇴사일\"/></Band><Band id=\"body\"><Cell text=\"bind:c_group\"/><Cell col=\"1\" textAlign=\"center\" text=\"bind:c_name\" cursor=\"pointer\"/><Cell col=\"2\" combodataset=\"ds_cm_rank_cd\" combodatacol=\"CMNM\" combocodecol=\"CMCD\" text=\"bind:성별\"/><Cell col=\"3\" text=\"bind:담당직종\"/><Cell col=\"4\" text=\"bind:근무현황\"/><Cell col=\"5\" text=\"bind:c_become\" displaytype=\"date\" expandchar=\"dot\"/><Cell col=\"6\" text=\"bind:c_retire\" displaytype=\"date\" expandchar=\"dot\" color=\"tomato\"/></Band></Format></Formats>");
        ...
        // User Script
        this.addIncludeScript("DAYEMP_5_PP.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("DAYEMP_5_PP.xfdl","lib::pgm_com.xjs");
        this.registerScript("DAYEMP_5_PP.xfdl", function() {
        ...
        this.fn_search = function()
        {
        	...
        	const argument = "method=getList "
        				   + "sqlId=DAYEMP_5_PP.DAYEMP_5_PP_DS_LIST_S ";
        ...
        this.loadIncludeScript("DAYEMP_5_PP.xfdl");
