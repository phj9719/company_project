(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00717_R01");
            this.set_titletext("실내·외 소독일지");
        ...
        // User Script
        this.registerScript("DAY00717_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	if (repo1 == "1")
        		jrfFile = "DAY00717_R01.jrf";
        	else if (repo1 == "2")
        		jrfFile = "DAY00717_R02.jrf";
        	...
        	const fileGrp2 = this.parent.pParam.fileGrp2;
        	...
        	if (!this.isEmpty(fileGrp2))
        	{
        		imgUrl = webHost + path + fileGrp2;
        		this.UbiViewer.setArgument("P_PATH2", imgUrl.replace("/ /g", "%20"));
        	}
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00717_R01.xfdl");
