(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00706_R01");
            this.set_titletext("식품위생점검표");
        ...
        // User Script
        this.registerScript("DAY00706_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.DAY00712_R01_onload = function(obj,e)
        {
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00706_R01.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00706_R01.xfdl");
