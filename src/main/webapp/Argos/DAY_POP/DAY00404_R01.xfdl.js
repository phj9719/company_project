(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00404_R01");
            this.set_titletext("급여제공 계획서서식");
        ...
        // User Script
        this.registerScript("DAY00404_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	//trace("argument : sicode = " + sicode + ", print = " + print + ", code : " + code);
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00404_R01.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00404_R01.xfdl");
