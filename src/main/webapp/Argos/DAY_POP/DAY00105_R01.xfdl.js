(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00105_R01");
            this.set_titletext("월간목욕일정표(일-8인)");
        ...
        // User Script
        this.registerScript("DAY00105_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00105_R01.xfdl");
