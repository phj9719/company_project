(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00220_R01");
            this.set_titletext("일일 투약전달기록");
        ...
        // User Script
        this.registerScript("DAY00220_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00220_R01.xfdl");
