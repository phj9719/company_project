(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("DAY00506_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	const mCodeStr = this.parent.pParam.DATE;
        //	const mCodeStr = this.parent.pParam.MCODESTR;


        	this.UbiViewer.ismultireport = "false";

        	this.UbiViewer.setArgument("P_SICODE", sicode);
        	this.UbiViewer.setArgument("P_DATE", mCodeStr);
        //	this.UbiViewer.setArgument("P_MCODERSTR", mCodeStr);


        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00506_R01.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00506_R01.xfdl");
