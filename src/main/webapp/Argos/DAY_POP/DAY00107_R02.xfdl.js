(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00107_R02");
            this.set_titletext("업무인수인계서(선택)");
        ...
        // User Script
        this.registerScript("DAY00107_R02.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00107_R02.xfdl");
