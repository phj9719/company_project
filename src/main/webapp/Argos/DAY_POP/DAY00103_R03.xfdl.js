(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00703_R03");
            this.set_titletext("식사도움기록");
        ...
        // User Script
        this.registerScript("DAY00103_R03.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.DAY00712_R01_onload = function(obj,e)
        {
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00103_R03.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00103_R03.xfdl");
