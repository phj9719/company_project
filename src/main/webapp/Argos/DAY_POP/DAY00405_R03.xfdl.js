(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00405_R03");
            this.set_titletext("월간 수급자 결석리스트");
        ...
        // User Script
        this.registerScript("DAY00405_R03.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	const to = this.parent.pParam.to;
        	const mon = this.parent.pParam.mon;

        	//trace("argument : sicode = " + sicode + ", date = " + date + ", from : " + from + ", to : " + to + ", mon : " + mon);
        	...
        	this.UbiViewer.setArgument("P_DATE_TO", to);
        	this.UbiViewer.setArgument("P_MONTH", mon);

        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00405_R03.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00405_R03.xfdl");
