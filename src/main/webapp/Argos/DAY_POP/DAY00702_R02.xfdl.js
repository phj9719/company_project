(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00702_R02");
            this.set_titletext("월간식단표");
        ...
        // User Script
        this.registerScript("DAY00702_R02.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.DAY00712_R01_onload = function(obj,e)
        {
        	...
        	const monthly = this.parent.pParam.monthly; // 주간 1, 월간 2 구분값
        	const weekly = this.parent.pParam.weekly; // 일토 1, 월일 2 구분값
        	...
        	//trace("weekly : " + weekly);
        	//trace("P_CATERER : " + caterer);
        	//trace("P_ORIGIN1 : " + origin1);
        	//trace("P_ORIGIN2 : " + origin2);

        	this.UbiViewer.setArgument("P_SICODE", sicode);
        	this.UbiViewer.setArgument("P_DATE", date);
        	this.UbiViewer.setArgument("P_SIGN", sign);
        	this.UbiViewer.setArgument("P_MONTHLY", monthly);
        	this.UbiViewer.setArgument("P_WEEKLY", weekly);
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00702_R02.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00702_R02.xfdl");
