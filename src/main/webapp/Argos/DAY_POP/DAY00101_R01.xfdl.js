(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00101_R01");
            this.set_titletext("일 목욕제공 리스트");
        ...
        // User Script
        this.registerScript("DAY00101_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00101_R01.xfdl");
