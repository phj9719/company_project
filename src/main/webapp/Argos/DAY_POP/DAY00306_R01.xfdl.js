(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00306_R01");
            this.set_titletext("연간 수급자 물리치료 제공집계");
        ...
        // User Script
        this.registerScript("DAY00306_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00306_R01.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00306_R01.xfdl");
