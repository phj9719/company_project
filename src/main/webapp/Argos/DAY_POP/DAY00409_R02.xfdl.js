(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00409_R02");
            this.set_titletext("차량별 월간운행일지");
        ...
        // User Script
        this.registerScript("DAY00409_R02.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	//trace("argument : sicode = " + sicode + ", from = " + from + ", to = " + to + ", gubun = " + gubun);
        	...
        	this.UbiViewer.setArgument("P_GUBUN", gubun);

        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00409_R02.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00409_R02.xfdl");
