(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00408_R01");
            this.set_titletext("송영차량 운행일지");
        ...
        // User Script
        this.registerScript("DAY00408_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	//trace("argument : sicode = " + sicode + ", date = " + date + ", sign = " + sign);
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00408_R01.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00408_R01.xfdl");
