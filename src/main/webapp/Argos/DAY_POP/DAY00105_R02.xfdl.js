(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00105_R02");
            this.set_titletext("월간목욕일정표(리스트)");
        ...
        // User Script
        this.registerScript("DAY00105_R02.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00105_R02.xfdl");
