(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00204_R01");
            this.set_titletext("상비약품점검일지");
        ...
        // User Script
        this.registerScript("DAY00204_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00204_R01.xfdl");
