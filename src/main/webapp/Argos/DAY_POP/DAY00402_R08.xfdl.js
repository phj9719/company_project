(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00402_R08");
            this.set_titletext("연간 송영차량별 운행현황");
        ...
        // User Script
        this.registerScript("DAY00402_R08.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	//trace("argument : sicode = " + sicode + ", date = " + date + ", gubun : " + gubun + ", year : " + year + ", no : " + no);
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00402_R08.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00402_R08.xfdl");
