(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00206_R01");
            this.set_titletext("의료폐기 관리대장");
        ...
        // User Script
        this.registerScript("DAY00206_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00206_R01.xfdl");
