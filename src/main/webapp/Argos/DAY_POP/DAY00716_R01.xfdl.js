(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00716_R01");
            this.set_titletext("비상구점검일지");
        ...
        // User Script
        this.registerScript("DAY00716_R01.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	if (repo1 == "1")
        		jrfFile = "DAY00716_R01.jrf";
        	else if (repo1 == "2")
        		jrfFile = "DAY00716_R02.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00716_R01.xfdl");
