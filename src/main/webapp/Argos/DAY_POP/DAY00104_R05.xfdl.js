(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00104_R05");
            this.set_titletext("목욕제공기록");
        ...
        // User Script
        this.registerScript("DAY00104_R05.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	const date_from = this.parent.pParam.date_from;
        	const date_to = this.parent.pParam.date_to;
        	const reserv_yn = this.parent.pParam.reserv_yn;	// 목욕제공기록에서 예약항목 즉, 제공방법 0인 항목을 제외할지 여부를 결정
        							// 'Y' 또는 'y'로 지정시 제공방법 0인 항목도 출력, 'N', 'n' 일때는 출력 않음)
        	...
        	this.UbiViewer.setArgument("P_DATE_FROM", date_from);
        	this.UbiViewer.setArgument("P_DATE_TO", date_to);
        	this.UbiViewer.setArgument("P_RESERV_YN", reserv_yn);
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00104_R05.xfdl");
