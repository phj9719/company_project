(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00211_R01");
            this.set_titletext("간호제공기록(8단)");
        ...
        // User Script
        this.registerScript("DAY00211_R01_copy0.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	const fdate = this.parent.pParam.date_from;
        	const tdate = this.parent.pParam.date_to;
        	const sign = this.parent.pParam.sign;
        	const flag = this.parent.pParam.flag;
        	if (flag == "1")
        	{
        		let size = m_code.length;
        	...
        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00211_R01.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00211_R01_copy0.xfdl");
