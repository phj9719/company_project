(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00209_R03");
            this.set_titletext("수급자별 청구기록");
        ...
        // User Script
        this.registerScript("DAY00209_R03.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	const fdate = this.parent.pParam.dateF;
        	const tdate = this.parent.pParam.dateT;
        	const sign = this.parent.pParam.sign;
        	const sort = this.parent.pParam.sort;
        	const mCodes = this.parent.pParam.mCodes;
        	let size = mCodes.length;

        	this.UbiViewer.ismultireport = "true";
        	this.UbiViewer.multicount = size;
        	for(let i=0;i<size;i++)
        		this.UbiViewer.setArgument("P_M_CODE." + (i+1), mCodes[i]);
        	...
        	this.UbiViewer.setArgument("P_SORT", sort);

        	// 리포트 파일명
            this.UbiViewer.jrffile = "DAY00209_R03.jrf";
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("DAY00209_R03.xfdl");
