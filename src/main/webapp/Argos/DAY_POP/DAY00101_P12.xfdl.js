(function()
{
    return function()
    {
        ...
        {
            this.set_name("DAY00101_P12");
            this.set_titletext("송영기록 조회·수정");
            if (Form == this.constructor)
            {
                this._setFormPosition(785,400);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("ds_search", this);
            obj._setContents("<ColumnInfo><Column id=\"sicode\" type=\"STRING\" size=\"256\"/><Column id=\"k_number\" type=\"STRING\" size=\"256\"/><Column id=\"k_code\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj = new Div("div_00","5","575","1170","256",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("div_00");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("sta_subTitle2","11","69","260","24",null,null,null,null,null,null,this.div_00.form);
            obj.set_taborder("0");
            obj.set_text("단기보호");
            obj.set_cssclass("lb01");
            this.div_00.addChild(obj.name, obj);

            obj = new Div("div_line00","10","100",null,"2","417",null,null,null,null,null,this.div_00.form);
            obj.set_taborder("1");
            obj.set_background("#000000");
            this.div_00.addChild(obj.name, obj);

            obj = new Static("sta_head9","9","108","83","64",null,null,null,null,null,null,this.div_00.form);
            obj.set_taborder("2");
            obj.set_cssclass("sta_WF_DetailLabel01");
            obj.set_textAlign("center");
            obj.set_text("단기보호\r\n야간시간");
            ...
            obj = new Static("sta_body9","91","108","660","64",null,null,null,null,null,null,this.div_00.form);
            obj.set_taborder("3");
            obj.set_cssclass("sta_WF_DetailLabel02");
            this.div_00.addChild(obj.name, obj);

            obj = new Static("sta_head9_1","389","108","83","64",null,null,null,null,null,null,this.div_00.form);
            obj.set_taborder("4");
            obj.set_cssclass("sta_WF_DetailLabel01");
            obj.set_textAlign("center");
            obj.set_text("이용사유");
            ...
            obj = new Edit("edt_from_hour","97","118","35","26",null,null,null,null,null,null,this.div_00.form);
            obj.set_taborder("5");
            obj.set_textAlign("center");
            obj.set_inputtype("digit");
            obj.set_maxlength("2");
            ...
            obj = new Static("sta_timeColon3","130","119","10","25",null,null,null,null,null,null,this.div_00.form);
            obj.set_taborder("6");
            obj.set_text(":");
            obj.set_textAlign("center");
            this.div_00.addChild(obj.name, obj);

            obj = new Edit("edt_from_min","140","118","35","26",null,null,null,null,null,null,this.div_00.form);
            obj.set_taborder("7");
            obj.set_textAlign("center");
            obj.set_inputtype("digit");
            obj.set_maxlength("2");
            ...
            obj = new Static("sta_no02","98","150","279","19",null,null,null,null,null,null,this.div_00.form);
            obj.set_taborder("8");
            obj.set_text("▲ 단기보호 야간시간 익일까지 표시 예시) 22:00 - 08:00");
            obj.set_font("normal 8pt/normal \"Arial\"");
            this.div_00.addChild(obj.name, obj);

            obj = new Static("sta_timeColon1_01_00","180","119","10","25",null,null,null,null,null,null,this.div_00.form);
            obj.set_taborder("9");
            obj.set_text("-");
            obj.set_textAlign("center");
            this.div_00.addChild(obj.name, obj);

            obj = new Edit("edt_to_hour","197","118","35","26",null,null,null,null,null,null,this.div_00.form);
            obj.set_taborder("10");
            obj.set_textAlign("center");
            obj.set_inputtype("digit");
            obj.set_maxlength("2");
            ...
            obj = new Static("sta_timeColon1_01_01","230","119","10","25",null,null,null,null,null,null,this.div_00.form);
            obj.set_taborder("11");
            obj.set_text(":");
            obj.set_textAlign("center");
            this.div_00.addChild(obj.name, obj);

            obj = new Edit("edt_to_min","240","118","35","26",null,null,null,null,null,null,this.div_00.form);
            obj.set_taborder("12");
            obj.set_textAlign("center");
            obj.set_inputtype("digit");
            obj.set_maxlength("2");
            ...
            obj = new Combo("cmb_remark_select","613","119","121","25",null,null,null,null,null,null,this.div_00.form);
            obj.set_taborder("13");
            ...
            obj = new Edit("edt_remark","477","119","129","25",null,null,null,null,null,null,this.div_00.form);
            obj.set_taborder("14");
            this.div_00.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",785,400,this,function(p){});
            ...
            obj = new BindItem("item10","div_00.form.edt_from_hour","value","ds_data","단기시작시");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item22","div_00.form.edt_from_min","value","ds_data","단기시작분");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item24","div_00.form.edt_to_hour","value","ds_data","단기종료시");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item25","div_00.form.edt_to_min","value","ds_data","단기종료분");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item26","div_00.form.edt_remark","value","ds_data","단기사유");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("DAY00101_P12.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("DAY00101_P12.xfdl","lib::pgm_com.xjs");
        this.registerScript("DAY00101_P12.xfdl", function() {
        /***********************************************************************
         * 화면ID   	: DAY00101_P12
         * 화면명   	: 송영기록 수정, 저장
         * 화면설명 	: 요양서비스 제공기록에서 송영기록을 수정,저장하는 팝업
         * 작성일   	: 2022-05-19
         * 작성자   	: 박한준
         * 수정이력 	:
         ***********************************************************************
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	nexacro.getApplication().gv_curWinKey = "DAY00101_P12";

        	// 검색조건 세팅
        	this.ds_search.setColumn(0, "sicode", fv_sicode);
        	this.ds_search.setColumn(0, "k_number", fv_knumber);
        	this.ds_search.setColumn(0, "k_code", fv_mcode);
        ...
        {
        	var shour = this.ds_data.getColumn(0,"시작시");
        	var smin = this.ds_data.getColumn(0,"시작분");
        	var ehour = this.ds_data.getColumn(0,"종료시");
        	var emin = this.ds_data.getColumn(0,"종료분");
        	var stime = ""; // 시작시간
        	var etime = ""; // 종료시간
        	...
        	this.ds_data.setColumn(0,"시작시간",stime);
        	this.ds_data.setColumn(0,"종료시간",etime);
        	//this.ds_data.setColumn(0,"단기시간",shorttime);
        ...
        this.fn_search = function ()
        {
        	...
        	const argument = "method=getList"
        				   + " sqlId=DAY00101_P12.DAY00101_P12_DS_DATA_S";
        ...
        this.fn_car_search = function()
        {
        	...
        	const argument = "method=getList"
        				   + " sqlId=DAY00101_P12.DAY00101_P12_DS_CAR_S";
        ...
        this.fn_callback = function (strSvcID, nErrorCode, strErrorMsg)
        {
        	if (nErrorCode == 0)
        	{
        		if (strSvcID == "search")
        		{
        			...
        			{
        				if(nexacro.trim(this.ds_data.getColumn(0,"시작시")) == ""){
        					this.ds_data.setColumn(0, "시작시", "00");
        				}
        				if(nexacro.trim(this.ds_data.getColumn(0,"시작분")) == ""){
        					this.ds_data.setColumn(0, "시작분", "00");
        				}
        				if(nexacro.trim(this.ds_data.getColumn(0,"종료시")) == ""){
        					this.ds_data.setColumn(0, "종료시", "00");
        				}
        				if(nexacro.trim(this.ds_data.getColumn(0,"종료분")) == ""){
        ...
        this.fn_setComboDs = function(obj)
        {
        	const comboDsParamArr = [
        		{ outDsName : "ds_dist", sqlId : "DAY00101_P12.DAY00101_P12_DS_DIST_S", param : this.ds_search, bEmptyRow : false }
        	];
        ...
        this.btn_erase_onclick = function(obj,e)
        {
        	...
        	switch(obj.id) {
        		case "btn_startErase" :
        			str = "시작";
        			str2 = "오전";
        			this.div_main.form.cmb_scar_select.set_value("");
        			this.div_main.form.cmb_sdist_select.set_value("");
        			break;
        		case "btn_endErase" :
        			str = "종료";
        			str2 = "오후";
        			this.div_main.form.cmb_ecar_select.set_value("");
        			this.div_main.form.cmb_edist_select.set_value("");
        			break;
        		default:
        	}
        	...
        	this.ds_data.setColumn(0, str2 + "거리", "0");
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_00.form.edt_from_hour.addEventHandler("onchanged",this.edt_hour_onchanged,this);
            this.div_00.form.edt_from_min.addEventHandler("onchanged",this.edt_min_onchanged,this);
            this.div_00.form.edt_to_hour.addEventHandler("onchanged",this.edt_hour_onchanged,this);
            this.div_00.form.edt_to_min.addEventHandler("onchanged",this.edt_min_onchanged,this);
            this.div_00.form.cmb_remark_select.addEventHandler("onitemchanged",this.div_main_cmb_remark_select_onitemchanged,this);
        };
        this.loadIncludeScript("DAY00101_P12.xfdl");
