(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("버전확인 및 버전업데이트");
        ...
        // User Script
        this.addIncludeScript("NUC012CT.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUC012CT.xfdl","lib::pgm_com.xjs");
        this.addIncludeScript("NUC012CT.xfdl","lib::mpgm_com.xjs");
        this.registerScript("NUC012CT.xfdl", function() {
        /***********************************************************************
         * 화면ID    	: NUC012CT
         * 화면명   	: 버전확인 및 버전업데이트
        ...
        this.loadIncludeScript("NUC012CT.xfdl");
