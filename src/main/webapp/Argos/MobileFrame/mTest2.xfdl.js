(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"DATE\" type=\"STRING\" size=\"256\"/><Column id=\"A\" type=\"STRING\" size=\"256\"/><Column id=\"TIME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"DATE\">2021.06.30</Col><Col id=\"A\">양족어깨관절</Col><Col id=\"TIME\">30분</Col></Row><Row><Col id=\"DATE\">2021.06.24</Col><Col id=\"A\">양쪽어깨관절</Col><Col id=\"TIME\">30분</Col></Row><Row><Col id=\"DATE\">2021.06.19</Col><Col id=\"A\">등</Col><Col id=\"TIME\">30분</Col></Row><Row><Col id=\"DATE\">2021.06.12</Col><Col id=\"A\">양쪽다리</Col><Col id=\"TIME\">30분</Col></Row><Row><Col id=\"DATE\">2021.06.08</Col><Col id=\"A\">양쪽다리</Col><Col id=\"TIME\">30분</Col></Row><Row><Col id=\"DATE\">2021.06.04</Col><Col id=\"A\">양쪽무릎</Col><Col id=\"TIME\">30분</Col></Row><Row><Col id=\"DATE\">2021.06.01</Col><Col id=\"A\">양쪽무릎</Col><Col id=\"TIME\">30분</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_chart", this);
            obj._setContents("<ColumnInfo><Column id=\"DATE\" type=\"STRING\" size=\"256\"/><Column id=\"TIME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"DATE\">06.01</Col><Col id=\"TIME\">30</Col></Row><Row><Col id=\"DATE\">06.04</Col><Col id=\"TIME\">30</Col></Row><Row><Col id=\"DATE\">06.08</Col><Col id=\"TIME\">30</Col></Row><Row><Col id=\"DATE\">06.12</Col><Col id=\"TIME\">30</Col></Row><Row><Col id=\"DATE\">06.19</Col><Col id=\"TIME\">30</Col></Row><Row><Col id=\"DATE\">06.24</Col><Col id=\"TIME\">30</Col></Row><Row><Col id=\"DATE\">06.30</Col><Col id=\"TIME\">30</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Static("Static00","5%","250",null,"40","5%",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("운동치료 내역");
            ...
            obj = new Grid("Grid00","5.00%","331",null,"251","5.00%",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_autofittype("col");
            obj.set_binddataset("ds_list");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"130\"/><Column size=\"90\"/></Columns><Rows><Row size=\"40\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"날짜\"/><Cell col=\"1\" text=\"부위\"/><Cell col=\"2\" text=\"시간\"/></Band><Band id=\"body\"><Cell text=\"bind:DATE\"/><Cell col=\"1\" text=\"bind:A\"/><Cell col=\"2\" text=\"bind:TIME\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("mTest2.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("mTest2.xfdl","lib::pgm_com.xjs");
        this.addIncludeScript("mTest2.xfdl","lib::mpgm_com.xjs");
        this.registerScript("mTest2.xfdl", function() {
        /***********************************************************************
         * 화면ID    	: mTest
         * 화면명   	:
         * 화면설명 	:
        ...
        this.loadIncludeScript("mTest2.xfdl");
