(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"DATE\" type=\"STRING\" size=\"256\"/><Column id=\"A\" type=\"STRING\" size=\"256\"/><Column id=\"TIME\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_chart", this);
            obj._setContents("<ColumnInfo><Column id=\"DATE\" type=\"STRING\" size=\"256\"/><Column id=\"TIME\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Static("Static00","5%","250",null,"40","5%",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("작업치료 내역");
            obj.set_cssclass("sta_title");
            this.addChild(obj.name, obj);

            obj = new Static("Static01","5.00%","291",null,"30","5.00%",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("최근 30일간 홍길동님의 작업치료 정보입니다.");
            obj.set_textAlign("left");
            obj.set_cssclass("sta_txt");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid00","5.00%","331",null,"368","5.00%",null,null,null,null,null,this);
            obj.set_taborder("2");
        ...
        // User Script
        this.addIncludeScript("mTest3.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("mTest3.xfdl","lib::pgm_com.xjs");
        this.addIncludeScript("mTest3.xfdl","lib::mpgm_com.xjs");
        this.registerScript("mTest3.xfdl", function() {
        /***********************************************************************
         * 화면ID    	: mTest
         * 화면명   	:
         * 화면설명 	:
        ...
        this.loadIncludeScript("mTest3.xfdl");
