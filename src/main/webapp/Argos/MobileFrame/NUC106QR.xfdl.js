(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"COMPANY_CD\" type=\"STRING\" size=\"256\"/><Column id=\"RES_ID\" type=\"STRING\" size=\"256\"/><Column id=\"SGD_DT\" type=\"STRING\" size=\"256\"/><Column id=\"CHART_DATE\" type=\"STRING\" size=\"256\"/><Column id=\"PT\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_sgds", this);
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"COMPANY_CD\" type=\"STRING\" size=\"256\"/><Column id=\"RES_ID\" type=\"STRING\" size=\"256\"/><Column id=\"SGD_DT\" type=\"STRING\" size=\"256\"/><Column id=\"PT\" type=\"STRING\" size=\"256\"/><Column id=\"SCORE\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("0");
            obj.set_text("지난 3개월간 검사내역");
            obj.set_cssclass("sta_title");
            this.addChild(obj.name, obj);

            obj = new Div("div_lastSgd","5.00%","70",null,"140","5.00%",null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Static("sta_day","2.78%","11",null,"26","2.78%",null,null,null,null,null,this.div_lastSgd.form);
            obj.set_taborder("0");
            obj.set_text("DAY");
            obj.set_font("normal 700 16pt/normal \"Noto Sans KR\"");
            obj.set_color("#ffffff");
            obj.set_textAlign("center");
            this.div_lastSgd.addChild(obj.name, obj);

            obj = new Div("div_line","2.78%","49",null,"2","2.78%",null,null,null,null,null,this.div_lastSgd.form);
            obj.set_taborder("1");
            obj.set_text("Div00");
            this.div_lastSgd.addChild(obj.name, obj);

            obj = new Static("sta_ptH","36.11%","44.29%","27.78%","18.57%",null,null,null,null,null,null,this.div_lastSgd.form);
            obj.set_taborder("2");
            obj.set_text("점수");
            obj.set_color("#ffffff");
            obj.set_textAlign("center");
            ...
            obj = new Static("sta_ptVal","36.11%","69.29%","27.78%","18.57%",null,null,null,null,null,null,this.div_lastSgd.form);
            obj.set_taborder("3");
            obj.set_font("normal 700 13pt/normal \"Noto Sans KR\"");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"130\"/><Column size=\"120\"/></Columns><Rows><Row size=\"40\" band=\"head\"/><Row size=\"40\"/></Rows><Band id=\"head\"><Cell text=\"날짜\"/><Cell col=\"1\" text=\"점수\"/></Band><Band id=\"body\"><Cell text=\"bind:SGD_DT\" expandchar=\"dot\" displaytype=\"date\"/><Cell col=\"1\" text=\"bind:PT\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new BasicChart("cha_sgd","5.00%","275",null,"220","5.00%",null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new BindItem("item2","div_lastSgd.form.sta_ptVal","text","ds_sgds","SCORE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("NUC106QR.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUC106QR.xfdl","lib::pgm_com.xjs");
        this.addIncludeScript("NUC106QR.xfdl","lib::mpgm_com.xjs");
        this.registerScript("NUC106QR.xfdl", function() {
        /***********************************************************************
         * 화면ID    	: NUC106QR
         * 화면명   	: 우울검사
         ...
         ***********************************************************************/
        this.NUC106QR_onload = function(obj,e)
        {
        ...
        // 모바일 디바이스 버튼 이벤트
        this.NUC106QR_ondevicebuttonup = function(obj,e)
        {
        	if(e.button == 2)
        	{
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("ondevicebuttonup",this.NUC106QR_ondevicebuttonup,this);
            this.addEventHandler("onload",this.NUC106QR_onload,this);
        };
        this.loadIncludeScript("NUC106QR.xfdl");
