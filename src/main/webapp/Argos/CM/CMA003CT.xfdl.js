(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_grp_cd","509","11","90","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("7");
            obj.set_text("그룹코드");
            ...
            obj = new Edit("edt_grp_cd","608","11","130","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("2");
            obj.set_autoselect("true");
            this.div_search.addChild(obj.name, obj);

            obj = new Static("sta_grp_cd00","749","11","90","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("8");
            obj.set_text("그룹명");
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.set_textAlign("right");
            ...
            obj = new Edit("edt_grpnm","849","11","130","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("3");
            obj.set_autoselect("true");
            this.div_search.addChild(obj.name, obj);

            obj = new Static("sta_company","4","11","90","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("5");
            obj.set_text("법인명");
            obj.set_cssclass("sta_WF_SearchLabel");
            ...
            obj = new Static("sta_serv_tp","254","11","90","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("6");
            obj.set_text("서비스유형");
            obj.set_cssclass("sta_WF_SearchLabel");
            obj.set_color("rgba(34,34,34,1)");
            ...
            obj = new Combo("cmb_serv_tp","349","11","130","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("1");
            ...
            obj = new Grid("grd_head","0","36",null,null,"0","0",null,null,null,null,this.div_cont.form.div_left.form);
            obj.set_taborder("0");
            obj.set_binddataset("ds_head");
            obj.set_autoenter("select");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"40\"/><Column size=\"40\"/><Column size=\"60\"/><Column size=\"134\"/><Column size=\"141\"/><Column size=\"131\"/><Column size=\"140\"/><Column size=\"120\"/><Column size=\"132\"/><Column size=\"60\"/><Column size=\"70\"/><Column size=\"70\"/><Column size=\"70\"/><Column size=\"70\"/><Column size=\"70\"/><Column size=\"70\"/><Column size=\"70\"/><Column size=\"70\"/><Column size=\"70\"/><Column size=\"70\"/><Column size=\"48\"/><Column size=\"48\"/><Column size=\"48\"/><Column size=\"48\"/><Column size=\"48\"/><Column size=\"48\"/><Column size=\"48\"/><Column size=\"48\"/><Column size=\"48\"/><Column size=\"48\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"90\"/><Column size=\"120\"/><Column size=\"90\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell expandchar=\"status\"/><Cell col=\"1\" expandchar=\"delete\"/><Cell col=\"2\" text=\"NO\"/><Cell col=\"3\" text=\"법인코드\"/><Cell col=\"4\" text=\"법인명\"/><Cell col=\"5\" text=\"서비스유형\" cssclass=\"CellEssential\"/><Cell col=\"6\" text=\"그룹코드\" cssclass=\"CellEssential\"/><Cell col=\"7\" text=\"그룹명\" cssclass=\"CellEssential\"/><Cell col=\"8\" text=\"상세설명\"/><Cell col=\"9\" text=\"고객공통코드조회부\"/><Cell col=\"10\" text=\"사용여부\"/><Cell col=\"11\" text=\"TITLE1\"/><Cell col=\"12\" text=\"TITLE2\"/><Cell col=\"13\" text=\"TITLE3\"/><Cell col=\"14\" text=\"TITLE4\"/><Cell col=\"15\" text=\"TITLE5\"/><Cell col=\"16\" text=\"TITLE6\"/><Cell col=\"17\" text=\"TITLE7\"/><Cell col=\"18\" text=\"TITLE8\"/><Cell col=\"19\" text=\"TITLE9\"/><Cell col=\"20\" text=\"TITLE10\"/><Cell col=\"21\" text=\"STR1\"/><Cell col=\"22\" text=\"STR2\"/><Cell col=\"23\" text=\"STR3\"/><Cell col=\"24\" text=\"STR4\"/><Cell col=\"25\" text=\"STR5\"/><Cell col=\"26\" text=\"STR6\"/><Cell col=\"27\" text=\"STR7\"/><Cell col=\"28\" text=\"STR8\"/><Cell col=\"29\" text=\"STR9\"/><Cell col=\"30\" text=\"STR10\"/><Cell col=\"31\" text=\"등록자ID\"/><Cell col=\"32\" text=\"등록자명\"/><Cell col=\"33\" text=\"등록일자\"/><Cell col=\"34\" text=\"수정자명\"/><Cell col=\"35\" text=\"수정일자\"/></Band><Band id=\"body\"><Cell/><Cell col=\"1\"/><Cell col=\"2\" text=\"expr:currow + 1\"/><Cell col=\"3\" text=\"bind:COMPANY_CD\" edittype=\"normal\"/><Cell col=\"4\" text=\"bind:COMPANY_NM\" edittype=\"none\"/><Cell col=\"5\" text=\"bind:SERVICE_TP\" displaytype=\"combotext\" edittype=\"combo\" combodataset=\"ds_cm_service_tp\" combocodecol=\"CMCD\" combodatacol=\"CMNM\"/><Cell col=\"6\" text=\"bind:GRP_CD\" edittype=\"normal\" textAlign=\"left\"/><Cell col=\"7\" text=\"bind:GRPNM\" edittype=\"normal\" textAlign=\"left\"/><Cell col=\"8\" text=\"bind:REMARK\" displaytype=\"normal\" edittype=\"normal\" combodataset=\"ds_menu_tp\" combodatacol=\"CMNM\" combocodecol=\"CMCD\"/><Cell col=\"9\" text=\"bind:USER_VISIBLE_YN\" displaytype=\"combotext\" edittype=\"combo\" combodataset=\"ds_cm_use_yn\" combocodecol=\"CMCD\" combodatacol=\"CMCD\"/><Cell col=\"10\" text=\"bind:USE_YN\" displaytype=\"combotext\" edittype=\"combo\" checkboxfalsevalue=\"N\" checkboxtruevalue=\"Y\" combodataset=\"ds_cm_use_yn\" combocodecol=\"CMCD\" combodatacol=\"CMNM\"/><Cell col=\"11\" text=\"bind:TITLE1\" textAlign=\"left\" edittype=\"normal\"/><Cell col=\"12\" text=\"bind:TITLE2\" textAlign=\"left\" edittype=\"normal\"/><Cell col=\"13\" text=\"bind:TITLE3\" textAlign=\"left\" edittype=\"normal\"/><Cell col=\"14\" text=\"bind:TITLE4\" textAlign=\"left\" edittype=\"normal\"/><Cell col=\"15\" text=\"bind:TITLE5\" textAlign=\"left\" edittype=\"normal\"/><Cell col=\"16\" text=\"bind:TITLE6\" textAlign=\"left\" edittype=\"normal\"/><Cell col=\"17\" text=\"bind:TITLE7\" textAlign=\"left\" edittype=\"normal\"/><Cell col=\"18\" text=\"bind:TITLE8\" textAlign=\"left\" edittype=\"normal\"/><Cell col=\"19\" text=\"bind:TITLE9\" textAlign=\"left\" edittype=\"normal\"/><Cell col=\"20\" text=\"bind:TITLE10\" textAlign=\"left\" edittype=\"normal\"/><Cell col=\"21\" text=\"bind:STR1\" edittype=\"normal\"/><Cell col=\"22\" text=\"bind:STR2\" edittype=\"normal\"/><Cell col=\"23\" text=\"bind:STR3\" edittype=\"normal\"/><Cell col=\"24\" text=\"bind:STR4\" edittype=\"normal\"/><Cell col=\"25\" text=\"bind:STR5\" edittype=\"normal\"/><Cell col=\"26\" text=\"bind:STR6\" edittype=\"normal\"/><Cell col=\"27\" text=\"bind:STR7\" edittype=\"normal\"/><Cell col=\"28\" text=\"bind:STR8\" edittype=\"normal\"/><Cell col=\"29\" text=\"bind:STR9\" edittype=\"normal\"/><Cell col=\"30\" text=\"bind:STR10\" edittype=\"normal\"/><Cell col=\"31\" text=\"bind:REG_USER\" textAlign=\"center\"/><Cell col=\"32\" text=\"bind:REG_USER_NM\" textAlign=\"center\"/><Cell col=\"33\" text=\"bind:REG_DT\" displaytype=\"date\"/><Cell col=\"34\" text=\"bind:MOD_USER_NM\" textAlign=\"center\"/><Cell col=\"35\" text=\"bind:MOD_DT\" displaytype=\"date\"/></Band></Format></Formats>");
            this.div_cont.form.div_left.addChild(obj.name, obj);

            obj = new Static("Static_mid_label_left01","0","9","194","30",null,null,null,null,null,null,this.div_cont.form.div_left.form);
            obj.set_taborder("1");
            obj.set_text("그룹코드등록");
            obj.set_cssclass("lb01");
            this.div_cont.form.div_left.addChild(obj.name, obj);

            obj = new Button("btn_addrow_grp",null,"6","80","29","0",null,null,null,null,null,this.div_cont.form.div_left.form);
            obj.set_taborder("2");
            obj.set_text("행추가");
            ...
            obj = new Static("Static_mid_label_left01","0","9","220","30",null,null,null,null,null,null,this.div_cont.form.div_right.form);
            obj.set_taborder("0");
            obj.set_text("공통코드등록");
            obj.set_cssclass("lb01");
            this.div_cont.form.div_right.addChild(obj.name, obj);

            obj = new Button("btn_addrow_code",null,"6","80","29","0",null,null,null,null,null,this.div_cont.form.div_right.form);
            obj.set_taborder("1");
            obj.set_text("행추가");
            obj.set_visible("true");
            obj.set_cssclass("btn_com_add");
            ...
            obj = new Grid("grd_detail","0","36",null,null,"0","0",null,null,null,null,this.div_cont.form.div_right.form);
            obj.set_taborder("2");
            ...
            obj = new Static("Static60","0","-4","120","28",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("검색조건");
            obj.set_cssclass("lb01");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item0","div_search.form.cmb_serv_tp","value","ds_search","SERVICE_TP");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("CMA003CT.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("CMA003CT.xfdl","lib::pgm_com.xjs");
        this.registerScript("CMA003CT.xfdl", function() {
        /***********************************************************************
         * 화면ID   : SMA040CT
         * 화면명   : 일반코드그룹관리(상세)
         * 화면설명 :
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_search.form.sta_company.addEventHandler("onclick",this.div_search_sta_doc_no_onclick,this);
        ...
        this.loadIncludeScript("CMA003CT.xfdl");
