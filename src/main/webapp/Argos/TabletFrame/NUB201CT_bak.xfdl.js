(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("div_search","2.46%","90",null,"40","3.39%",null,null,null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);
            ...
            obj = new Combo("cmb_area","160","0","120","40",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("1");
            ...
            obj = new Combo("cmb_location","290","0","120","40",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("2");
            obj.set_itemheight("36");
            ...
            obj = new Button("btn_tReset",null,"0","90","40","180",null,null,null,null,null,this.div_search.form);
            obj.set_taborder("7");
            obj.set_text("초기화");
            obj.set_cssclass("btn_tReset");
            this.div_search.addChild(obj.name, obj);

            obj = new Div("div_cont","2.46%","146",null,null,"3.39%","4.29%",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("sta_resident","0","11","100","25",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("0");
            obj.set_text("입소자성명 :");
            obj.set_cssclass("sta_tTxt1");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("sta_residentVal","95","11","110","25",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_tTxt2");
            obj.set_text("성명");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("sta_enterDt","210","11","80","25",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("2");
            obj.set_text("| 입소일 :");
            obj.set_cssclass("sta_tTxt1");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("sta_areaLocation","400","11","80","25",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("4");
            obj.set_text("| 생활실 :");
            obj.set_cssclass("sta_tTxt1");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("sta_areaLocatonVal","473","11","110","25",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("5");
            obj.set_cssclass("sta_tTxt2");
            obj.set_text("층/호실");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("sta_date","590","11","80","25",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("6");
            obj.set_text("| 작성일 :");
            obj.set_cssclass("sta_tTxt1");
            this.div_cont.addChild(obj.name, obj);
            ...
            obj = new Static("sta_remarkB","0","295","930","120",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("57");
            obj.set_cssclass("sta_tDataBForm2");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("sta_remarkH","0","295","930","40",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("27");
            obj.set_text("건강일지");
            obj.set_cssclass("sta_tDataHForm1");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("sta_managerB","sta_remarkB:0","295","180","120",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("58");
            obj.set_cssclass("sta_tDataBForm3");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("sta_managerH","sta_remarkH:0","295","180","40",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("28");
            obj.set_text("작성자");
            obj.set_cssclass("sta_tDataHForm3");
            this.div_cont.addChild(obj.name, obj);

            obj = new TextArea("txa_remark","20","345","885","60",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("47");
            ...
            obj = new Combo("cmb_manager","950","355","145","40",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("48");
            obj.set_displaynulltext("간호사");
            ...
            obj = new Button("btn_tRecord","515","303","60","24",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("70");
            obj.set_cssclass("btn_tRecord");
            this.div_cont.addChild(obj.name, obj);

            obj = new MaskEdit("mae_dateVal","663","11","110","25",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("7");
            obj.set_format("####.##.##");
            obj.set_type("string");
            obj.set_readonly("true");
            ...
            obj = new MaskEdit("mae_enterDt","283","11","110","25",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("3");
            obj.set_format("####.##.##");
            obj.set_type("string");
            obj.set_readonly("true");
            ...
            obj = new Static("sta_etc","30","50","500","30",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("※ 측정 버튼을 누르시면 각 항목별 측정 페이지로 연결됩니다.");
            obj.set_cssclass("sta_tTxt1");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            ...
            obj = new BindItem("item23","div_cont.form.sta_residentVal","text","ds_resInfo","NAME_AGE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item24","div_cont.form.mae_enterDt","value","ds_resInfo","ENTER_DT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item25","div_cont.form.sta_areaLocatonVal","text","ds_resInfo","ROOM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("NUB201CT_bak.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUB201CT_bak.xfdl","lib::pgm_com.xjs");
        this.addIncludeScript("NUB201CT_bak.xfdl","lib::tpgm_com.xjs");
        this.registerScript("NUB201CT_bak.xfdl", function() {
        /***********************************************************************
         * 화면ID    	: NUB201CT
         * 화면명   	: 건강기록일지
        ...
        // 처리자 선택
        this.div_cont_cmb_manager_oneditclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_cont.form.sta_resident.addEventHandler("onclick",this.formClick,this);
            this.div_cont.form.sta_residentVal.addEventHandler("onclick",this.formClick,this);
            this.div_cont.form.sta_enterDt.addEventHandler("onclick",this.formClick,this);
            this.div_cont.form.sta_areaLocation.addEventHandler("onclick",this.formClick,this);
            this.div_cont.form.sta_areaLocatonVal.addEventHandler("onclick",this.formClick,this);
            this.div_cont.form.sta_date.addEventHandler("onclick",this.formClick,this);
            ...
            this.div_cont.form.sta_managerB.addEventHandler("onclick",this.formClick,this);
            this.div_cont.form.sta_managerH.addEventHandler("onclick",this.formClick,this);
            ...
            this.div_cont.form.cmb_manager.addEventHandler("oneditclick",this.div_cont_cmb_manager_oneditclick,this);
            this.div_cont.form.btn_tRecord.addEventHandler("onclick",this.btn_tRecord_onclick,this);
            this.div_cont.form.mae_dateVal.addEventHandler("oneditclick",this.formClick,this);
            this.div_cont.form.mae_enterDt.addEventHandler("oneditclick",this.formClick,this);
            ...
            this.sta_etc.addEventHandler("onclick",this.formClick,this);
        };
        this.loadIncludeScript("NUB201CT_bak.xfdl");
