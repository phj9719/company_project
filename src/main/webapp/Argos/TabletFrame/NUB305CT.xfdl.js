(function()
{
    return function()
    {
        ...
        {
            this.set_name("NUB305CT");
            this.set_titletext("요양/관찰일지");
            ...
            obj = new Combo("cmb_managerId","166","2","240","36",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("2");
            ...
            obj = new Static("sta_observe_managerIdH","0","0","165","40",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("0");
            obj.set_text("처리자");
            obj.set_cssclass("sta_tDataHForm1");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("sta_observe_noteB","0","43",null,null,"0","0",null,null,null,null,this.div_cont.form);
            obj.set_taborder("4");
            obj.set_cssclass("sta_tDataBForm2");
            this.div_cont.addChild(obj.name, obj);

            obj = new TextArea("txt_observe_note","15","96",null,null,"15","15",null,null,null,null,this.div_cont.form);
            obj.set_taborder("5");
            obj.set_font("normal 500 16pt/normal \"Noto Sans KR\"");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("sta_observe_noteH","0","43",null,"40","0",null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("3");
            obj.set_text("요양일지");
            obj.set_cssclass("sta_tDataHForm1");
            this.div_cont.addChild(obj.name, obj);

            obj = new Button("btn_tRecord_observe2","54.98%","50","60","24",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("6");
            ...
            obj = new BindItem("item10","div_cont.form.txt_observe_note","value","ds_list","NOTE");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("NUB305CT.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUB305CT.xfdl","lib::pgm_com.xjs");
        this.addIncludeScript("NUB305CT.xfdl","lib::tpgm_com.xjs");
        this.registerScript("NUB305CT.xfdl", function() {
        /***********************************************************************
         * 화면ID    	: NUB305CT
         * 화면명   	: 요양/관찰일지
         ...
         ***********************************************************************/
        this.NUB305CT_onload = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onload",this.NUB305CT_onload,this);
            ...
            this.div_cont.form.sta_observe_managerIdH.addEventHandler("onclick",this.formClick,this);
            this.div_cont.form.sta_observe_noteB.addEventHandler("onclick",this.formClick,this);
            this.div_cont.form.sta_observe_noteH.addEventHandler("onclick",this.formClick,this);
            this.div_cont.form.btn_tRecord_observe2.addEventHandler("onclick",this.btn_tRecord_onclick,this);
        };
        this.loadIncludeScript("NUB305CT.xfdl");
