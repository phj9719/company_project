(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("div_humi","402","20","240","95",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("Div00");
            obj.set_background("#edf9ff");
            obj.set_borderRadius("10px");
            ...
            obj = new ImageViewer("imv_exDiaper","70","40","50","45",null,null,null,null,null,null,this.div_humi.form);
            obj.set_taborder("0");
            obj.set_image("url(\'theme://images/ico_sta_diaper.png\')");
            obj.set_background("transparent");
            this.div_humi.addChild(obj.name, obj);

            obj = new Static("sta_exDiaperCount","140","40","45","45",null,null,null,null,null,null,this.div_humi.form);
            obj.set_taborder("1");
            obj.set_text("-");
            ...
            obj = new Div("div_battery","652","20","240","95",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("Div00");
            obj.set_background("#edf9ff");
            obj.set_borderRadius("10px");
            ...
            obj = new ImageViewer("imv_exBattery","70","40","50","45",null,null,null,null,null,null,this.div_battery.form);
            obj.set_taborder("0");
            obj.set_image("url(\'theme://images/ico_sta_battery.png\')");
            obj.set_background("transparent");
            this.div_battery.addChild(obj.name, obj);

            obj = new Static("sta_exBatteryCount","140","40","45","45",null,null,null,null,null,null,this.div_battery.form);
            obj.set_taborder("1");
            obj.set_text("-");
            obj.set_font("normal 700 25pt/normal \"Noto Sans KR\"");
            ...
            obj = new Div("div_disconnect","902","20","240","95",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("Div00");
            obj.set_borderRadius("10px");
            obj.set_boxShadow("0px 0px 7px #dddddd");
            ...
            obj = new ImageViewer("imv_diaperNot","70","40","50","45",null,null,null,null,null,null,this.div_disconnect.form);
            obj.set_taborder("0");
            obj.set_image("url(\'theme://images/ico_sta_diapernot.png\')");
            obj.set_background("transparent");
            this.div_disconnect.addChild(obj.name, obj);

            obj = new Static("sta_diaperNotCount","140","40","45","45",null,null,null,null,null,null,this.div_disconnect.form);
            obj.set_taborder("1");
            obj.set_text("-");
            obj.set_font("normal 700 25pt/normal \"Noto Sans KR\"");
            ...
            obj = new Static("sta_batteryTitle","652","20","240","35",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("배터리");
            obj.set_textAlign("center");
            obj.set_color("#ffffff");
            ...
            obj = new Static("sta_humi","402","20","240","35",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("기저귀");
            obj.set_textAlign("center");
            obj.set_color("#ffffff");
            ...
            obj = new Static("sta_disconnectTitle","902","20","240","35",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("연결끊김");
            obj.set_textAlign("center");
            obj.set_color("#ffffff");
            obj.set_font("normal 700 18pt/normal \"Noto Sans KR\"");
            obj.set_background("#777777");
            obj.set_borderRadius("10px 10px 0px 0px");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.addIncludeScript("NUB101CT_D.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUB101CT_D.xfdl","lib::pgm_com.xjs");
        this.addIncludeScript("NUB101CT_D.xfdl","lib::tpgm_com.xjs");
        this.registerScript("NUB101CT_D.xfdl", function() {
        /***********************************************************************
         * 화면ID    	: NUB101CT_D
         * 화면명   	: 호실현황 (모니터링 기저귀)
         * 화면설명 	: 호실 입소자 선택에서 선택한 호실의
        				  입소자의 기저귀 현황과 공기질을 모니터링하는 화면
         * 작성일    	: 2021-12-22
         * 작성자   	: 조기종
         * 수정이력 	: ↓↓↓↓↓↓↓
         ***********************************************************************
        ...
        this.fn_search = function()
        {
        	...
        	const svcId = "search";
        	const params = "/NUB101CT_DController.do";
        	const inDatasets = "";
        ...
        this.fn_callback = function(strSvcID, nErrorCode, strErrorMsg)
        {
        	if (nErrorCode == 0)
        	{
        		if (strSvcID == "search")
        		{
        			...
        			this.div_disconnect.form.sta_diaperNotCount.set_text(dcDiaper);
        			// 기저귀 교체 수 (습도)
        			...
        			this.div_humi.form.sta_exDiaperCount.set_text(exDiaperH);
        			// 기저귀 교체 수 (배터리)
        			const exDiaperB = this.ds_resident.getCaseCount("DIAPER_YN == 'Y' && (CONN_ST != null && CONN_ST != undefined) && BAT_RATE <= " + batteryLine);
        			this.div_battery.form.sta_exBatteryCount.set_text(exDiaperB);
        ...
        this.fn_makeResident = function()
        {
        	...
        	for(let i = 0; i < this.ds_resident.rowcount; i++)
        	{
        		...
        		this.fn_makeDiv(divId, divLeft, divTop, divWidth, divHeight, right, resId);
        		this.fn_makeDivContents(i, divId, name, age, sex, con, humiRateN, humiRateB, batRate, diaperYn);
        	}
        ...
        // 수급자 카드틀 만들기
        this.fn_makeDiv = function(id, left, top, width, height, right, resId)
        {
        ...
        // 수급자 카드 내용 만들기
        this.fn_makeDivContents = function(i, divId, name, age, sex, con, humiRateN, humiRateB, batRate, diaperYn)
        {
        	...
        	if (diaperYn == "Y")
        	{
        		...
        		left = 229, top = 68, width = 63, height = 49;
        		...
        		left = 258, top = 24, width = 39, height = 24;
        		...
        		else
        		{
        			...
        			left = 208, top = 19, width = 44, height = 24;
        			...
        			left = 235, top = 118, width = 42, height = 24;
        			...
        			left = 280, top = 124, width = 19, height = 22;
        			...
        			if (humiRateB != null && humiRateB != undefined)
        			{
        				...
        				left = 146, top = 74, width = 61, height = 51;
        				...
        				left = 145, top = 121, width = 38, height = 24;
        				...
        				left = 186, top = 123, width = 19, height = 22;
        				...
        				left = 205, top = 77, width = 19, height = 24;
        ...
        this.fn_setDivCss = function (value, sta, cmcd)
        {
        	...
        	for (let i = 1; i <= 8; i++) // STR1~STR8 변수 생성
        	{
        		try
        		{
        ...
        this.loadIncludeScript("NUB101CT_D.xfdl");
