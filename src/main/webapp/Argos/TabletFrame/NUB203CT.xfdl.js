(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_preH","150","15","210","40",null,null,null,null,null,null,this.div_main.form.div_cont.form.div_head.form);
            obj.set_taborder("1");
            obj.set_text("혈압(H/L)");
            obj.set_cssclass("sta_tDataHForm4");
            this.div_main.form.div_cont.form.div_head.addChild(obj.name, obj);

            obj = new Static("Static02_00","150","55","210","80",null,null,null,null,null,null,this.div_main.form.div_cont.form.div_head.form);
            obj.set_taborder("2");
            obj.set_cssclass("sta_tDataBForm3");
            this.div_main.form.div_cont.form.div_head.addChild(obj.name, obj);

            obj = new Static("Static02_00_00","360","55","11.42%","80",null,null,null,null,null,null,this.div_main.form.div_cont.form.div_head.form);
            obj.set_taborder("3");
            obj.set_cssclass("sta_tDataBForm3");
            this.div_main.form.div_cont.form.div_head.addChild(obj.name, obj);

            obj = new Static("sta_pulse","360","15","120","40",null,null,null,null,null,null,this.div_main.form.div_cont.form.div_head.form);
            obj.set_taborder("4");
            obj.set_text("맥박");
            obj.set_cssclass("sta_tDataHForm1");
            this.div_main.form.div_cont.form.div_head.addChild(obj.name, obj);

            obj = new Static("Static02_00_00_00","480","55","435","80",null,null,null,null,null,null,this.div_main.form.div_cont.form.div_head.form);
            obj.set_taborder("5");
            obj.set_cssclass("sta_tDataBForm3");
            this.div_main.form.div_cont.form.div_head.addChild(obj.name, obj);

            obj = new Static("sta_remark","480","15","435","40",null,null,null,null,null,null,this.div_main.form.div_cont.form.div_head.form);
            obj.set_taborder("7");
            obj.set_text("비고");
            obj.set_cssclass("sta_tDataHForm2");
            this.div_main.form.div_cont.form.div_head.addChild(obj.name, obj);

            obj = new Edit("edt_preH","160","75","80","40",null,null,null,null,null,null,this.div_main.form.div_cont.form.div_head.form);
            obj.set_taborder("8");
            ...
            obj = new Static("Static03_00","250","75","0.86%","40",null,null,null,null,null,null,this.div_main.form.div_cont.form.div_head.form);
            obj.set_taborder("9");
            obj.set_text("/");
            obj.set_textAlign("center");
            ...
            obj = new Edit("edt_preL","270","75","80","40",null,null,null,null,null,null,this.div_main.form.div_cont.form.div_head.form);
            obj.set_taborder("10");
            obj.set_textAlign("center");
            obj.set_inputtype("number");
            obj.set_cssclass("essential");
            ...
            obj = new Edit("edt_pulse","380","75","80","40",null,null,null,null,null,null,this.div_main.form.div_cont.form.div_head.form);
            obj.set_taborder("11");
            obj.set_textAlign("center");
            obj.set_inputtype("number");
            obj.set_cssclass("essential");
            ...
            obj = new TextArea("txt_remark","494","75","405","40",null,null,null,null,null,null,this.div_main.form.div_cont.form.div_head.form);
            obj.set_taborder("12");
            ...
            obj = new Combo("cmb_manager","937","75","110","40",null,null,null,null,null,null,this.div_main.form.div_cont.form.div_head.form);
            obj.set_taborder("16");
            obj.set_itemheight("36");
            ...
            obj = new MaskEdit("mae_preDt","20","75","110","40",null,null,null,null,null,null,this.div_main.form.div_cont.form.div_head.form);
            obj.set_taborder("6");
            ...
            obj = new Static("sta_preL","150","15","210","40",null,null,null,null,null,null,this.div_main.form.div_cont.form.div_head.form);
            obj.set_taborder("17");
            obj.set_text("혈압(H/L)");
            obj.set_cssclass("sta_tDataHForm4");
            this.div_main.form.div_cont.form.div_head.addChild(obj.name, obj);

            obj = new Button("btn_tRecord1","722","11","40","20",null,null,null,null,null,null,this.div_main.form.div_cont.form);
            obj.set_taborder("2");
            ...
            obj = new BindItem("item7","div_main.form.div_cont.form.div_head.form.edt_preH","value","ds_pressure_i","PRE_H");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","div_main.form.div_cont.form.div_head.form.edt_preL","value","ds_pressure_i","PRE_L");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item9","div_main.form.div_cont.form.div_head.form.edt_pulse","value","ds_pressure_i","PULSE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item10","div_main.form.div_cont.form.div_head.form.txt_remark","value","ds_pressure_i","REMARK");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item11","div_main.form.div_cont.form.div_head.form.cmb_manager","value","ds_pressure_i","MANAGER_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item12","div_main.form.div_cont.form.div_head.form.mae_preDt","value","ds_pressure_i","PRE_TIME");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("NUB203CT.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUB203CT.xfdl","lib::pgm_com.xjs");
        this.addIncludeScript("NUB203CT.xfdl","lib::tpgm_com.xjs");
        this.registerScript("NUB203CT.xfdl", function() {
        /***********************************************************************
         * 화면ID    	: NUB202CT
         * 화면명   	: 기초건강측정
        ...
        this.fn_search = function(ds, ds_i)
        {
        	...
        	let outDatasets = "ds_resInfo=output1 ds_pressure=output2";
        	let argument = "method=getList ";
        		argument += "sqlId='NUB202CT.NUB202CT_DS_RESINFO_S NUB202CT.NUB202CT_DS_PRESSURE_S'";
        ...
        this.fn_save = function (ds)
        {
        	...
        	var svcId = "save";
        	var params = "/NUB203CTController.do";
        ...
        this.on_standardPlugin_callback = function(obj, e)
        {
        	...
        	if(e.svcid == "TIMEPICKER1")
        	{
        		if(e.reason == 0)
        		{
        			this.div_main.form.div_cont.form.div_head.form.mae_preDt.set_value(e.returnvalue);
        		}
        	}
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.div_main.form.div_search.form.btn_tMeasure.addEventHandler("onclick",this.tab_head_Tabpage0_div_search_btn_tMeasure_onclick,this);
            ...
            this.div_main.form.div_cont.form.div_head.form.Static02_00.addEventHandler("onclick",this.formClick,this);
            ...
            this.div_main.form.div_cont.form.div_head.form.sta_remark.addEventHandler("onclick",this.div_main_div_cont_div_head_sta_remark_onclick,this);
            this.div_main.form.div_cont.form.div_head.form.edt_preH.addEventHandler("onsetfocus",this.fn_onsetfocus,this);
            this.div_main.form.div_cont.form.div_head.form.edt_preL.addEventHandler("onsetfocus",this.fn_onsetfocus,this);
            this.div_main.form.div_cont.form.div_head.form.edt_pulse.addEventHandler("onsetfocus",this.fn_onsetfocus,this);
            ...
            this.div_main.form.div_cont.form.div_head.form.mae_preDt.addEventHandler("onsetfocus",this.fn_onsetfocus,this);
            this.div_main.form.div_cont.form.div_head.form.mae_preDt.addEventHandler("oneditclick",this.preDt_oneditclick,this);
            this.div_main.form.div_cont.form.div_head.form.mae_preDt.addEventHandler("onchanged",this.fn_mdt_onchanged,this);
            this.div_main.form.div_cont.form.btn_tRecord1.addEventHandler("onclick",this.btn_tRecord_onclick,this);
        };
        this.loadIncludeScript("NUB203CT.xfdl");
