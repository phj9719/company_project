(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01","0","55","222","100",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("8");
            ...
            obj = new Static("Static01_01","0","155","222","150",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("10");
            obj.set_cssclass("sta_tDataBForm1");
            this.div_cont.addChild(obj.name, obj);
            ...
            obj = new Static("Static02","0","55","222","40",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("9");
            obj.set_text("Rom-exercise");
            obj.set_cssclass("sta_tDataHForm1");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("Static01_01_00","222","155","222","150",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("15");
            obj.set_cssclass("sta_tDataBForm1");
            this.div_cont.addChild(obj.name, obj);

            obj = new Radio("Radio00","65","105","90","40",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("14");
            ...
            obj = new Static("Static02_01","0","155","222","40",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("11");
            obj.set_text("치료부위");
            obj.set_cssclass("sta_tDataHForm1");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("Static01_01_00_00","444","155","444","150",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("18");
            obj.set_cssclass("sta_tDataBForm1");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("Static01_01_00_01","888","155","222","150",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("21");
            obj.set_cssclass("sta_tDataBForm3");
            this.div_cont.addChild(obj.name, obj);

            obj = new TextArea("TextArea00_00","242","210","180","80",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("16");
            this.div_cont.addChild(obj.name, obj);

            obj = new TextArea("TextArea00_00_00","464","210","400","80",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("19");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("Static01_00","222","55","222","100",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("24");
            obj.set_cssclass("sta_tDataBForm1");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("Static02_01_00","222","155","222","40",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("17");
            obj.set_text("시간");
            obj.set_cssclass("sta_tDataHForm1");
            this.div_cont.addChild(obj.name, obj);
            ...
            obj = new Static("Static01_00_00","444","55","222","100",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("27");
            obj.set_cssclass("sta_tDataBForm1");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_00","666","55","222","100",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("30");
            obj.set_cssclass("sta_tDataBForm1");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("Static02_01_00_00","444","155","444","40",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("20");
            obj.set_text("기타(특이사항)");
            obj.set_cssclass("sta_tDataHForm1");
            this.div_cont.addChild(obj.name, obj);

            obj = new Radio("Radio00_00","287","105","90","40",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("26");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_direction("vertical");
            ...
            obj = new Radio("Radio00_00_00","509","105","90","40",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("29");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_direction("vertical");
            ...
            obj = new Static("Static02_00","222","55","222","40",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("25");
            obj.set_text("standing-table");
            obj.set_cssclass("sta_tDataHForm1");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_00_00","888","55","222","100",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("33");
            obj.set_cssclass("sta_tDataBForm3");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("Static02_01_00_01","888","155","222","40",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("22");
            obj.set_text("처리자");
            obj.set_cssclass("sta_tDataHForm2");
            this.div_cont.addChild(obj.name, obj);

            obj = new Radio("Radio00_00_00_00","731","105","90","40",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("32");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_direction("vertical");
            ...
            obj = new Static("Static02_00_00","444","55","222","40",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("28");
            obj.set_text("자동자전거 태우기");
            obj.set_cssclass("sta_tDataHForm1");
            this.div_cont.addChild(obj.name, obj);

            obj = new Radio("Radio00_00_00_00_00","945","105","90","40",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("35");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_direction("vertical");
            ...
            obj = new Static("Static02_00_00_00","666","55","222","40",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("31");
            obj.set_text("보행운동");
            obj.set_cssclass("sta_tDataHForm1");
            this.div_cont.addChild(obj.name, obj);

            obj = new Static("Static02_00_00_00_00","888","55","222","40",null,null,null,null,null,null,this.div_cont.form);
            obj.set_taborder("34");
            obj.set_text("근력운동");
            obj.set_cssclass("sta_tDataHForm2");
            this.div_cont.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("NUB402CT.xfdl","lib::sct_com.xjs");
        this.addIncludeScript("NUB402CT.xfdl","lib::pgm_com.xjs");
        this.addIncludeScript("NUB402CT.xfdl","lib::tpgm_com.xjs");
        this.registerScript("NUB402CT.xfdl", function() {
        /***********************************************************************
         * 화면ID    : CMA001CT
         * 화면명   :
         * 화면설명 :
        ...
        this.loadIncludeScript("NUB402CT.xfdl");
